%
% $XORP: xorp/docs/rtrmgr/rtrmgr.tex,v 1.44 2005/11/17 08:31:57 pavlin Exp $
%
...
The {\it \%help:} is a mandatory keyword and is followed by the help string.
Currently the help string is not used, but it may be used in the future
for command-line completion purpose.
