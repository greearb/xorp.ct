%
% $XORP: xorp/docs/rtrmgr/rtrmgr.tex,v 1.15 2004/01/15 01:25:40 pavlin Exp $
%
...
\item {{\tt \%modinfo: startcommit }{\it method }{\it argument}}  \\
The {\tt startcommit} subcommand takes two or more additional parameters, that
...
\item {{\tt \%modinfo: endcommit }{\it method }{\it argument}}  \\
The {\tt endcommit} subcommand takes two or more additional parameters, that
...
\item {{\tt \%modinfo: statusmethod }{\it method }{\it argument}}  \\
The {\tt statusmethod} subcommand takes two or more additional parameters,
...
\item {{\tt \%modinfo: shutdownmethod }{\it method }{\it argument}}  \\
The {\tt shutdownmethod} subcommand takes two or more additional parameters,
...
show interface $(interfaces.interface.*) {
        %command: "path/to/show_interface" %help: HELP;
        %module: fea;
