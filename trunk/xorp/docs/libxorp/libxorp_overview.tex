%
% $XORP: xorp/docs/libxorp/libxorp_overview.tex,v 1.2 2003/03/06 01:47:04 jcardona Exp $
%
...
and it's SelectorList to read or write files asynchronously.  The
...
RefTrie differs from Trie (and it's associated classes) in that the
...
\begin{itemize}
  ...
  \item March 5, 2003: Add information about RefTrie.  Version 0.2.
