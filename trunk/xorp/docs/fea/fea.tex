%
% $XORP: xorp/docs/fea/fea.tex,v 1.16 2005/11/29 01:48:36 pavlin Exp $
%
...
via XRL on the basis on filter conditions.  Currently (March 2006),
...
In other words, currently (March 2006) the {\tt fea} supports FreeBSD,
NetBSD, OpenBSD, MacOS X, Linux, and Windows Server 2003 (see file
