%
% $XORP: xorp/docs/fea/fea.tex,v 1.22 2008/07/17 23:19:41 pavlin Exp $
%
...
\begin{itemize}
  ...
  \item July 22, 2008: Updated the version to 1.5, the date, and added
  a footnote that the description is actually for the FEA in XORP-1.4.
