...
and succesfully handled a full eBGP feed of around 120,000 IPv4 route prefixes.
...
%\begin{center}
%\includegraphics[bb=0 0 778 570]{figs/windispatcher}
% windispatcher.svg: 778x570 pixel, 72dpi, 27.45x20.11 cm, bb=0 0 778 570
%\end{center}
...
As described earlier, this is due to the multi-threadeded design
