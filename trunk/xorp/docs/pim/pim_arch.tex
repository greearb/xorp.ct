%
% $XORP: xorp/docs/pim/pim_arch.tex,v 1.21 2006/03/09 01:37:03 pavlin Exp $
%
...
\begin{itemize}
  ...
  \item November 6, 2003: Added brief info about retrieving protocol-related
  statistics. Minor cleanup.
  Updated the version to 0.5, and the date.

  \item July 8, 2004: Updated to match release 1.0.
