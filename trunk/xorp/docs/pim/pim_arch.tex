%
% $XORP: xorp/docs/pim/pim_arch.tex,v 1.3 2003/03/07 22:03:26 pavlin Exp $
%
...
would be through PimNode~\footnote{For simplicity, currently (March 2003)
...
sent by the CLI). This problem arises
...
as of March 2003), we save the appropriate state to continue the
