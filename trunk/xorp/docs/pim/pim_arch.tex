%
% $XORP: xorp/docs/pim/pim_arch.tex,v 1.9 2004/02/22 03:03:43 pavlin Exp $
%
...
Currently (June 2004), the PIM-SM implementation is based
...
would be through PimNode~\footnote{For simplicity, currently (June 2004)
...
(June 2004) the PimScopeZoneTable is used only for PIM
...
For simplicity of implementation, currently (June 2004) PimMrt
...
the multicast forwarding engine. Currently (June 2004), those
...
module~\footnote{Note that before June 2004 the information was
...
(June 2004), PimConfig is not implemented; rather, all state is
...
\begin{itemize}
  ...
  \item June 22, 2004: Updated to match release 1.0. Bump-up the version to
  1.0, and the date.
