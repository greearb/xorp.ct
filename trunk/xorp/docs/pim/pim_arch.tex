%
% $XORP: xorp/docs/pim/pim_arch.tex,v 1.20 2005/11/29 01:48:39 pavlin Exp $
%
...
Currently (March 2006), the PIM-SM implementation is based
...
would be through PimNode~\footnote{For simplicity, currently (March 2006)
...
(March 2006) the PimScopeZoneTable is used only for PIM
...
For simplicity of implementation, currently (March 2006) PimMrt
...
the multicast forwarding engine. Currently (March 2006), those
...
(March 2006), PimConfig is not implemented; rather, all state is
