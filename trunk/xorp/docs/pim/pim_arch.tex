%
% $XORP: xorp/docs/pim/pim_arch.tex,v 1.7 2003/08/28 00:35:16 pavlin Exp $
%
...
would be through PimNode~\footnote{For simplicity, currently (November 2003)
...
(November 2003) the PimScopeZoneTable is used only for PIM
...
For simplicity of implementation, currently (November 2003) PimMrt
...
the multicast forwarding engine. Currently (November 2003), those
...
module~\footnote{Currently (November 2003), the information is
...
Note that as we mentioned earlier, currently (November 2003), the MRIB
...
(November 2003), PimConfig is not implemented; rather, all state is
