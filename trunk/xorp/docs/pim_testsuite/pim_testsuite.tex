%
% $XORP: xorp/docs/pim_testsuite/pim_testsuite.tex,v 1.13 2003/03/02 06:51:30 pavlin Exp $
%
...
\para{References:}
\begin{itemize}
  \item draft-ietf-pim-sm-bsr-02 -- Section 3.1
\end{itemize}
...
In Part A, B, and C, the BS Timer in the RUT might expire earlier than
3 * \verb=C-RP-Adv_Period= (3 * {\PimsmCRPAdvPeriod}), hence the RUT
may stop transmitting Cand-RP-Adv messages right after the BS Timer expires.
