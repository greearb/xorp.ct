%
% $XORP: xorp/docs/pim_testsuite/pim_testsuite.tex,v 1.18 2003/03/06 12:21:37 pavlin Exp $
%
...
Version 0.2 completed	& March 7, 2003 & \verb=draft-ietf-pim-sm-v2-new-05.{ps,tex}= \\
...
itself. More specifically, the XORP PIM-SM implementation has extentions that
...
\newcommand{\PimsmSZTimeout}{1300 sec}			% SZ_Timeout
...
\begin{enumerate}
  ...
  \item Continue obsrving the Bootstrap messages transmitted on LAN1
...
capable-interface excelt if the interface is an administrative scope boundary
...
substitured everywhere with 226.0.0.0/8, and except that
