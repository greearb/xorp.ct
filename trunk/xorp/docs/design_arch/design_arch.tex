%
% $XORP: xorp/docs/design_arch/design_arch.tex,v 1.18 2006/03/08 23:41:20 pavlin Exp $
%
...
\begin{itemize}
  ...
  items. Bump-up the version to 0.4, and the date.
  ...
  forwarding path); bump-up the version to 1.2, and the date.
