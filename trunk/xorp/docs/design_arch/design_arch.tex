%
% $XORP: xorp/docs/design_arch/design_arch.tex,v 1.1.1.1 2002/12/11 23:55:55 hodson Exp $
%
...
most of the code is written to support both, as of Release 0.2
(March 2003) only IPv4 has been tested.
...
Note that in release 0.2 (March 2003), the multicast-related
...
multicast RIBs for multicast routing purpose.  As of version 0.2, only
...
daemons will be separate.  Work on our RIP implementation is only just
beginning.
...
using XRLs.  As of March 2003, work on SNMP is only just beginning.
...
\begin{itemize}
  ...
  \item March 5, 2003: Updated to match XORP version 0.2 release code.
