%
% $XORP: xorp/docs/design_arch/design_arch.tex,v 1.9 2003/11/06 20:21:01 pavlin Exp $
%
...
most of the code is written to support both, as of Release 1.0
(June 2004) majority of the testing has been limited to IPv4 only.
...
\begin{itemize}
  ...
  \item June 22, 2004: Updated the status (now there is support for RIP and
