%
% $XORP: xorp/docs/multicast/multicast_arch.tex,v 1.7 2003/08/28 00:23:16 pavlin Exp $
%
...
\begin{itemize}
  ...
  \item Currently (November 2003), the MRIB information is
...
Register encapsulation. Currently (November 2003), only few systems (\eg
FreeBSD-CURRENT, FreeBSD-4.9, and DragonFlyBSD) do support such kernel-level
encapsulation.
...
Currently (November 2003), this interaction is not implemented;
