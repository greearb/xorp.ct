%
% $XORP: xorp/docs/multicast/multicast_arch.tex,v 1.17 2005/11/29 01:48:38 pavlin Exp $
%
...
Register encapsulation. Currently (March 2006), only recent releases
...
information should be sent to the PIM module. Currently (March 2006),
