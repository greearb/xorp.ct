%
% $XORP: xorp/docs/multicast/multicast_arch.tex,v 1.6 2003/06/09 20:02:21 pavlin Exp $
%
...
\begin{itemize}
  ...
  \item Currently (August 2003), the MRIB information is
...
Register encapsulation. Currently (August 2003), FreeBSD-CURRENT and
the fortcoming FreeBSD-4.9 do support such kernel-level encapsulation.
...
information should be sent to the PIM module. Currently (August 2003),
...
Currently (August 2003), this interaction is not implemented;
