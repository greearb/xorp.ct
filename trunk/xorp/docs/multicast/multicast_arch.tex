%
% $XORP: xorp/docs/multicast/multicast_arch.tex,v 1.18 2006/03/09 01:30:58 pavlin Exp $
%
...
Register encapsulation. Currently (August 2006), only recent releases
...
information should be sent to the PIM module. Currently (August 2006),
