%
% $XORP: xorp/docs/multicast/multicast_arch.tex,v 1.8 2003/11/06 18:57:50 pavlin Exp $
%
...
\begin{itemize}
  ...
  \item Note that as of (June 2004), the MRIB information is
  not obtained anymore from the MFEA, but from the RIB.
...
Register encapsulation. Currently (June 2004), only few systems (\eg
FreeBSD-5.2, FreeBSD-4.9 and later, and DragonFlyBSD) do support such
...
information should be sent to the PIM module. Currently (November 2003),
...
Note that previously the MRIB information was received from the MFEA.
As of June 2004 the MRIB is received from the RIB instead.
...
\begin{itemize}
  ...
  \item June 22, 2004: Status updated; added information about the FIB2MRIB
