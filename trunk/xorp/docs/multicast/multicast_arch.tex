%
% $XORP: xorp/docs/multicast/multicast_arch.tex,v 1.3 2003/03/07 22:34:00 pavlin Exp $
%
...
protocols may receive multicast group membership information per
interface.
...
\begin{itemize}
  ...
  \item Currently (March 2003), the MRIB information is
  obtained through the MFEA.

  \item Currently (March 2003), the information about
...
Note that the current (March 2003) solution in case of UNIX PIM kernel
...
FreeBSD-CURRENT in March-April 2003.
...
information should be sent to the PIM module. Currently (March 2003),
...
Currently (March 2003), this interaction is not implemented;
