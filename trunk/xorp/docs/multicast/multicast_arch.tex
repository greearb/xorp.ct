%
% $XORP: xorp/docs/multicast/multicast_arch.tex,v 1.1.1.1 2002/12/11 23:55:56 hodson Exp $
%
...
protocol, then we can have MLD6/IGMP running as a library linked with
...
Separating IGMP/MLD6 from the routing code has the advantage of reducing
