%
% $XORP: xorp/docs/libxipc/libxipc_overview.tex,v 1.16 2006/08/02 00:42:39 pavlin Exp $
%
...
\begin{itemize}
  ...
  \item August 2, 2006: Updated sample XRL-related code to match the current
	code. Added ``Modification History'' appendix.
