%
% $XORP: xorp/docs/mld6igmp/mld6igmp_arch.tex,v 1.19 2006/07/05 03:38:51 pavlin Exp $
%
...
(August 2006) there are few occasions when XrlMld6igmpNode uses
...
configuration~\footnote{Currently (August 2006), Mld6igmpConfig is not
