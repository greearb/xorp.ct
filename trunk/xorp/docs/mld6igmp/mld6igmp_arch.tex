%
% $XORP: xorp/docs/mld6igmp/mld6igmp_arch.tex,v 1.6 2003/06/09 20:02:21 pavlin Exp $
%
...
Currently (August 2003), the MLD and IGMP implementation is based
...
(August 2003) there are few occasions when XrlMld6igmpNode uses
...
configuration~\footnote{Currently (August 2003), Mld6igmpConfig is not
