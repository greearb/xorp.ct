%
% $XORP: xorp/docs/mld6igmp/mld6igmp_arch.tex,v 1.4 2003/06/03 23:51:26 pavlin Exp $
%
...
Currently (June 2003), the MLD and IGMP implementation is based
...
(June 2003) there are few occasions when XrlMld6igmpNode uses
...
configuration~\footnote{Currently (June 2003), Mld6igmpConfig is not
...
\begin{itemize}
  ...
  \item June 6, 2003: Bump-up the version to 0.3, and the date.
