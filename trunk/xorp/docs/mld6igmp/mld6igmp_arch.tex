%
% $XORP: xorp/docs/mld6igmp/mld6igmp_arch.tex,v 1.22 2007/03/14 00:18:20 pavlin Exp $
%
...
(March 2007) there are few occasions when XrlMld6igmpNode uses
...
configuration~\footnote{Currently (March 2007), Mld6igmpConfig is not
