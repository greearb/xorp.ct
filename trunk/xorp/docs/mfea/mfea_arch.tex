%
% $XORP: xorp/docs/mfea/mfea_arch.tex,v 1.21 2006/03/09 01:23:29 pavlin Exp $
%
...
Currently (August 2006), the MFEA supports abstraction for
the following systems:

\begin{itemize}
  \item \{DragonFly,Free,Net,Open\}BSD OS
  \item Linux OS
\end{itemize}

In the future, the MFEA will support simulation environment, and
abstraction for Click~\cite{CLICK-PROJECT} forwarding
path~\footnote{Currently (August 2006) Click does
...
(August 2006) there are few occasions when XrlMfeaNode uses direct access to
MfeaVif.}.
...
(August 2006), MfeaConfig is not implemented; rather, all state is
