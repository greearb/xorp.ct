%
% $XORP: xorp/docs/mfea/mfea_arch.tex,v 1.18 2005/04/12 08:27:56 pavlin Exp $
%
...
Currently (April 2005), the MFEA supports abstraction for
...
path~\footnote{Currently (April 2005) Click does
...
(April 2005) there are few occasions when XrlMfeaNode uses direct access to
MfeaVif.}.
...
(April 2005), MfeaConfig is not implemented; rather, all state is
