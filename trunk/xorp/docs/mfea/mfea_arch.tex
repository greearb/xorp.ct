%
% $XORP: xorp/docs/mfea/mfea_arch.tex,v 1.10 2003/08/28 00:12:48 pavlin Exp $
%
...
path~\footnote{Currently (November 2003) Click does
...
\begin{itemize}
  ...
  in the future (after November 2003) the multicast modules interested in
...
packets~\footnote{In the future (after November 2003), the PIM
...
would be through MfeaNode~\footnote{For simplicity, currently (November
...
(November 2003), MfeaConfig is not implemented; rather, all state is
...
Currently (November 2003), the MRIB information is obtained by
