%
% $XORP: xorp/docs/user_manual/ospf.tex,v 1.6 2006/03/09 10:45:00 atanu Exp $
% 
...
\>\>\>\>\>\>max-time-drift-secs: {\it uint(0..65535)}\\
\>\>\>\>\>\}\\
\>\>\>\>\}\\
\>\>\>\}\\
\\
...
\begin{description}
  ...
  \item{\tt max-time-drift-secs}: this specifies the maximum time drift
