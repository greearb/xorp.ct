%
% $XORP: xorp/docs/user_manual/cli_intro.tex,v 1.8 2005/09/29 01:46:33 pavlin Exp $
%
...
\\
\noindent[edit interfaces interface rl0]\\
user@hostname\# \textbf{create vif rl0b \{}\\
...
\begin{tabbing}
xx\=xx\=xx\=xx\=xx\=\kill
user@hostname\# \textbf{show interfaces interface rl0}\\
\>description: "control interface"\\
\>vif rl0 \{\\
\>\>address 192.150.187.108 \{\\
\>\>\>prefix-length: 24\\
...
\\
\noindent[edit]\\
user@hostname\# \textbf{delete interfaces interface rl0 vif rl0b}\\
Deleting:\\
\>address 10.0.0.1 \{\\
\>\>prefix-length: 16\\
\>\>broadcast: 10.0.255.255\\
...
{\textbf XORP\_OPERATIONAL\_MODE\_PROMPT} and
{\textbf XORP\_CONFIGURATION\_MODE\_PROMPT}.

\begin{verbatim}
user@hostname[10] env XORP_OPERATIONAL_MODE_PROMPT="foo " 
                      XORP_CONFIGURATION_MODE_PROMPT="bar " ./xorpsh
