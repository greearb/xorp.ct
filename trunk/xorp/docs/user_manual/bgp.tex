%
% $XORP: xorp/docs/user_manual/bgp.tex,v 1.17 2006/03/08 08:38:35 atanu Exp $
%
...
\item{\bf RFC draft-ietf-idr-rfc2858bis-03.txt}: Multiprotocol
...
\item{\bf RFC 2796}: BGP Route Reflection - An Alternative to Full Mesh IBGP
