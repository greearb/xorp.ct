...
\begin{itemize}
\item draft-ietf-idr-bgp4-22.txt: BGP-4 Specification (obsoletes RFC 1771)
\item RFC 1657: Definitions of Managed Objects for the Fourth Version
     of the Border Gateway Protocol (BGP-4) using SMIv2.
\item RFC 2858: Multiprotocol Extensions for BGP-4.
\item RFC 2545: Use of BGP-4 Multiprotocol Extensions for IPv6
     Inter-Domain Routing.
\end{itemize}

\noindent We also have limited support for:
\begin{itemize}
\item RFC 1997: BGP Communities Attribute.
\end{itemize}
