%
% $XORP: xorp/docs/user_manual/igmp.tex,v 1.15 2005/06/01 00:58:04 pavlin Exp $
%
...
\item{\tt version}: this directive specifies the protocol version for this
  ...
  interval [1..2] with default value of {\stt 2}.  In case of MLD the value
  must be in the interval [1..1] with default value of {\stt 1}.
...
\item {\tt query-response-interval}: this directive specifies the maximum
  ...
  The {\tt query-response-interval} must be less than the {\tt
  query-interval}.
