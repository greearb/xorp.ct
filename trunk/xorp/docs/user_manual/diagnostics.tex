%
% $XORP: xorp/docs/user_manual/diagnostics.tex,v 1.2 2005/04/07 03:09:12 pavlin Exp $
%
...
XORP supports severail operational commands in {\stt xorpsh}
...
Xorp> \textbf{traceroute 10.4.0.2}\\
