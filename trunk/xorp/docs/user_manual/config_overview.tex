%
% $XORP: xorp/docs/user_manual/config_overview.tex,v 1.8 2005/05/14 04:20:20 pavlin Exp $
%
...
The {\tt hello-period} parameter is used to configure the PIM Hello messages
period (in seconds)~\footnote{Note that the {\tt hello-period} statement
appeared after XORP Release-1.1.}. It must be an integer between 1 and 18724.
