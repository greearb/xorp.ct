%
% $XORP: xorp/docs/user_manual/policy.tex,v 1.3 2006/03/08 10:08:27 atanu Exp $
%
...
\hline
{\tt localpref} & {\tt :} & u32 & Matches the local preference of the route. \\
\hline
{\tt was-aggregated} & {\tt :} & bool & True if this route contributed to origination of an aggregate route. \\
\end{tabular}
...
\hline
{\tt aggregate-prefix-len} & {\tt :} & u32 & Originate an aggregate route with this prefix length. \\
\end{tabular}
...
work (only changes in rip$[$ng$]$.tp files should be required).
