...
#
# $XORP: xorp/bgp/harness/test_peering2.sh,v 1.14 2003/06/20 19:33:24 atanu Exp $
#
...
test2()
{
	...
	# Wait for the session to get dropped, this will cause an error
	# to be generated by the coordinator.
	while ! coord peer1 assert established 2> /dev/null
	do
	    sleep 1
	done
