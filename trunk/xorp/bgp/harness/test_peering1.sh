...
#
# $XORP: xorp/bgp/harness/test_peering1.sh,v 1.33 2005/06/29 20:03:08 atanu Exp $
#
...
TESTS_NOT_FIXED='test5'
TESTS='test1 test2 test3 test4 test6 test7 test8 test8_ipv6
