...
public:
    ...
    typedef XorpCallback1<void, const XrlError&>::RefPtr AddStaticRouteCB;
    /**
     *  Send Xrl intended to:
     *
     *  Add a static route.
    ...
    typedef XorpCallback1<void, const XrlError&>::RefPtr DeleteStaticRouteCB;
    /**
     *  Send Xrl intended to:
     *
     *  Remove static route.
...
private:
    ...
    void unmarshall_add_static_route(
	const XrlError&	e,
	XrlArgs*	a,
	AddStaticRouteCB		cb
    );

    void unmarshall_delete_static_route(
	const XrlError&	e,
	XrlArgs*	a,
