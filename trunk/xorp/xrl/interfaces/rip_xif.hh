 ...
 *
 * $XORP: xorp/xrl/interfaces/rip_xif.hh,v 1.6 2005/03/25 02:54:54 pavlin Exp $
 */
...
public:
    ...
    typedef XorpCallback1<void, const XrlError&>::RefPtr SetMd5AuthenticationCB;
    /**
     *  Send Xrl intended to:
     *
     ...
     */
    bool send_set_md5_authentication(
	const char*	target_name,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
    ...
    typedef XorpCallback1<void, const XrlError&>::RefPtr DeleteMd5AuthenticationCB;
    /**
     *  Send Xrl intended to:
     *
     ...
     *  @param key_id the key ID (must be an integer in the interval [0, 255]).
     */
    bool send_delete_md5_authentication(
	const char*	target_name,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
private:
    ...
    void unmarshall_set_md5_authentication(
	const XrlError&	e,
	XrlArgs*	a,
	SetMd5AuthenticationCB		cb
    );

    void unmarshall_delete_md5_authentication(
	const XrlError&	e,
	XrlArgs*	a,
