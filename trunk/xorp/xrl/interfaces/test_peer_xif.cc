...
#ident "$XORP: xorp/xrl/interfaces/test_peer_xif.cc,v 1.3 2003/01/24 06:31:31 pavlin Exp $"
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestPeerV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestPeerV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestPeerV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    x.args().add("port", port);
    return _sender->send(x, callback(this, &XrlTestPeerV0p1Client::unmarshall3, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestPeerV0p1Client::unmarshall4, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestPeerV0p1Client::unmarshall5, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestPeerV0p1Client::unmarshall6, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestPeerV0p1Client::unmarshall7, cb));
}
