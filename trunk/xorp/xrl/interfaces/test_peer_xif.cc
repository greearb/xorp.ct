...
#ident "$XORP: xorp/xrl/interfaces/test_peer_xif.cc,v 1.19 2007/07/16 22:29:25 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/register");
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/packetisation");
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/use_4byte_asnums");
    x.args().add("use", use);
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/connect");
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/listen");
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/bind");
    x.args().add("address", address);
    x.args().add("port", port);
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/send");
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/disconnect");
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/reset");
...
{
    Xrl x(dst_xrl_target_name, "test_peer/0.1/terminate");
