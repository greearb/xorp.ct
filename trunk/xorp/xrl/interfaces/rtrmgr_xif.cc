...
#ident "$XORP: xorp/xrl/interfaces/rtrmgr_xif.cc,v 1.1.1.1 2002/12/11 23:56:18 hodson Exp $"
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    x.args().add("clientname", clientname);
    x.args().add("token", token);
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall3, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall4, cb));
}
...
)
{
    ...
    x.args().add("token", token);
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall5, cb));
}
...
)
{
    ...
    x.args().add("token", token);
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall6, cb));
}
...
)
{
    ...
    x.args().add("token", token);
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall7, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall8, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall9, cb));
}
...
)
{
    ...
    x.args().add("token", token);
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall10, cb));
}
...
)
{
    ...
    x.args().add("timeout", timeout);
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall11, cb));
}
...
)
{
    ...
    x.args().add("token", token);
    x.args().add("node", node);
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall12, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall13, cb));
}
...
)
{
    ...
    x.args().add("target", target);
    x.args().add("filename", filename);
    return _router->send(x, callback(this, &XrlRtrmgrV0p1Client::unmarshall14, cb));
}
