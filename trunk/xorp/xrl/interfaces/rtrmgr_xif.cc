...
#ident "$XORP: xorp/xrl/interfaces/rtrmgr_xif.cc,v 1.21 2007/07/12 21:46:09 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/get_pid");
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/register_client");
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/unregister_client");
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/authenticate_client");
    x.args().add("userid", userid);
    x.args().add("clientname", clientname);
    x.args().add("token", token);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/enter_config_mode");
    x.args().add("token", token);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/leave_config_mode");
    x.args().add("token", token);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/get_config_users");
    x.args().add("token", token);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/get_running_config");
    x.args().add("token", token);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/apply_config_change");
    x.args().add("token", token);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/lock_config");
    x.args().add("token", token);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/unlock_config");
    x.args().add("token", token);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/lock_node");
    x.args().add("token", token);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/unlock_node");
    x.args().add("token", token);
    x.args().add("node", node);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/save_config");
    x.args().add("token", token);
    x.args().add("target", target);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/load_config");
    x.args().add("token", token);
    x.args().add("target", target);
    x.args().add("filename", filename);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr/0.1/set_config_directory");
