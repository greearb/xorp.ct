...
#ident "$XORP: xorp/xrl/interfaces/bgp_xif.cc,v 1.6 2003/01/24 06:31:29 pavlin Exp $"
...
)
{
    ...
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall13, cb));
}
...
)
{
    ...
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall14, cb));
}
...
)
{
    ...
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall15, cb));
}
...
)
{
    ...
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall16, cb));
}
...
)
{
    ...
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall17, cb));
}
...
)
{
    ...
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall18, cb));
}
...
)
{
    ...
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall19, cb));
}
...
)
{
	...
	a->get("min_as_orginiation_interval", min_as_orginiation_interval);
    ...
    cb->dispatch(e, &retry_interval, &hold_time, &keep_alive, &hold_time_conf, &keep_alive_conf, &min_as_orginiation_interval, &min_route_adv_interval);
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall20, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall21, cb));
}
...
)
{
    ...
    x.args().add("nlri", nlri);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall22, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall23, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall24, cb));
}
...
)
{
    ...
    x.args().add("token", token);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall25, cb));
}
...
)
{
    ...
    x.args().add("token", token);
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall26, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall27, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlBgpV0p2Client::unmarshall28, cb));
}
