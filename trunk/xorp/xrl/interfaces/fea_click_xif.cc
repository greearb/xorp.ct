...
#ident "$XORP: xorp/xrl/interfaces/fea_click_xif.cc,v 1.10 2007/02/16 22:47:36 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/load_click");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/unload_click");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/enable_click");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/start_click");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/stop_click");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/enable_duplicate_routes_to_kernel");
    x.args().add("enable", enable);
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/enable_kernel_click");
    x.args().add("enable", enable);
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/enable_kernel_click_install_on_startup");
    x.args().add("enable", enable);
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_kernel_click_modules");
    x.args().add("modules", modules);
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_kernel_click_mount_directory");
    x.args().add("directory", directory);
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_kernel_click_config_generator_file");
    x.args().add("kernel_click_config_generator_file", kernel_click_config_generator_file);
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/enable_user_click");
    x.args().add("enable", enable);
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_user_click_command_file");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_user_click_command_extra_arguments");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_user_click_command_execute_on_startup");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_user_click_control_address");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_user_click_control_socket_port");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_user_click_startup_config_file");
...
{
    Xrl x(dst_xrl_target_name, "fea_click/0.1/set_user_click_config_generator_file");
    x.args().add("user_click_config_generator_file", user_click_config_generator_file);
