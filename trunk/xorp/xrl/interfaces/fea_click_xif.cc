...
#ident "$XORP: xorp/xrl/interfaces/fea_click_xif.cc,v 1.6 2005/01/20 00:43:17 pavlin Exp $"
...
{
    Xrl x(the_tgt, "fea_click/0.1/enable_duplicate_routes_to_kernel");
    x.args().add("enable", enable);
...
{
    Xrl x(the_tgt, "fea_click/0.1/enable_kernel_click_install_on_startup");
    x.args().add("enable", enable);
...
{
    Xrl x(the_tgt, "fea_click/0.1/set_kernel_click_modules");
...
{
    Xrl x(the_tgt, "fea_click/0.1/set_kernel_click_mount_directory");
...
{
    Xrl x(the_tgt, "fea_click/0.1/set_kernel_click_config_generator_file");
...
{
    Xrl x(the_tgt, "fea_click/0.1/set_user_click_config_generator_file");
