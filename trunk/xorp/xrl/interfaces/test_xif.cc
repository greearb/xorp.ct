...
#ident "$XORP: xorp/xrl/interfaces/test_xif.cc,v 1.4 2003/02/06 22:21:30 hodson Exp $"
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestV1p0Client::unmarshall0, cb));
}
...
)
{
    ...
    x.args().add("msg", msg);
    return _sender->send(x, callback(this, &XrlTestV1p0Client::unmarshall1, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestV1p0Client::unmarshall2, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestV1p0Client::unmarshall3, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlTestV1p0Client::unmarshall4, cb));
}
