...
#ident "$XORP: xorp/xrl/interfaces/pim_xif.cc,v 1.25 2004/06/10 22:42:03 hodson Exp $"
...
)
{
	...
	XLOG_ERROR("Wrong number of arguments (%u != %u)", XORP_UINT_CAST(a->size()), 3);
...
)
{
	...
	XLOG_ERROR("Wrong number of arguments (%u != %u)", XORP_UINT_CAST(a->size()), 8);
...
)
{
	...
	XLOG_ERROR("Wrong number of arguments (%u != %u)", XORP_UINT_CAST(a->size()), 5);
...
)
{
	...
	XLOG_ERROR("Wrong number of arguments (%u != %u)", XORP_UINT_CAST(a->size()), 7);
