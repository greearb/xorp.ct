...
#ident "$XORP: xorp/xrl/interfaces/pim_xif.cc,v 1.34 2005/05/14 03:18:41 pavlin Exp $"
...
{
    Xrl x(the_tgt, "pim/0.1/add_config_cand_bsr4");
    x.args().add("scope_zone_id", scope_zone_id);
...
{
    Xrl x(the_tgt, "pim/0.1/add_config_cand_bsr6");
    x.args().add("scope_zone_id", scope_zone_id);
    x.args().add("is_scope_zone", is_scope_zone);
    x.args().add("vif_name", vif_name);
    x.args().add("vif_addr", vif_addr);
...
{
    Xrl x(the_tgt, "pim/0.1/add_config_cand_rp4");
...
{
    Xrl x(the_tgt, "pim/0.1/add_config_cand_rp6");
    x.args().add("group_prefix", group_prefix);
    x.args().add("is_scope_zone", is_scope_zone);
    x.args().add("vif_name", vif_name);
    x.args().add("vif_addr", vif_addr);
...
{
    Xrl x(the_tgt, "pim/0.1/delete_config_cand_rp4");
    x.args().add("group_prefix", group_prefix);
    x.args().add("is_scope_zone", is_scope_zone);
    x.args().add("vif_name", vif_name);
    x.args().add("vif_addr", vif_addr);
...
{
    Xrl x(the_tgt, "pim/0.1/delete_config_cand_rp6");
    x.args().add("group_prefix", group_prefix);
    x.args().add("is_scope_zone", is_scope_zone);
    x.args().add("vif_name", vif_name);
    x.args().add("vif_addr", vif_addr);
...
{
    Xrl x(the_tgt, "pim/0.1/delete_config_all_static_group_prefixes_rp4");
    x.args().add("rp_addr", rp_addr);
...
{
    Xrl x(the_tgt, "pim/0.1/delete_config_all_static_group_prefixes_rp6");
    x.args().add("rp_addr", rp_addr);
...
{
    Xrl x(the_tgt, "pim/0.1/delete_config_all_static_rps");
...
{
    Xrl x(the_tgt, "pim/0.1/get_vif_ip_router_alert_option_check");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "pim/0.1/set_vif_ip_router_alert_option_check");
    x.args().add("vif_name", vif_name);
    x.args().add("enable", enable);
...
{
    Xrl x(the_tgt, "pim/0.1/reset_vif_ip_router_alert_option_check");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "pim/0.1/get_vif_propagation_delay");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "pim/0.1/set_vif_propagation_delay");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "pim/0.1/reset_vif_propagation_delay");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "pim/0.1/add_alternative_subnet4");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "pim/0.1/add_alternative_subnet6");
    x.args().add("vif_name", vif_name);
    x.args().add("subnet", subnet);
...
{
    Xrl x(the_tgt, "pim/0.1/delete_alternative_subnet4");
    x.args().add("vif_name", vif_name);
    x.args().add("subnet", subnet);
...
{
    Xrl x(the_tgt, "pim/0.1/delete_alternative_subnet6");
    x.args().add("vif_name", vif_name);
    x.args().add("subnet", subnet);
...
{
    Xrl x(the_tgt, "pim/0.1/remove_all_alternative_subnets");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "pim/0.1/log_trace_all");
    x.args().add("enable", enable);
