...
#ident "$XORP: xorp/xrl/interfaces/pim_xif.cc,v 1.3 2003/01/10 00:30:29 hodson Exp $"
...
)
{
    ...
    return _router->send(x, callback(this, &XrlPimV0p1Client::unmarshall75, cb));
}
...
)
{
    ...
    x.args().add("metric_preference", metric_preference);
    x.args().add("metric", metric);
    return _router->send(x, callback(this, &XrlPimV0p1Client::unmarshall76, cb));
}
