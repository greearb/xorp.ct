...
#ident "$XORP: xorp/xrl/interfaces/mld6igmp_xif.cc,v 1.19 2005/06/01 09:34:01 pavlin Exp $"
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/get_vif_ip_router_alert_option_check");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/set_vif_ip_router_alert_option_check");
    x.args().add("vif_name", vif_name);
    x.args().add("enable", enable);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/reset_vif_ip_router_alert_option_check");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/get_vif_query_interval");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/set_vif_query_interval");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/reset_vif_query_interval");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/get_vif_query_last_member_interval");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/set_vif_query_last_member_interval");
    x.args().add("vif_name", vif_name);
    x.args().add("interval_sec", interval_sec);
    x.args().add("interval_usec", interval_usec);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/reset_vif_query_last_member_interval");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/get_vif_query_response_interval");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/set_vif_query_response_interval");
    x.args().add("vif_name", vif_name);
    x.args().add("interval_sec", interval_sec);
    x.args().add("interval_usec", interval_usec);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/reset_vif_query_response_interval");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/get_vif_robust_count");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/set_vif_robust_count");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(the_tgt, "mld6igmp/0.1/reset_vif_robust_count");
    x.args().add("vif_name", vif_name);
