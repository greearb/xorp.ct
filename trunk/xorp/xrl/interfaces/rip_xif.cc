...
#ident "$XORP: xorp/xrl/interfaces/rip_xif.cc,v 1.9 2005/03/25 02:54:54 pavlin Exp $"
...
{
    Xrl x(the_tgt, "rip/0.1/add_rip_address");
...
{
    Xrl x(the_tgt, "rip/0.1/remove_rip_address");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/set_rip_address_enabled");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/rip_address_enabled");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/set_cost");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/set_horizon");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/set_passive");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/set_accept_non_rip_requests");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/accept_non_rip_requests");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/set_accept_default_route");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("accept", accept);
...
{
    Xrl x(the_tgt, "rip/0.1/accept_default_route");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/set_advertise_default_route");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/advertise_default_route");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
bool
XrlRipV0p1Client::send_set_route_expiry_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/set_route_expiry_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_route_expiry_seconds, cb));
}


/* Unmarshall set_route_expiry_seconds */
void
XrlRipV0p1Client::unmarshall_set_route_expiry_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_route_expiry_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/route_expiry_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_route_expiry_seconds, cb));
}


/* Unmarshall route_expiry_seconds */
void
XrlRipV0p1Client::unmarshall_route_expiry_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_set_route_deletion_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/set_route_deletion_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_route_deletion_seconds, cb));
}


/* Unmarshall set_route_deletion_seconds */
void
XrlRipV0p1Client::unmarshall_set_route_deletion_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_route_deletion_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/route_deletion_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_route_deletion_seconds, cb));
}


/* Unmarshall route_deletion_seconds */
void
XrlRipV0p1Client::unmarshall_route_deletion_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_set_table_request_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/set_table_request_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_table_request_seconds, cb));
}


/* Unmarshall set_table_request_seconds */
void
XrlRipV0p1Client::unmarshall_set_table_request_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_table_request_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/table_request_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_table_request_seconds, cb));
}


/* Unmarshall table_request_seconds */
void
XrlRipV0p1Client::unmarshall_table_request_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_set_unsolicited_response_min_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/set_unsolicited_response_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_unsolicited_response_min_seconds, cb));
}


/* Unmarshall set_unsolicited_response_min_seconds */
void
XrlRipV0p1Client::unmarshall_set_unsolicited_response_min_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_unsolicited_response_min_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/unsolicited_response_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_unsolicited_response_min_seconds, cb));
}


/* Unmarshall unsolicited_response_min_seconds */
void
XrlRipV0p1Client::unmarshall_unsolicited_response_min_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_set_unsolicited_response_max_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/set_unsolicited_response_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_unsolicited_response_max_seconds, cb));
}


/* Unmarshall set_unsolicited_response_max_seconds */
void
XrlRipV0p1Client::unmarshall_set_unsolicited_response_max_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_unsolicited_response_max_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/unsolicited_response_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_unsolicited_response_max_seconds, cb));
}


/* Unmarshall unsolicited_response_max_seconds */
void
XrlRipV0p1Client::unmarshall_unsolicited_response_max_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_set_triggered_update_min_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/set_triggered_update_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_triggered_update_min_seconds, cb));
}


/* Unmarshall set_triggered_update_min_seconds */
void
XrlRipV0p1Client::unmarshall_set_triggered_update_min_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_triggered_update_min_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/triggered_update_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_triggered_update_min_seconds, cb));
}


/* Unmarshall triggered_update_min_seconds */
void
XrlRipV0p1Client::unmarshall_triggered_update_min_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_set_triggered_update_max_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/set_triggered_update_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_triggered_update_max_seconds, cb));
}


/* Unmarshall set_triggered_update_max_seconds */
void
XrlRipV0p1Client::unmarshall_set_triggered_update_max_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_triggered_update_max_seconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/triggered_update_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_triggered_update_max_seconds, cb));
}


/* Unmarshall triggered_update_max_seconds */
void
XrlRipV0p1Client::unmarshall_triggered_update_max_seconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_set_interpacket_delay_milliseconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/set_interpacket_delay_milliseconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_msecs", t_msecs);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_interpacket_delay_milliseconds, cb));
}


/* Unmarshall set_interpacket_delay_milliseconds */
void
XrlRipV0p1Client::unmarshall_set_interpacket_delay_milliseconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_interpacket_delay_milliseconds(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/interpacket_delay_milliseconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_interpacket_delay_milliseconds, cb));
}


/* Unmarshall interpacket_delay_milliseconds */
void
XrlRipV0p1Client::unmarshall_interpacket_delay_milliseconds(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_set_authentication(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/set_authentication");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("type", type);
    x.args().add("password", password);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_authentication, cb));
}


/* Unmarshall set_authentication */
void
XrlRipV0p1Client::unmarshall_set_authentication(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_authentication(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
...
{
    Xrl x(the_tgt, "rip/0.1/authentication");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_authentication, cb));
}


/* Unmarshall authentication */
void
XrlRipV0p1Client::unmarshall_authentication(
	const XrlError&	e,
	XrlArgs*	a,
	AuthenticationCB		cb
)
{
    ...
    try {
	a->get("type", type);
	a->get("password", password);
    } catch (const XrlArgs::XrlAtomNotFound&) {
	XLOG_ERROR("Atom not found");
	cb->dispatch(XrlError::BAD_ARGS(), 0, 0);
	return;
    }
    cb->dispatch(e, &type, &password);
}

bool
XrlRipV0p1Client::send_set_md5_authentication(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
	...
	const SetMd5AuthenticationCB&	cb
)
{
    Xrl x(the_tgt, "rip/0.1/set_md5_authentication");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    ...
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_set_md5_authentication, cb));
}


/* Unmarshall set_md5_authentication */
void
XrlRipV0p1Client::unmarshall_set_md5_authentication(
	const XrlError&	e,
	XrlArgs*	a,
	SetMd5AuthenticationCB		cb
)
{
    if (e != XrlError::OKAY()) {
	cb->dispatch(e);
...
bool
XrlRipV0p1Client::send_delete_md5_authentication(
	const char*	the_tgt,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
	const uint32_t&	key_id,
	const DeleteMd5AuthenticationCB&	cb
)
{
    Xrl x(the_tgt, "rip/0.1/delete_md5_authentication");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("key_id", key_id);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_delete_md5_authentication, cb));
}


/* Unmarshall delete_md5_authentication */
void
XrlRipV0p1Client::unmarshall_delete_md5_authentication(
	const XrlError&	e,
	XrlArgs*	a,
	DeleteMd5AuthenticationCB		cb
)
{
    if (e != XrlError::OKAY()) {
	cb->dispatch(e);
...
{
    Xrl x(the_tgt, "rip/0.1/rip_address_status");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/get_all_addresses");
...
{
    Xrl x(the_tgt, "rip/0.1/get_counters");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/get_peers");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(the_tgt, "rip/0.1/get_all_peers");
...
{
    Xrl x(the_tgt, "rip/0.1/get_peer_counters");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
bool
XrlRipV0p1Client::send_redist_protocol_routes(
	const char*	the_tgt,
...
{
    Xrl x(the_tgt, "rip/0.1/redist_protocol_routes");
    x.args().add("protocol_name", protocol_name);
    x.args().add("cost", cost);
    x.args().add("tag", tag);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_redist_protocol_routes, cb));
}


/* Unmarshall redist_protocol_routes */
void
XrlRipV0p1Client::unmarshall_redist_protocol_routes(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_no_redist_protocol_routes(
	const char*	the_tgt,
	const string&	protocol_name,
	const NoRedistProtocolRoutesCB&	cb
)
{
    Xrl x(the_tgt, "rip/0.1/no_redist_protocol_routes");
    x.args().add("protocol_name", protocol_name);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_no_redist_protocol_routes, cb));
}


/* Unmarshall no_redist_protocol_routes */
void
XrlRipV0p1Client::unmarshall_no_redist_protocol_routes(
	const XrlError&	e,
	XrlArgs*	a,
