...
#ident "$XORP: xorp/xrl/interfaces/rip_xif.cc,v 1.16 2007/02/16 22:47:43 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_update_interval");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/update_interval");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_update_jitter");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/update_jitter");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_triggered_update_delay");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/triggered_update_delay");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_triggered_update_jitter");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_jitter", t_jitter);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/triggered_update_jitter");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
