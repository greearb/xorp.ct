...
bool
XrlRipV0p1Client::send_add_static_route(
	const char*	the_tgt,
...
{
    Xrl x(the_tgt, "rip/0.1/add_static_route");
    x.args().add("network", network);
    x.args().add("nexthop", nexthop);
    x.args().add("cost", cost);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_add_static_route, cb));
}


/* Unmarshall add_static_route */
void
XrlRipV0p1Client::unmarshall_add_static_route(
	const XrlError&	e,
	XrlArgs*	a,
	AddStaticRouteCB		cb
)
...
bool
XrlRipV0p1Client::send_delete_static_route(
	const char*	the_tgt,
	const IPv4Net&	network,
	const DeleteStaticRouteCB&	cb
)
{
    Xrl x(the_tgt, "rip/0.1/delete_static_route");
    x.args().add("network", network);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_delete_static_route, cb));
}


/* Unmarshall delete_static_route */
void
XrlRipV0p1Client::unmarshall_delete_static_route(
	const XrlError&	e,
	XrlArgs*	a,
