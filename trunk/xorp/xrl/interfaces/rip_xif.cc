...
#ident "$XORP: xorp/xrl/interfaces/rip_xif.cc,v 1.12 2006/03/16 00:06:19 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/add_rip_address");
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/remove_rip_address");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_rip_address_enabled");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/rip_address_enabled");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_cost");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/cost");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_horizon");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/horizon");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_passive");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/passive");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_accept_non_rip_requests");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/accept_non_rip_requests");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_accept_default_route");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("accept", accept);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/accept_default_route");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_advertise_default_route");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/advertise_default_route");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_route_expiry_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/route_expiry_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_route_deletion_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/route_deletion_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_table_request_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/table_request_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_unsolicited_response_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/unsolicited_response_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_unsolicited_response_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/unsolicited_response_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_triggered_update_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/triggered_update_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_triggered_update_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/triggered_update_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_interpacket_delay_milliseconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/interpacket_delay_milliseconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_simple_authentication_key");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/delete_simple_authentication_key");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/set_md5_authentication_key");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/delete_md5_authentication_key");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("key_id", key_id);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/rip_address_status");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/get_all_addresses");
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/get_counters");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/get_peers");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/get_all_peers");
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/get_peer_counters");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/redist_protocol_routes");
...
{
    Xrl x(dst_xrl_target_name, "rip/0.1/no_redist_protocol_routes");
    x.args().add("protocol_name", protocol_name);
