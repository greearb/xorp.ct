...
#ident "$XORP: xorp/xrl/interfaces/rip_xif.cc,v 1.3 2004/05/24 17:35:38 hodson Exp $"
...
bool
XrlRipV0p1Client::send_import_protocol_routes(
	const char*	the_tgt,
...
{
    Xrl x(the_tgt, "rip/0.1/import_protocol_routes");
    x.args().add("protocol_name", protocol_name);
    x.args().add("cost", cost);
    x.args().add("tag", tag);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_import_protocol_routes, cb));
}


/* Unmarshall import_protocol_routes */
void
XrlRipV0p1Client::unmarshall_import_protocol_routes(
	const XrlError&	e,
	XrlArgs*	a,
...
bool
XrlRipV0p1Client::send_no_import_protocol_routes(
	const char*	the_tgt,
	const string&	protocol_name,
	const NoImportProtocolRoutesCB&	cb
)
{
    Xrl x(the_tgt, "rip/0.1/no_import_protocol_routes");
    x.args().add("protocol_name", protocol_name);
    return _sender->send(x, callback(this, &XrlRipV0p1Client::unmarshall_no_import_protocol_routes, cb));
}


/* Unmarshall no_import_protocol_routes */
void
XrlRipV0p1Client::unmarshall_no_import_protocol_routes(
	const XrlError&	e,
	XrlArgs*	a,
