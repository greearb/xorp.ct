...
#ident "$XORP: xorp/xrl/interfaces/ripng_xif.cc,v 1.22 2008/10/29 21:59:41 andrewma Exp $"
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/add_rip_address");
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/remove_rip_address");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_rip_address_enabled");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/rip_address_enabled");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_cost");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/cost");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_horizon");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/horizon");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_passive");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/passive");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_accept_non_rip_requests");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/accept_non_rip_requests");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_accept_default_route");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
        x->args().add(XrlAtom(accept));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/accept_default_route");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_advertise_default_route");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/advertise_default_route");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_route_timeout");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/route_timeout");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_deletion_delay");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
        x->args().add(XrlAtom(t_secs));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/deletion_delay");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_request_interval");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
        x->args().add(XrlAtom(t_secs));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/request_interval");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_update_interval");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
        x->args().add(XrlAtom(t_secs));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/update_interval");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_update_jitter");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/update_jitter");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_triggered_update_delay");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
        x->args().add(XrlAtom(t_secs));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/triggered_update_delay");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_triggered_update_jitter");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
        x->args().add(XrlAtom(t_jitter));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/triggered_update_jitter");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/set_interpacket_delay");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/interpacket_delay");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/rip_address_status");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/get_all_addresses");
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/get_counters");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/get_peers");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/get_all_peers");
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/get_peer_counters");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ripng/0.1/trace");
    ...
    return _sender->send(*x, callback(this, &XrlRipngV0p1Client::unmarshall_trace, cb));
}


/* Unmarshall trace */
void
XrlRipngV0p1Client::unmarshall_trace(
	const XrlError&	e,
	XrlArgs*	a,
	TraceCB		cb
)
