...
#ident "$XORP: xorp/xrl/interfaces/ripng_xif.cc,v 1.11 2006/03/26 22:39:28 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "ripng/0.1/set_unsolicited_response_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "ripng/0.1/unsolicited_response_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "ripng/0.1/set_unsolicited_response_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "ripng/0.1/unsolicited_response_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "ripng/0.1/set_triggered_update_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "ripng/0.1/triggered_update_min_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
...
{
    Xrl x(dst_xrl_target_name, "ripng/0.1/set_triggered_update_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("t_secs", t_secs);
...
{
    Xrl x(dst_xrl_target_name, "ripng/0.1/triggered_update_max_seconds");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
