...
#ident "$XORP: xorp/xrl/interfaces/test_xrls_xif.cc,v 1.10 2008/01/04 03:18:02 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "test_xrls/0.1/start_transmission");
...
{
    Xrl x(dst_xrl_target_name, "test_xrls/0.1/end_transmission");
...
{
    Xrl x(dst_xrl_target_name, "test_xrls/0.1/add_xrl0");
...
{
    Xrl x(dst_xrl_target_name, "test_xrls/0.1/add_xrl1");
...
{
    Xrl x(dst_xrl_target_name, "test_xrls/0.1/add_xrl2");
    x.args().add("data1", data1);
...
{
    Xrl x(dst_xrl_target_name, "test_xrls/0.1/add_xrl9");
    x.args().add("data1", data1);
    x.args().add("data2", data2);
...
{
    Xrl x(dst_xrl_target_name, "test_xrls/0.1/add_xrlx");
