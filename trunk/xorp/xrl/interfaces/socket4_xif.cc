...
#ident "$XORP: xorp/xrl/interfaces/socket4_xif.cc,v 1.10 2005/03/25 02:54:55 pavlin Exp $"
...
{
    Xrl x(the_tgt, "socket4/0.1/udp_join_group");
...
{
    Xrl x(the_tgt, "socket4/0.1/udp_leave_group");
    x.args().add("sockid", sockid);
    x.args().add("mcast_addr", mcast_addr);
...
{
    Xrl x(the_tgt, "socket4/0.1/send_from_multicast_if");
    x.args().add("sockid", sockid);
