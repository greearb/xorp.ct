...
#ident "$XORP: xorp/xrl/interfaces/cli_processor_xif.cc,v 1.1.1.1 2002/12/11 23:56:17 hodson Exp $"
...
)
{
    ...
    return _router->send(x, callback(this, &XrlCliProcessorV0p1Client::unmarshall0, cb));
}


/* Unmarshall process_command */
void
XrlCliProcessorV0p1Client::unmarshall0(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB0		cb
)
