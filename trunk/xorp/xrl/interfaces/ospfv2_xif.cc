...
#ident "$XORP: xorp/xrl/interfaces/ospfv2_xif.cc,v 1.7 2005/10/22 18:44:51 atanu Exp $"
...
)
{
    ...
    cb->dispatch(e, &valid, &address, &interface, &state, &rid, &priority, &area, &opt, &dr, &bdr, &up, &adjacent);
}
