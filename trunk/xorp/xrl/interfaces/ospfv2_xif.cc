...
#ident "$XORP: xorp/xrl/interfaces/ospfv2_xif.cc,v 1.33 2008/09/23 08:13:18 abittau Exp $"
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_router_id");
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_rfc1583_compatibility");
        x->args().add(XrlAtom(compatibility));
    }

    x->set_target(dst_xrl_target_name);

    x->args().set_arg(0, compatibility);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_ip_router_alert");
        x->args().add(XrlAtom(ip_router_alert));
    }

    x->set_target(dst_xrl_target_name);

    x->args().set_arg(0, ip_router_alert);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/create_area_router");
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(type));
    }

    x->set_target(dst_xrl_target_name);

    x->args().set_arg(0, area);
    x->args().set_arg(1, type);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/change_area_router_type");
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(type));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/destroy_area_router");
        x->args().add(XrlAtom(area));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/create_peer");
    ...
    x->args().set_arg(3, type);
    x->args().set_arg(4, area);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/delete_peer");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_peer_state");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/add_neighbour");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(neighbour_address));
        x->args().add(XrlAtom(neighbour_id));
    }
    ...
    x->args().set_arg(0, ifname);
    x->args().set_arg(1, vifname);
    x->args().set_arg(2, area);
    x->args().set_arg(3, neighbour_address);
    x->args().set_arg(4, neighbour_id);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/remove_neighbour");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(neighbour_address));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/create_virtual_link");
        x->args().add(XrlAtom(neighbour_id));
        x->args().add(XrlAtom(area));
    }
    ...
    x->args().set_arg(0, neighbour_id);
    x->args().set_arg(1, area);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/delete_virtual_link");
        x->args().add(XrlAtom(neighbour_id));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/transit_area_virtual_link");
        x->args().add(XrlAtom(neighbour_id));
        x->args().add(XrlAtom(transit_area));
    }

    x->set_target(dst_xrl_target_name);

    x->args().set_arg(0, neighbour_id);
    x->args().set_arg(1, transit_area);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_interface_cost");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_retransmit_interval");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_inftransdelay");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(delay));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_router_priority");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_hello_interval");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(interval));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_router_dead_interval");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(interval));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_simple_authentication_key");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/delete_simple_authentication_key");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_md5_authentication_key");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
        ...
        x->args().add(XrlAtom(max_time_drift));
    }
    ...
    x->args().set_arg(7, max_time_drift);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/delete_md5_authentication_key");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(key_id));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/set_passive");
        x->args().add(XrlAtom(ifname));
        x->args().add(XrlAtom(vifname));
        x->args().add(XrlAtom(area));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/originate_default_route");
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(enable));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/stub_default_cost");
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(cost));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/summaries");
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(enable));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/area_range_add");
        x->args().add(XrlAtom(area));
    ...
    x->args().set_arg(0, area);
    x->args().set_arg(1, net);
    x->args().set_arg(2, advertise);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/area_range_delete");
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(net));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/area_range_change_state");
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(net));
        x->args().add(XrlAtom(advertise));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/trace");
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/get_lsa");
        x->args().add(XrlAtom(area));
        x->args().add(XrlAtom(index));
    }

    x->set_target(dst_xrl_target_name);

    x->args().set_arg(0, area);
    x->args().set_arg(1, index);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/get_area_list");
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/get_neighbour_list");
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/get_neighbour_info");
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "ospfv2/0.1/clear_database");
    }
