...
#ident "$XORP: xorp/xrl/interfaces/ospfv2_xif.cc,v 1.21 2006/03/16 00:06:14 pavlin Exp $"
...
{
    Xrl x(the_tgt, "ospfv2/0.1/set_rfc1583_compatibility");
...
)
{
    ...
    x.args().add("max_time_drift_secs", max_time_drift_secs);
