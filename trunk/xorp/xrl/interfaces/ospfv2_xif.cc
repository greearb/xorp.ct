...
#ident "$XORP: xorp/xrl/interfaces/ospfv2_xif.cc,v 1.18 2006/02/26 09:20:59 atanu Exp $"
...
bool
XrlOspfv2V0p1Client::send_set_rfc1583compatibility(
	const char*	the_tgt,
	const bool&	compatibility,
	const SetRfc1583CompatibilityCB&	cb
)
{
    Xrl x(the_tgt, "ospfv2/0.1/set_rfc1583compatibility");
    x.args().add("compatibility", compatibility);
    return _sender->send(x, callback(this, &XrlOspfv2V0p1Client::unmarshall_set_rfc1583compatibility, cb));
}


/* Unmarshall set_rfc1583compatibility */
void
XrlOspfv2V0p1Client::unmarshall_set_rfc1583compatibility(
	const XrlError&	e,
	XrlArgs*	a,
...
{
    Xrl x(the_tgt, "ospfv2/0.1/change_area_router_type");
    x.args().add("area", area);
    x.args().add("type", type);
...
{
    Xrl x(the_tgt, "ospfv2/0.1/set_simple_authentication_key");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("area", area);
...
{
    Xrl x(the_tgt, "ospfv2/0.1/delete_simple_authentication_key");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("area", area);
...
{
    Xrl x(the_tgt, "ospfv2/0.1/set_md5_authentication_key");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("area", area);
...
{
    Xrl x(the_tgt, "ospfv2/0.1/delete_md5_authentication_key");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("area", area);
    x.args().add("key_id", key_id);
...
{
    Xrl x(the_tgt, "ospfv2/0.1/set_passive");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("area", area);
...
{
    Xrl x(the_tgt, "ospfv2/0.1/originate_default_route");
    x.args().add("area", area);
    x.args().add("enable", enable);
...
{
    Xrl x(the_tgt, "ospfv2/0.1/stub_default_cost");
    x.args().add("area", area);
    x.args().add("cost", cost);
...
{
    Xrl x(the_tgt, "ospfv2/0.1/summaries");
    x.args().add("area", area);
    x.args().add("enable", enable);
