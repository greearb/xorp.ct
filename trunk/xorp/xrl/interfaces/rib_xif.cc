...
#ident "$XORP: xorp/xrl/interfaces/rib_xif.cc,v 1.1.1.1 2002/12/11 23:56:18 hodson Exp $"
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall3, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall4, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall5, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall6, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall7, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall8, cb));
}
...
)
{
    ...
    x.args().add("nexthop", nexthop);
    x.args().add("metric", metric);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall9, cb));
}
...
)
{
    ...
    x.args().add("nexthop", nexthop);
    x.args().add("metric", metric);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall10, cb));
}
...
)
{
    ...
    x.args().add("nexthop", nexthop);
    x.args().add("metric", metric);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall11, cb));
}
...
)
{
    ...
    x.args().add("multicast", multicast);
    x.args().add("network", network);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall12, cb));
}
...
)
{
    ...
    x.args().add("multicast", multicast);
    x.args().add("network", network);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall13, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall14, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall15, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall16, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall17, cb));
}
...
)
{
    ...
    x.args().add("addr", addr);
    x.args().add("subnet", subnet);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall18, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall19, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall20, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall21, cb));
}
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall22, cb));
}
...
)
{
    ...
    x.args().add("addr", addr);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall23, cb));
}
...
)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 6)", a->size());
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall24, cb));
}
...
)
{
    ...
    x.args().add("target", target);
    x.args().add("addr", addr);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall25, cb));
}
...
)
{
    ...
    x.args().add("addr", addr);
    x.args().add("prefix", prefix);
    return _router->send(x, callback(this, &XrlRibV0p1Client::unmarshall26, cb));
}
