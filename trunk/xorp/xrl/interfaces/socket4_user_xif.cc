...
#ident "$XORP: xorp/xrl/interfaces/socket4_user_xif.cc,v 1.11 2007/02/16 22:47:44 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "socket4_user/0.1/connect_event");
    x.args().add("sockid", sockid);
    x.args().add("src_host", src_host);
    x.args().add("src_port", src_port);
...
{
    Xrl x(dst_xrl_target_name, "socket4_user/0.1/close_event");
    x.args().add("sockid", sockid);
