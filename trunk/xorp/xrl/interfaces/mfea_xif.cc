...
#ident "$XORP: xorp/xrl/interfaces/mfea_xif.cc,v 1.22 2007/02/16 22:47:39 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/have_multicast_routing4");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/have_multicast_routing6");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/add_protocol4");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/add_protocol6");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/delete_protocol4");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/delete_protocol6");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/start_protocol_vif4");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/start_protocol_vif6");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/stop_protocol_vif4");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/stop_protocol_vif6");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/allow_signal_messages");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/join_multicast_group4");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/join_multicast_group6");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/delete_dataflow_monitor6");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("source_address", source_address);
    x.args().add("group_address", group_address);
    x.args().add("threshold_interval_sec", threshold_interval_sec);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/delete_all_dataflow_monitor4");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("source_address", source_address);
    x.args().add("group_address", group_address);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/delete_all_dataflow_monitor6");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("source_address", source_address);
    x.args().add("group_address", group_address);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/enable_vif");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/start_vif");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/stop_vif");
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/enable_all_vifs");
    x.args().add("enable", enable);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/start_all_vifs");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/stop_all_vifs");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/enable_mfea");
    x.args().add("enable", enable);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/start_mfea");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/stop_mfea");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/enable_cli");
    x.args().add("enable", enable);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/start_cli");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/stop_cli");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/log_trace_all");
    x.args().add("enable", enable);
