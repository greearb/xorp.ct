...
#ident "$XORP: xorp/xrl/interfaces/mfea_xif.cc,v 1.10 2003/09/23 03:35:39 pavlin Exp $"
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall_disable_vif, cb));
}


/* Unmarshall disable_vif */
void
XrlMfeaV0p1Client::unmarshall_disable_vif(
	const XrlError&	e,
	XrlArgs*	a,
	DisableVifCB		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall_disable_all_vifs, cb));
}


/* Unmarshall disable_all_vifs */
void
XrlMfeaV0p1Client::unmarshall_disable_all_vifs(
	const XrlError&	e,
	XrlArgs*	a,
	DisableAllVifsCB		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall_disable_mfea, cb));
}


/* Unmarshall disable_mfea */
void
XrlMfeaV0p1Client::unmarshall_disable_mfea(
	const XrlError&	e,
	XrlArgs*	a,
	DisableMfeaCB		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall_disable_cli, cb));
}


/* Unmarshall disable_cli */
void
XrlMfeaV0p1Client::unmarshall_disable_cli(
	const XrlError&	e,
	XrlArgs*	a,
	DisableCliCB		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall_enable_log_trace, cb));
}


/* Unmarshall enable_log_trace */
void
XrlMfeaV0p1Client::unmarshall_enable_log_trace(
	const XrlError&	e,
	XrlArgs*	a,
	EnableLogTraceCB		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall_disable_log_trace, cb));
}


/* Unmarshall disable_log_trace */
void
XrlMfeaV0p1Client::unmarshall_disable_log_trace(
	const XrlError&	e,
	XrlArgs*	a,
