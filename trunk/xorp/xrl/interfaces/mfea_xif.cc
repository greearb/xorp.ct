...
#ident "$XORP: xorp/xrl/interfaces/mfea_xif.cc,v 1.24 2007/05/19 01:52:48 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/register_protocol4");
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/register_protocol6");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("if_name", if_name);
    x.args().add("vif_name", vif_name);
    x.args().add("ip_protocol", ip_protocol);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/unregister_protocol4");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("if_name", if_name);
    x.args().add("vif_name", vif_name);
...
{
    Xrl x(dst_xrl_target_name, "mfea/0.1/unregister_protocol6");
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("if_name", if_name);
    x.args().add("vif_name", vif_name);
