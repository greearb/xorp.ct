 ...
 *
 * $XORP: xorp/xrl/interfaces/ospfv2_xif.hh,v 1.7 2005/10/22 18:44:51 atanu Exp $
 */
...
public:
    ...
    typedef XorpCallback13<void, const XrlError&, const bool*, const string*, const string*, const string*, const IPv4*, const uint32_t*, const IPv4*, const uint32_t*, const IPv4*, const IPv4*, const uint32_t*, const uint32_t*>::RefPtr GetNeighbourInfoCB;
    /**
     *  Send Xrl intended to:
     *
