...
#ident "$XORP: xorp/xrl/interfaces/finder_xif.cc,v 1.10 2003/05/09 19:36:04 hodson Exp $"
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall0, cb));
}


/* Unmarshall register_finder_client */
void
XrlFinderV0p2Client::unmarshall0(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB0		cb
)
...
)
{
    ...
    x.args().add("instance_name", instance_name);
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall1, cb));
}


/* Unmarshall unregister_finder_client */
void
XrlFinderV0p2Client::unmarshall1(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB1		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall2, cb));
}


/* Unmarshall set_finder_client_enabled */
void
XrlFinderV0p2Client::unmarshall2(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB2		cb
)
...
)
{
    ...
    x.args().add("instance_name", instance_name);
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall3, cb));
}


/* Unmarshall finder_client_enabled */
void
XrlFinderV0p2Client::unmarshall3(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB3		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall4, cb));
}


/* Unmarshall add_xrl */
void
XrlFinderV0p2Client::unmarshall4(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB4		cb
)
...
)
{
    ...
    x.args().add("xrl", xrl);
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall5, cb));
}


/* Unmarshall remove_xrl */
void
XrlFinderV0p2Client::unmarshall5(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB5		cb
)
...
)
{
    ...
    x.args().add("xrl", xrl);
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall6, cb));
}


/* Unmarshall resolve_xrl */
void
XrlFinderV0p2Client::unmarshall6(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB6		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall7, cb));
}


/* Unmarshall get_xrl_targets */
void
XrlFinderV0p2Client::unmarshall7(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB7		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall8, cb));
}


/* Unmarshall get_xrls_registered_by */
void
XrlFinderV0p2Client::unmarshall8(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB8		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall9, cb));
}


/* Unmarshall get_ipv4_permitted_hosts */
void
XrlFinderV0p2Client::unmarshall9(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB9		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall10, cb));
}


/* Unmarshall get_ipv4_permitted_nets */
void
XrlFinderV0p2Client::unmarshall10(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB10		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall11, cb));
}


/* Unmarshall get_ipv6_permitted_hosts */
void
XrlFinderV0p2Client::unmarshall11(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB11		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p2Client::unmarshall12, cb));
}


/* Unmarshall get_ipv6_permitted_nets */
void
XrlFinderV0p2Client::unmarshall12(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB12		cb
)
