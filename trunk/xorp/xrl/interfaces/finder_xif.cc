...
#ident "$XORP: xorp/xrl/interfaces/finder_xif.cc,v 1.8 2003/03/06 01:26:24 hodson Exp $"
...
bool
XrlFinderV0p1Client::send_set_finder_client_enabled(
	const char*	the_tgt, 
	const string&	target_name, 
	const bool&	enabled, 
	const CB2&	cb
...
{
    Xrl x(the_tgt, "finder/0.1/set_finder_client_enabled");
    x.args().add("target_name", target_name);
...
bool
XrlFinderV0p1Client::send_finder_client_enabled(
	const char*	the_tgt, 
	const string&	target_name, 
	const CB3&	cb
)
{
    Xrl x(the_tgt, "finder/0.1/finder_client_enabled");
    x.args().add("target_name", target_name);
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p1Client::unmarshall11, cb));
}


/* Unmarshall get_ipv6_permitted_hosts */
void
XrlFinderV0p1Client::unmarshall11(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB11		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFinderV0p1Client::unmarshall12, cb));
}


/* Unmarshall get_ipv6_permitted_nets */
void
XrlFinderV0p1Client::unmarshall12(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB12		cb
)
