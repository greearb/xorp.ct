...
#ident "$XORP: xorp/xrl/interfaces/redist_transaction4_xif.cc,v 1.10 2005/03/25 02:54:53 pavlin Exp $"
...
{
    Xrl x(the_tgt, "redist_transaction4/0.1/delete_all_routes");
    x.args().add("tid", tid);
    x.args().add("cookie", cookie);
