 ...
 *
 * $XORP: xorp/xrl/interfaces/pim_xif.hh,v 1.1.1.1 2002/12/11 23:56:18 hodson Exp $
 */
...
public:
    XrlPimV0p1Client(XrlRouter* r) : _router(r) {}
    ...
    typedef XorpCallback4<void, const XrlError&, const uint32_t*, const bool*, const string*>::RefPtr CB63;
