...
bool
XrlFib2mribV0p1Client::send_add_route4(
	const char*	the_tgt,
	const bool&	unicast,
...
{
    Xrl x(the_tgt, "fib2mrib/0.1/add_route4");
    ...
    return _sender->send(x, callback(this, &XrlFib2mribV0p1Client::unmarshall_add_route4, cb));
}


/* Unmarshall add_route4 */
void
XrlFib2mribV0p1Client::unmarshall_add_route4(
	const XrlError&	e,
	XrlArgs*	a,
	AddRoute4CB		cb
)
...
bool
XrlFib2mribV0p1Client::send_add_route6(
	const char*	the_tgt,
	const bool&	unicast,
	const bool&	multicast,
...
{
    Xrl x(the_tgt, "fib2mrib/0.1/add_route6");
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    x.args().add("network", network);
    x.args().add("nexthop", nexthop);
    x.args().add("metric", metric);
    return _sender->send(x, callback(this, &XrlFib2mribV0p1Client::unmarshall_add_route6, cb));
}


/* Unmarshall add_route6 */
void
XrlFib2mribV0p1Client::unmarshall_add_route6(
	const XrlError&	e,
	XrlArgs*	a,
	AddRoute6CB		cb
)
...
bool
XrlFib2mribV0p1Client::send_replace_route4(
	const char*	the_tgt,
	const bool&	unicast,
	const bool&	multicast,
	const IPv4Net&	network,
...
{
    Xrl x(the_tgt, "fib2mrib/0.1/replace_route4");
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    x.args().add("network", network);
    x.args().add("nexthop", nexthop);
    x.args().add("metric", metric);
    return _sender->send(x, callback(this, &XrlFib2mribV0p1Client::unmarshall_replace_route4, cb));
}


/* Unmarshall replace_route4 */
void
XrlFib2mribV0p1Client::unmarshall_replace_route4(
	const XrlError&	e,
	XrlArgs*	a,
	ReplaceRoute4CB		cb
)
...
bool
XrlFib2mribV0p1Client::send_replace_route6(
	const char*	the_tgt,
	const bool&	unicast,
	const bool&	multicast,
	const IPv6Net&	network,
...
{
    Xrl x(the_tgt, "fib2mrib/0.1/replace_route6");
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    x.args().add("network", network);
    x.args().add("nexthop", nexthop);
    x.args().add("metric", metric);
    return _sender->send(x, callback(this, &XrlFib2mribV0p1Client::unmarshall_replace_route6, cb));
}


/* Unmarshall replace_route6 */
void
XrlFib2mribV0p1Client::unmarshall_replace_route6(
	const XrlError&	e,
	XrlArgs*	a,
	ReplaceRoute6CB		cb
)
...
bool
XrlFib2mribV0p1Client::send_delete_route4(
	const char*	the_tgt,
	const bool&	unicast,
	const bool&	multicast,
	const IPv4Net&	network,
...
{
    Xrl x(the_tgt, "fib2mrib/0.1/delete_route4");
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    x.args().add("network", network);
    return _sender->send(x, callback(this, &XrlFib2mribV0p1Client::unmarshall_delete_route4, cb));
}


/* Unmarshall delete_route4 */
void
XrlFib2mribV0p1Client::unmarshall_delete_route4(
	const XrlError&	e,
	XrlArgs*	a,
	DeleteRoute4CB		cb
)
...
bool
XrlFib2mribV0p1Client::send_delete_route6(
	const char*	the_tgt,
	const bool&	unicast,
	const bool&	multicast,
	const IPv6Net&	network,
...
{
    Xrl x(the_tgt, "fib2mrib/0.1/delete_route6");
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    x.args().add("network", network);
    return _sender->send(x, callback(this, &XrlFib2mribV0p1Client::unmarshall_delete_route6, cb));
}


/* Unmarshall delete_route6 */
void
XrlFib2mribV0p1Client::unmarshall_delete_route6(
	const XrlError&	e,
	XrlArgs*	a,
	DeleteRoute6CB		cb
)
