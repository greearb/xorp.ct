...
#ident "$XORP: xorp/xrl/interfaces/cli_manager_xif.cc,v 1.3 2003/01/23 11:14:25 pavlin Exp $"
...
)
{
    ...
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall3, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall4, cb));
}
...
)
{
    ...
    x.args().add("subnet_addr", subnet_addr);
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall5, cb));
}
...
)
{
    ...
    x.args().add("subnet_addr", subnet_addr);
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall6, cb));
}
...
)
{
    ...
    x.args().add("subnet_addr", subnet_addr);
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall7, cb));
}
...
)
{
    ...
    x.args().add("subnet_addr", subnet_addr);
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall8, cb));
}
...
)
{
    ...
    x.args().add("subnet_addr", subnet_addr);
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall9, cb));
}
...
)
{
    ...
    x.args().add("subnet_addr", subnet_addr);
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall10, cb));
}
...
)
{
    ...
    x.args().add("subnet_addr", subnet_addr);
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall11, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall12, cb));
}
...
)
{
    ...
    x.args().add("processor_name", processor_name);
    x.args().add("command_name", command_name);
    return _router->send(x, callback(this, &XrlCliManagerV0p1Client::unmarshall13, cb));
}
