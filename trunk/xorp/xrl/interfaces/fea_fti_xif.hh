 ...
 *
 * $XORP: xorp/xrl/interfaces/fea_fti_xif.hh,v 1.5 2003/03/10 23:01:27 hodson Exp $
 */
...
public:
    ...
    typedef XorpCallback5<void, const XrlError&, const IPv6Net*, const IPv6*, const string*, const string*>::RefPtr CB11;
    /**
     *  Send Xrl intended to:
     *  
     *  Lookup a route for a destination host address.
    ...
    typedef XorpCallback4<void, const XrlError&, const IPv4*, const string*, const string*>::RefPtr CB12;
    /**
     *  Send Xrl intended to:
     *  
