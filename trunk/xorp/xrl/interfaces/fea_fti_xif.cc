...
#ident "$XORP: xorp/xrl/interfaces/fea_fti_xif.cc,v 1.3 2003/01/24 06:31:29 pavlin Exp $"
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall3, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    x.args().add("dst", dst);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall4, cb));
}
...
)
{
    ...
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall5, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    x.args().add("dst", dst);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall6, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall7, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall8, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall9, cb));
}
...
)
{
    ...
    x.args().add("dst", dst);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall10, cb));
}
...
)
{
    ...
    x.args().add("dst", dst);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall11, cb));
}
...
)
{
    ...
    x.args().add("dst", dst);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall12, cb));
}
...
)
{
    ...
    x.args().add("dst", dst);
    return _sender->send(x, callback(this, &XrlFtiV0p1Client::unmarshall13, cb));
}
