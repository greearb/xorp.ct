...
#ident "$XORP: xorp/xrl/interfaces/fea_rawlink_xif.cc,v 1.8 2008/09/23 08:13:17 abittau Exp $"
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "raw_link/0.1/send");
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "raw_link/0.1/register_receiver");
        x->args().add(XrlAtom(xrl_target_instance_name));
        x->args().add(XrlAtom(if_name));
        x->args().add(XrlAtom(vif_name));
        x->args().add(XrlAtom(ether_type));
        x->args().add(XrlAtom(filter_program));
    ...
    x->args().set_arg(3, ether_type);
    x->args().set_arg(4, filter_program);
    x->args().set_arg(5, enable_multicast_loopback);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "raw_link/0.1/unregister_receiver");
        x->args().add(XrlAtom(xrl_target_instance_name));
        x->args().add(XrlAtom(if_name));
        x->args().add(XrlAtom(vif_name));
        x->args().add(XrlAtom(ether_type));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "raw_link/0.1/join_multicast_group");
        x->args().add(XrlAtom(xrl_target_instance_name));
        x->args().add(XrlAtom(if_name));
        x->args().add(XrlAtom(vif_name));
        x->args().add(XrlAtom(ether_type));
    ...
    x->args().set_arg(3, ether_type);
    x->args().set_arg(4, filter_program);
    x->args().set_arg(5, group_address);
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "raw_link/0.1/leave_multicast_group");
        x->args().add(XrlAtom(xrl_target_instance_name));
        x->args().add(XrlAtom(if_name));
        x->args().add(XrlAtom(vif_name));
        x->args().add(XrlAtom(ether_type));
