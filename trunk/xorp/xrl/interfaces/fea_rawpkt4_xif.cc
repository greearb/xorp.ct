...
#ident "$XORP: xorp/xrl/interfaces/fea_rawpkt4_xif.cc,v 1.4 2005/03/25 02:54:48 pavlin Exp $"
...
{
    Xrl x(the_tgt, "raw_packet4/0.1/register_receiver");
...
{
    Xrl x(the_tgt, "raw_packet4/0.1/unregister_receiver");
    x.args().add("xrl_target_name", xrl_target_name);
    x.args().add("if_name", if_name);
    x.args().add("vif_name", vif_name);
    x.args().add("ip_protocol", ip_protocol);
...
{
    Xrl x(the_tgt, "raw_packet4/0.1/join_multicast_group");
    x.args().add("xrl_target_name", xrl_target_name);
    x.args().add("if_name", if_name);
    x.args().add("vif_name", vif_name);
    x.args().add("ip_protocol", ip_protocol);
...
{
    Xrl x(the_tgt, "raw_packet4/0.1/leave_multicast_group");
    x.args().add("xrl_target_name", xrl_target_name);
    x.args().add("if_name", if_name);
    x.args().add("vif_name", vif_name);
    x.args().add("ip_protocol", ip_protocol);
