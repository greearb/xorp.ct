...
#ident "$XORP: xorp/xrl/interfaces/bgp_mib_traps_xif.cc,v 1.14 2008/01/04 03:17:51 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "bgp_mib_traps/0.1/send_bgp_established_trap");
...
{
    Xrl x(dst_xrl_target_name, "bgp_mib_traps/0.1/send_bgp_backward_transition_trap");
    x.args().add("bgp_last_error", bgp_last_error);
    x.args().add("bgp_state", bgp_state);
