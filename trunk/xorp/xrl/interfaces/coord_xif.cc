...
#ident "$XORP: xorp/xrl/interfaces/coord_xif.cc,v 1.6 2003/05/13 00:23:45 hodson Exp $"
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlCoordV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlCoordV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlCoordV0p1Client::unmarshall2, cb));
}


/* Unmarshall pending */
void
XrlCoordV0p1Client::unmarshall2(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB2		cb
)
