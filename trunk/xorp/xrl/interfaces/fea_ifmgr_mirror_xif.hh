 ...
 *
 * $XORP: xorp/xrl/interfaces/fea_ifmgr_mirror_xif.hh,v 1.17 2007/07/12 21:37:27 pavlin Exp $
 */
...
public:
    ...
    typedef XorpCallback1<void, const XrlError&>::RefPtr VifSetVlanTagCB;

    bool send_vif_set_vlan_tag(
	const char*	dst_xrl_target_name,
	const string&	ifname,
	const string&	vifname,
...
private:
    ...
    void unmarshall_vif_set_vlan_tag(
	const XrlError&	e,
	XrlArgs*	a,
	VifSetVlanTagCB		cb
    );
