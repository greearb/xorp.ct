...
#ident "$XORP: xorp/xrl/interfaces/rtrmgr_client_xif.cc,v 1.1.1.1 2002/12/11 23:56:18 hodson Exp $"
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrClientV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrClientV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRtrmgrClientV0p1Client::unmarshall2, cb));
}
