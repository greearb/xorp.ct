...
#ident "$XORP: xorp/xrl/interfaces/rtrmgr_client_xif.cc,v 1.20 2008/01/04 03:18:01 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr_client/0.2/new_config_user");
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr_client/0.2/config_saved_done");
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr_client/0.2/config_change_done");
    x.args().add("success", success);
    x.args().add("errmsg", errmsg);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr_client/0.2/config_changed");
    x.args().add("userid", userid);
...
{
    Xrl x(dst_xrl_target_name, "rtrmgr_client/0.2/module_status");
