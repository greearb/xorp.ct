...
#ident "$XORP: xorp/xrl/interfaces/fea_ifmgr_client_xif.cc,v 1.16 2006/03/26 22:39:20 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "fea_ifmgr_client/0.1/interface_update");
...
{
    Xrl x(dst_xrl_target_name, "fea_ifmgr_client/0.1/vif_update");
    x.args().add("ifname", ifname);
...
{
    Xrl x(dst_xrl_target_name, "fea_ifmgr_client/0.1/vifaddr4_update");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "fea_ifmgr_client/0.1/vifaddr6_update");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("addr", addr);
    x.args().add("event", event);
...
{
    Xrl x(dst_xrl_target_name, "fea_ifmgr_client/0.1/updates_completed");
