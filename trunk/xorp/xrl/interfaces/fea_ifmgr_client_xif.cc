...
#ident "$XORP: xorp/xrl/interfaces/fea_ifmgr_client_xif.cc,v 1.3 2003/01/24 06:31:30 pavlin Exp $"
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlFeaIfmgrClientV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    x.args().add("event", event);
    return _sender->send(x, callback(this, &XrlFeaIfmgrClientV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    x.args().add("event", event);
    return _sender->send(x, callback(this, &XrlFeaIfmgrClientV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    x.args().add("addr", addr);
    x.args().add("event", event);
    return _sender->send(x, callback(this, &XrlFeaIfmgrClientV0p1Client::unmarshall3, cb));
}
