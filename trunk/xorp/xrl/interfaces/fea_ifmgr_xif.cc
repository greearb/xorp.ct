...
#ident "$XORP: xorp/xrl/interfaces/fea_ifmgr_xif.cc,v 1.1.1.1 2002/12/11 23:56:17 hodson Exp $"
...
)
{
    ...
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    x.args().add("ifname", ifname);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall3, cb));
}
...
bool
XrlIfmgrV0p1Client::send_get_vif_flags4(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv4&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_vif_flags4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall4, cb));
}


/* Unmarshall get_vif_flags4 */
void
...
)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 5)", a->size());
...
bool
XrlIfmgrV0p1Client::send_get_vif_flags6(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv6&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_vif_flags6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall5, cb));
}


/* Unmarshall get_vif_flags6 */
void
...
)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 4)", a->size());
...
)
{
    ...
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall6, cb));
}
...
)
{
    ...
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall7, cb));
}
...
)
{
    ...
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall8, cb));
}
...
)
{
    ...
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall9, cb));
}
...
bool
XrlIfmgrV0p1Client::send_get_interface_enabled(
	const char*	the_tgt, 
	const string&	ifname, 
	const CB10&	cb
)
{
    Xrl x(the_tgt, "ifmgr/0.1/get_interface_enabled");
    x.args().add("ifname", ifname);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall10, cb));
}


/* Unmarshall get_interface_enabled */
void
...
bool
XrlIfmgrV0p1Client::send_get_mac(
	const char*	the_tgt, 
	const string&	ifname, 
	const CB11&	cb
)
{
    Xrl x(the_tgt, "ifmgr/0.1/get_mac");
    x.args().add("ifname", ifname);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall11, cb));
}
...
bool
XrlIfmgrV0p1Client::send_get_mtu(
	const char*	the_tgt, 
	const string&	ifname, 
	const CB12&	cb
)
{
    Xrl x(the_tgt, "ifmgr/0.1/get_mtu");
    x.args().add("ifname", ifname);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall12, cb));
}
...
bool
XrlIfmgrV0p1Client::send_get_vif_enabled(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const CB13&	cb
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_vif_enabled");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall13, cb));
}


/* Unmarshall get_vif_enabled */
void
...
bool
XrlIfmgrV0p1Client::send_get_prefix4(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv4&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_prefix4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall14, cb));
}


/* Unmarshall get_prefix4 */
void
...
bool
XrlIfmgrV0p1Client::send_get_broadcast4(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv4&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_broadcast4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall15, cb));
}


/* Unmarshall get_broadcast4 */
void
...
bool
XrlIfmgrV0p1Client::send_get_endpoint4(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv4&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_endpoint4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall16, cb));
}


/* Unmarshall get_endpoint4 */
void
...
bool
XrlIfmgrV0p1Client::send_get_prefix6(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv6&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_prefix6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall17, cb));
}


/* Unmarshall get_prefix6 */
void
...
bool
XrlIfmgrV0p1Client::send_get_endpoint6(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv6&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_endpoint6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall18, cb));
}


/* Unmarshall get_endpoint6 */
void
...
)
{
    ...
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall19, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall20, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall21, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    x.args().add("ifname", ifname);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall22, cb));
}
...
)
{
    ...
    x.args().add("tid", tid);
    x.args().add("ifname", ifname);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall23, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall24, cb));
}
...
)
{
    ...
    x.args().add("ifname", ifname);
    x.args().add("mac", mac);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall25, cb));
}
...
)
{
    ...
    x.args().add("ifname", ifname);
    x.args().add("mtu", mtu);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall26, cb));
}
...
)
{
    ...
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall27, cb));
}
...
)
{
    ...
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall28, cb));
}
...
)
{
    ...
    x.args().add("vif", vif);
    x.args().add("enabled", enabled);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall29, cb));
}
...
)
{
    ...
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall30, cb));
}
...
)
{
    ...
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall31, cb));
}
...
)
{
    ...
    x.args().add("address", address);
    x.args().add("enabled", enabled);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall32, cb));
}
...
bool
XrlIfmgrV0p1Client::send_get_address_enabled4(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv4&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_address_enabled4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall33, cb));
}


/* Unmarshall get_address_enabled4 */
void
...
)
{
    ...
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall34, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall35, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall36, cb));
}
...
)
{
    ...
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall37, cb));
}
...
)
{
    ...
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall38, cb));
}
...
)
{
    ...
    x.args().add("address", address);
    x.args().add("enabled", enabled);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall39, cb));
}
...
bool
XrlIfmgrV0p1Client::send_get_address_enabled6(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv6&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_address_enabled6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall40, cb));
}


/* Unmarshall get_address_enabled6 */
void
...
)
{
    ...
    x.args().add("address", address);
    x.args().add("prefix", prefix);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall41, cb));
}
...
)
{
    ...
    x.args().add("address", address);
    x.args().add("endpoint", endpoint);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall42, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall43, cb));
}
...
)
{
    ...
    x.args().add("clientname", clientname);
    return _router->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall44, cb));
}
