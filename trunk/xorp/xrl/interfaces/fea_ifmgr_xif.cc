...
#ident "$XORP: xorp/xrl/interfaces/fea_ifmgr_xif.cc,v 1.7 2003/04/11 22:26:09 pavlin Exp $"
...
bool
XrlIfmgrV0p1Client::send_get_address_flags4(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv4&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_address_flags4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
...
bool
XrlIfmgrV0p1Client::send_get_address_flags6(
	const char*	the_tgt, 
	const string&	ifname, 
	const string&	vif, 
	const IPv6&	address, 
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_address_flags6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
