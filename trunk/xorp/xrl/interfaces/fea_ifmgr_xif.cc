...
#ident "$XORP: xorp/xrl/interfaces/fea_ifmgr_xif.cc,v 1.11 2003/05/23 23:26:34 pavlin Exp $"
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall60, cb));
}


/* Unmarshall register_client */
void
XrlIfmgrV0p1Client::unmarshall60(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB60		cb
)
...
)
{
    ...
    x.args().add("clientname", clientname);
    return _sender->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall61, cb));
}


/* Unmarshall unregister_client */
void
XrlIfmgrV0p1Client::unmarshall61(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB61		cb
)
...
)
{
    ...
    x.args().add("clientname", clientname);
    return _sender->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall62, cb));
}


/* Unmarshall register_all_interfaces_client */
void
XrlIfmgrV0p1Client::unmarshall62(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB62		cb
)
...
)
{
    ...
    x.args().add("clientname", clientname);
    return _sender->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall63, cb));
}


/* Unmarshall unregister_all_interfaces_client */
void
XrlIfmgrV0p1Client::unmarshall63(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB63		cb
)
