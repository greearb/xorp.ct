...
#ident "$XORP: xorp/xrl/interfaces/fea_ifmgr_xif.cc,v 1.29 2006/03/26 22:39:21 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/register_client");
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/unregister_client");
    x.args().add("clientname", clientname);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_interface_names");
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_vif_names");
    x.args().add("ifname", ifname);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_vif_flags");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_vif_pif_index");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_vif_addresses4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_address_flags4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_vif_addresses6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_address_flags6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_interface_enabled");
    x.args().add("ifname", ifname);
...
bool
XrlIfmgrV0p1Client::send_get_system_interface_discard(
	const char*	dst_xrl_target_name,
	const string&	ifname,
	const GetSystemInterfaceDiscardCB&	cb
)
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_interface_discard");
    x.args().add("ifname", ifname);
    return _sender->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall_get_system_interface_discard, cb));
}


/* Unmarshall get_system_interface_discard */
void
XrlIfmgrV0p1Client::unmarshall_get_system_interface_discard(
	const XrlError&	e,
	XrlArgs*	a,
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_mac");
    x.args().add("ifname", ifname);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_mtu");
    x.args().add("ifname", ifname);
...
bool
XrlIfmgrV0p1Client::send_get_system_no_carrier(
	const char*	dst_xrl_target_name,
	const string&	ifname,
	const GetSystemNoCarrierCB&	cb
)
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_no_carrier");
    x.args().add("ifname", ifname);
    return _sender->send(x, callback(this, &XrlIfmgrV0p1Client::unmarshall_get_system_no_carrier, cb));
}


/* Unmarshall get_system_no_carrier */
void
XrlIfmgrV0p1Client::unmarshall_get_system_no_carrier(
	const XrlError&	e,
	XrlArgs*	a,
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_vif_enabled");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_prefix4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_broadcast4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_endpoint4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_prefix6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_endpoint6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_address_enabled4");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/get_system_address_enabled6");
    x.args().add("ifname", ifname);
    x.args().add("vif", vif);
    x.args().add("address", address);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/register_system_interfaces_client");
    x.args().add("clientname", clientname);
...
{
    Xrl x(dst_xrl_target_name, "ifmgr/0.1/unregister_system_interfaces_client");
    x.args().add("clientname", clientname);
