...
#ident "$XORP: xorp/xrl/interfaces/fea_ifmgr_xif.cc,v 1.27 2005/10/16 07:10:38 pavlin Exp $"
...
{
    Xrl x(the_tgt, "ifmgr/0.1/set_restore_original_config_on_shutdown");
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_configured_interface_discard");
    x.args().add("ifname", ifname);
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_configured_no_carrier");
    x.args().add("ifname", ifname);
...
{
    Xrl x(the_tgt, "ifmgr/0.1/configure_interface_from_system");
    x.args().add("tid", tid);
    x.args().add("ifname", ifname);
...
{
    Xrl x(the_tgt, "ifmgr/0.1/set_interface_discard");
    x.args().add("tid", tid);
    x.args().add("ifname", ifname);
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_system_interface_discard");
    x.args().add("ifname", ifname);
...
{
    Xrl x(the_tgt, "ifmgr/0.1/get_system_no_carrier");
    x.args().add("ifname", ifname);
