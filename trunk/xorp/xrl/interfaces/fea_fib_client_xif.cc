...
#ident "$XORP: xorp/xrl/interfaces/fea_fib_client_xif.cc,v 1.4 2004/06/10 22:41:59 hodson Exp $"
...
{
    Xrl x(the_tgt, "fea_fib_client/0.1/resolve_route4");
    x.args().add("network", network);
...
{
    Xrl x(the_tgt, "fea_fib_client/0.1/resolve_route6");
    x.args().add("network", network);
