 ...
 *
 * $XORP: xorp/xrl/interfaces/rib_xif.hh,v 1.8 2003/03/22 04:29:46 pavlin Exp $
 */
...
public:
    ...
    typedef XorpCallback7<void, const XrlError&, const bool*, const IPv4*, const uint32_t*, const uint32_t*, const IPv4*, const uint32_t*>::RefPtr CB36;
    /**
     *  Send Xrl intended to:
     *  
    ...
    typedef XorpCallback7<void, const XrlError&, const bool*, const IPv6*, const uint32_t*, const uint32_t*, const IPv6*, const uint32_t*>::RefPtr CB38;
    /**
     *  Send Xrl intended to:
     *  
     *  Register an interest in a route
