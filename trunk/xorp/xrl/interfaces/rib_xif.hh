 ...
 *
 * $XORP: xorp/xrl/interfaces/rib_xif.hh,v 1.6 2003/03/10 23:01:30 hodson Exp $
 */
...
public:
    ...
    typedef XorpCallback2<void, const XrlError&, const IPv6*>::RefPtr CB24;
    /**
     *  Send Xrl intended to:
     *  
     *  Lookup nexthop.
    ...
    typedef XorpCallback7<void, const XrlError&, const bool*, const IPv4*, const uint32_t*, const uint32_t*, const IPv4*, const uint32_t*>::RefPtr CB32;
    /**
     *  Send Xrl intended to:
     *  
    ...
    typedef XorpCallback7<void, const XrlError&, const bool*, const IPv6*, const uint32_t*, const uint32_t*, const IPv6*, const uint32_t*>::RefPtr CB34;
    /**
     *  Send Xrl intended to:
     *  
     *  Register an interest in a route
