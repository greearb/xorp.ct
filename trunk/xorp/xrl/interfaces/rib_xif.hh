 ...
 *
 * $XORP: xorp/xrl/interfaces/rib_xif.hh,v 1.4 2003/02/06 22:21:28 hodson Exp $
 */
...
public:
    ...
    typedef XorpCallback2<void, const XrlError&, const IPv6*>::RefPtr CB16;
    /**
     *  Send Xrl intended to:
     *  
     *  Lookup nexthop.
    ...
    typedef XorpCallback7<void, const XrlError&, const bool*, const IPv4*, const uint32_t*, const uint32_t*, const IPv4*, const uint32_t*>::RefPtr CB24;
    /**
     *  Send Xrl intended to:
     *  
    ...
    typedef XorpCallback7<void, const XrlError&, const bool*, const IPv6*, const uint32_t*, const uint32_t*, const IPv6*, const uint32_t*>::RefPtr CB26;
    /**
     *  Send Xrl intended to:
     *  
     *  Register an interest in a route
