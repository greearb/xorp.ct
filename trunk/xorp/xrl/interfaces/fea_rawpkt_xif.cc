...
#ident "$XORP: xorp/xrl/interfaces/fea_rawpkt_xif.cc,v 1.1.1.1 2002/12/11 23:56:17 hodson Exp $"
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRawPacketV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlRawPacketV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    x.args().add("proto", proto);
    return _router->send(x, callback(this, &XrlRawPacketV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    x.args().add("proto", proto);
    return _router->send(x, callback(this, &XrlRawPacketV0p1Client::unmarshall3, cb));
}
