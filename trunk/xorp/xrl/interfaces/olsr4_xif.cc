...
#ident "$XORP: xorp/xrl/interfaces/olsr4_xif.cc,v 1.1 2008/04/24 15:20:35 bms Exp $"
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/trace");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/clear_database");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_willingness");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_willingness");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_mpr_coverage");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_mpr_coverage");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_tc_redundancy");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_tc_redundancy");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_tc_fisheye");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_tc_fisheye");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_hna_base_cost");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_hna_base_cost");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_hello_interval");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_hello_interval");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_refresh_interval");
    x.args().add("interval", interval);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_refresh_interval");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_tc_interval");
    x.args().add("interval", interval);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_tc_interval");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_mid_interval");
    x.args().add("interval", interval);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_mid_interval");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_hna_interval");
    x.args().add("interval", interval);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_hna_interval");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_dup_hold_time");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_dup_hold_time");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_main_address");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_main_address");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/bind_address");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/unbind_address");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_binding_enabled");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("enabled", enabled);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_binding_enabled");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/change_local_addr_port");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("local_addr", local_addr);
    x.args().add("local_port", local_port);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/change_all_nodes_addr_port");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
    x.args().add("all_nodes_addr", all_nodes_addr);
    x.args().add("all_nodes_port", all_nodes_port);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_interface_list");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_interface_info");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/set_interface_cost");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_interface_stats");
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_link_list");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_link_info");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_neighbor_list");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_neighbor_info");
    x.args().add("nid", nid);
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_twohop_link_list");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_twohop_link_info");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_twohop_neighbor_list");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_twohop_neighbor_info");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_mid_entry_list");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_mid_entry");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_tc_entry_list");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_tc_entry");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_hna_entry_list");
...
{
    Xrl x(dst_xrl_target_name, "olsr4/0.1/get_hna_entry");
