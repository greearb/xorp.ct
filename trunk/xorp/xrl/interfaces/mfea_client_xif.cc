...
#ident "$XORP: xorp/xrl/interfaces/mfea_client_xif.cc,v 1.1.1.1 2002/12/11 23:56:17 hodson Exp $"
...
)
{
    ...
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    x.args().add("vif_index", vif_index);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    x.args().add("broadcast", broadcast);
    x.args().add("peer", peer);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall3, cb));
}
...
)
{
    ...
    x.args().add("vif_index", vif_index);
    x.args().add("addr", addr);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall4, cb));
}
...
)
{
    ...
    x.args().add("vif_index", vif_index);
    x.args().add("addr", addr);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall5, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall6, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    x.args().add("vif_index", vif_index);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall7, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall8, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall9, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall10, cb));
}
...
)
{
    ...
    x.args().add("is_router_alert", is_router_alert);
    x.args().add("protocol_message", protocol_message);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall11, cb));
}
...
)
{
    ...
    x.args().add("dest_address", dest_address);
    x.args().add("protocol_message", protocol_message);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall12, cb));
}
...
)
{
    ...
    x.args().add("dest_address", dest_address);
    x.args().add("protocol_message", protocol_message);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall13, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall14, cb));
}
...
)
{
    ...
    x.args().add("metric", metric);
    x.args().add("metric_preference", metric_preference);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall15, cb));
}
...
)
{
    ...
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("dest_prefix", dest_prefix);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall16, cb));
}
...
)
{
    ...
    x.args().add("xrl_sender_name", xrl_sender_name);
    x.args().add("dest_prefix", dest_prefix);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall17, cb));
}
...
)
{
    ...
    x.args().add("xrl_sender_name", xrl_sender_name);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall18, cb));
}
...
)
{
    ...
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall19, cb));
}
...
)
{
    ...
    x.args().add("is_geq_upcall", is_geq_upcall);
    x.args().add("is_leq_upcall", is_leq_upcall);
    return _router->send(x, callback(this, &XrlMfeaClientV0p1Client::unmarshall20, cb));
}
