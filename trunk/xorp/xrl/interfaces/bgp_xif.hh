 ...
 *
 * $XORP: xorp/xrl/interfaces/bgp_xif.hh,v 1.6 2003/01/19 00:59:26 mjh Exp $
 */
...
public:
    XrlBgpV0p2Client(XrlSender* r) : _router(r) {}
    ...
    typedef XorpCallback3<void, const XrlError&, const uint32_t*, const bool*>::RefPtr CB11;
    /**
     *  Send Xrl intended to:
     *  
    ...
    typedef XorpCallback8<void, const XrlError&, const uint32_t*, const uint32_t*, const uint32_t*, const uint32_t*, const uint32_t*, const uint32_t*, const uint32_t*>::RefPtr CB19;
    ...
    typedef XorpCallback12<void, const XrlError&, const IPv4*, const IPv4Net*, const uint32_t*, const vector<uint8_t>*, const IPv4*, const int32_t*, const int32_t*, const int32_t*, const vector<uint8_t>*, const int32_t*, const vector<uint8_t>*>::RefPtr CB25;
    /**
     *  Send Xrl intended to:
     *  
    ...
    typedef XorpCallback12<void, const XrlError&, const IPv4*, const IPv6Net*, const uint32_t*, const vector<uint8_t>*, const IPv6*, const int32_t*, const int32_t*, const int32_t*, const vector<uint8_t>*, const int32_t*, const vector<uint8_t>*>::RefPtr CB26;
    /**
     *  Send Xrl intended to:
     *  
     *  Get the next route in the list See RFC 1657 (BGP MIB) for full
