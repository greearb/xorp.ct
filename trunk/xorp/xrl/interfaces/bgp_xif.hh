 ...
 *
 * $XORP: xorp/xrl/interfaces/bgp_xif.hh,v 1.33 2005/03/25 02:54:44 pavlin Exp $
 */
...
public:
    ...
    typedef XorpCallback1<void, const XrlError&>::RefPtr ChangePeerIpCB;
    /**
     *  Send Xrl intended to:
     *
...
private:
    ...
    void unmarshall_change_peer_ip(
	const XrlError&	e,
	XrlArgs*	a,
	ChangePeerIpCB		cb
    );
