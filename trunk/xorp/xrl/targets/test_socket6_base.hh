...
private:
	...
	if (_cmds->add_handler("common/0.1/get_target_name",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://test_socket6/common/0.1/get_target_name");
	}
	if (_cmds->add_handler("common/0.1/get_version",
	    callback(this, &XrlTestSocket6TargetBase::handle_common_0_1_get_version)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://test_socket6/common/0.1/get_version");
	}
	if (_cmds->add_handler("common/0.1/get_status",
	    callback(this, &XrlTestSocket6TargetBase::handle_common_0_1_get_status)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://test_socket6/common/0.1/get_status");
	}
	if (_cmds->add_handler("common/0.1/shutdown",
	    callback(this, &XrlTestSocket6TargetBase::handle_common_0_1_shutdown)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://test_socket6/common/0.1/shutdown");
	}
	if (_cmds->add_handler("socket6_user/0.1/recv_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://test_socket6/socket6_user/0.1/recv_event");
	}
	if (_cmds->add_handler("socket6_user/0.1/connect_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://test_socket6/socket6_user/0.1/connect_event");
	}
	if (_cmds->add_handler("socket6_user/0.1/error_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://test_socket6/socket6_user/0.1/error_event");
	}
	if (_cmds->add_handler("socket6_user/0.1/close_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://test_socket6/socket6_user/0.1/close_event");
	}
	_cmds->finalize();
    }
