...
#ident "$XORP: xorp/xrl/targets/mfea_base.cc,v 1.28 2007/05/08 19:23:22 pavlin Exp $"
...
XrlMfeaTargetBase::handle_mfea_0_1_send_protocol_message4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(12), XORP_UINT_CAST(xa_inputs.size()), "mfea/0.1/send_protocol_message4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_send_protocol_message6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 12) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(12), XORP_UINT_CAST(xa_inputs.size()), "mfea/0.1/send_protocol_message6");
	return XrlCmdError::BAD_ARGS();
    }
