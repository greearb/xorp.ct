...
#ident "$XORP: xorp/xrl/targets/mfea_base.cc,v 1.8 2003/05/18 03:18:24 pavlin Exp $"
...
const XrlCmdError
XrlMfeaTargetBase::handle_common_0_1_get_status(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 0) { 
...
const XrlCmdError
XrlMfeaTargetBase::handle_common_0_1_shutdown(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 0) { 
...
const XrlCmdError
XrlMfeaTargetBase::handle_fea_ifmgr_client_0_1_interface_update(const Xrl& xrl, XrlArgs* /* args */)
{
...
const XrlCmdError
XrlMfeaTargetBase::handle_fea_ifmgr_client_0_1_vif_update(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 3) { 
...
const XrlCmdError
XrlMfeaTargetBase::handle_fea_ifmgr_client_0_1_vifaddr4_update(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 4) { 
...
const XrlCmdError
XrlMfeaTargetBase::handle_fea_ifmgr_client_0_1_vifaddr6_update(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 4) { 
