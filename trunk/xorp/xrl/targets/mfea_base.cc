...
#ident "$XORP: xorp/xrl/targets/mfea_base.cc,v 1.21 2004/12/14 21:55:09 pavlin Exp $"
...
XrlMfeaTargetBase::handle_mfea_0_1_allow_mrib_messages(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "mfea/0.1/allow_mrib_messages");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_get_mrib_table_default_metric_preference(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(0), XORP_UINT_CAST(xa_inputs.size()), "mfea/0.1/get_mrib_table_default_metric_preference");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_set_mrib_table_default_metric_preference(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "mfea/0.1/set_mrib_table_default_metric_preference");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_reset_mrib_table_default_metric_preference(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(0), XORP_UINT_CAST(xa_inputs.size()), "mfea/0.1/reset_mrib_table_default_metric_preference");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_get_mrib_table_default_metric(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(0), XORP_UINT_CAST(xa_inputs.size()), "mfea/0.1/get_mrib_table_default_metric");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_set_mrib_table_default_metric(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "mfea/0.1/set_mrib_table_default_metric");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_reset_mrib_table_default_metric(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(0), XORP_UINT_CAST(xa_inputs.size()), "mfea/0.1/reset_mrib_table_default_metric");
	return XrlCmdError::BAD_ARGS();
    }
