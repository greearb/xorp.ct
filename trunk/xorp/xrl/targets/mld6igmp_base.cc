...
#ident "$XORP: xorp/xrl/targets/mld6igmp_base.cc,v 1.14 2003/11/18 01:47:39 hodson Exp $"
...
const XrlCmdError
XrlMld6igmpTargetBase::handle_mld6igmp_0_1_enable_log_trace(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != 0) handling mld6igmp/0.1/enable_log_trace",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlMld6igmpTargetBase::handle_mld6igmp_0_1_disable_log_trace(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != 0) handling mld6igmp/0.1/disable_log_trace",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
