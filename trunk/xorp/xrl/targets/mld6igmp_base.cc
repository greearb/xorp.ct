...
#ident "$XORP: xorp/xrl/targets/mld6igmp_base.cc,v 1.10 2003/05/31 06:42:31 pavlin Exp $"
...
const XrlCmdError
XrlMld6igmpTargetBase::handle_common_0_1_get_status(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 0) { 
...
const XrlCmdError
XrlMld6igmpTargetBase::handle_common_0_1_shutdown(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 0) { 
...
const XrlCmdError
XrlMld6igmpTargetBase::handle_mld6igmp_0_1_get_vif_proto_version(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling mld6igmp/0.1/get_vif_proto_version", (uint32_t)xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = mld6igmp_0_1_get_vif_proto_version(
	    ...
	    proto_version);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for mld6igmp/0.1/get_vif_proto_version failed: %s \"%s\"",
            		 e.str().c_str(), e.note().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
const XrlCmdError
XrlMld6igmpTargetBase::handle_mld6igmp_0_1_set_vif_proto_version(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 2) { 
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling mld6igmp/0.1/set_vif_proto_version", (uint32_t)xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for mld6igmp/0.1/set_vif_proto_version failed: %s \"%s\"",
            		 e.str().c_str(), e.note().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
const XrlCmdError
XrlMld6igmpTargetBase::handle_mld6igmp_0_1_reset_vif_proto_version(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling mld6igmp/0.1/reset_vif_proto_version", (uint32_t)xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = mld6igmp_0_1_reset_vif_proto_version(
	    xrl.const_args().get_string("vif_name"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for mld6igmp/0.1/reset_vif_proto_version failed: %s \"%s\"",
            		 e.str().c_str(), e.note().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
