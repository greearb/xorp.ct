...
#ident "$XORP: xorp/xrl/targets/finder_base.cc,v 1.4 2002/08/30 22:19:55 mjh Exp $"
...
XrlFinderTargetBase::handle_finder_0_1_register_xrl_target(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling finder/0.1/register_xrl_target", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFinderTargetBase::handle_finder_0_1_unregister_xrl_target(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling finder/0.1/unregister_xrl_target", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFinderTargetBase::handle_finder_0_1_add_xrl(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling finder/0.1/add_xrl", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFinderTargetBase::handle_finder_0_1_remove_xrl(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 2) handling finder/0.1/remove_xrl", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling finder/0.1/add_xrl_override", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 2) { 
	XLOG_ERROR("Wrong number of arguments (%d != 2) handling finder/0.1/remove_xrl_override", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 2) { 
	XLOG_ERROR("Wrong number of arguments (%d != 2) handling finder/0.1/resolve_xrl", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 2) { 
	XLOG_ERROR("Wrong number of arguments (%d != 2) handling finder/0.1/get_xrl_info", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling finder/0.1/get_xrl_targets", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling finder/0.1/get_xrls_registered_by", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling finder/0.1/get_all_xrls", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
