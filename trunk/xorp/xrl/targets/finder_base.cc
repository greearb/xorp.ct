...
#ident "$XORP: xorp/xrl/targets/finder_base.cc,v 1.3 2003/01/28 00:37:56 hodson Exp $"
...
XrlFinderTargetBase::handle_finder_0_1_register_finder_client(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling finder/0.1/register_finder_client", (uint32_t)xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
