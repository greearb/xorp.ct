...
#ident "$XORP: xorp/xrl/targets/test_socket4_base.cc,v 1.3 2004/06/10 22:42:17 hodson Exp $"
...
XrlTestSocket4TargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("socket4_user/0.1/connect_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "test_socket4", "socket4_user/0.1/connect_event");
	}
	...
	if (_cmds->add_handler("socket4_user/0.1/close_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "test_socket4", "socket4_user/0.1/close_event");
	}
	_cmds->finalize();
}
