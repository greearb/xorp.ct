 ...
 *
 * $XORP: xorp/xrl/targets/rib_base.hh,v 1.12 2003/05/13 00:23:58 hodson Exp $
 */
...
private:
    ...
    const XrlCmdError handle_rib_0_1_add_rib_client4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_rib_0_1_add_rib_client6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_rib_0_1_delete_rib_client4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_rib_0_1_delete_rib_client6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_rib_0_1_enable_rib_client4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_rib_0_1_enable_rib_client6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_rib_0_1_disable_rib_client4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_rib_0_1_disable_rib_client6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_rib_0_1_no_fea(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_rib_0_1_make_errors_fatal(const Xrl& x, XrlArgs* a);
