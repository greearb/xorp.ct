 ...
 *
 * $XORP: xorp/xrl/targets/rib_base.hh,v 1.25 2004/05/12 08:27:21 pavlin Exp $
 */
...
private:
	...
	if (_cmds->add_handler("rib/0.1/redist_transaction_enable4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://rib/rib/0.1/redist_transaction_enable4");
	}
	if (_cmds->add_handler("rib/0.1/redist_transaction_enable6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://rib/rib/0.1/redist_transaction_enable6");
	}
	if (_cmds->add_handler("rib/0.1/redist_transaction_disable4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://rib/rib/0.1/redist_transaction_disable4");
	}
	if (_cmds->add_handler("rib/0.1/redist_transaction_disable6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://rib/rib/0.1/redist_transaction_disable6");
	}
