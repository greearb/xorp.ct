 ...
 *
 * $XORP: xorp/xrl/targets/rib_base.hh,v 1.1.1.1 2002/12/11 23:56:19 hodson Exp $
 */
...
public:
    XrlRibTargetBase(XrlCmdMap* r) : _router(r) { add_handlers(); }
...
private:
	...
	if (_router->add_handler("rib/0.1/add_igp_table4", 
	...
	if (_router->add_handler("rib/0.1/add_igp_table6", 
	...
	if (_router->add_handler("rib/0.1/delete_igp_table4", 
	...
	if (_router->add_handler("rib/0.1/delete_igp_table6", 
	...
	if (_router->add_handler("rib/0.1/add_egp_table4", 
	...
	if (_router->add_handler("rib/0.1/add_egp_table6", 
	...
	if (_router->add_handler("rib/0.1/delete_egp_table4", 
	...
	if (_router->add_handler("rib/0.1/delete_egp_table6", 
	...
	if (_router->add_handler("rib/0.1/add_route4", 
	...
	if (_router->add_handler("rib/0.1/add_route6", 
	...
	if (_router->add_handler("rib/0.1/replace_route4", 
	...
	if (_router->add_handler("rib/0.1/replace_route6", 
	...
	if (_router->add_handler("rib/0.1/delete_route4", 
	...
	if (_router->add_handler("rib/0.1/delete_route6", 
	...
	if (_router->add_handler("rib/0.1/lookup_route4", 
	...
	if (_router->add_handler("rib/0.1/lookup_route6", 
	...
	if (_router->add_handler("rib/0.1/add_vif_addr6", 
	...
	if (_router->add_handler("rib/0.1/redist_enable4", 
	...
	if (_router->add_handler("rib/0.1/redist_enable6", 
	...
	if (_router->add_handler("rib/0.1/redist_disable4", 
	...
	if (_router->add_handler("rib/0.1/redist_disable6", 
	...
	if (_router->add_handler("rib/0.1/register_interest4", 
	...
	if (_router->add_handler("rib/0.1/deregister_interest4", 
	...
	if (_router->add_handler("rib/0.1/register_interest6", 
	...
	if (_router->add_handler("rib/0.1/deregister_interest6", 
	...
	_router->remove_handler("rib/0.1/add_igp_table4");
	_router->remove_handler("rib/0.1/add_igp_table6");
	_router->remove_handler("rib/0.1/delete_igp_table4");
	_router->remove_handler("rib/0.1/delete_igp_table6");
	_router->remove_handler("rib/0.1/add_egp_table4");
	_router->remove_handler("rib/0.1/add_egp_table6");
	_router->remove_handler("rib/0.1/delete_egp_table4");
	_router->remove_handler("rib/0.1/delete_egp_table6");
	_router->remove_handler("rib/0.1/add_route4");
	_router->remove_handler("rib/0.1/add_route6");
	_router->remove_handler("rib/0.1/replace_route4");
	_router->remove_handler("rib/0.1/replace_route6");
	_router->remove_handler("rib/0.1/delete_route4");
	_router->remove_handler("rib/0.1/delete_route6");
	_router->remove_handler("rib/0.1/lookup_route4");
	_router->remove_handler("rib/0.1/lookup_route6");
	_router->remove_handler("rib/0.1/new_vif");
	_router->remove_handler("rib/0.1/add_vif_addr4");
	_router->remove_handler("rib/0.1/add_vif_addr6");
	_router->remove_handler("rib/0.1/redist_enable4");
	_router->remove_handler("rib/0.1/redist_enable6");
	_router->remove_handler("rib/0.1/redist_disable4");
	_router->remove_handler("rib/0.1/redist_disable6");
	_router->remove_handler("rib/0.1/register_interest4");
	_router->remove_handler("rib/0.1/deregister_interest4");
	_router->remove_handler("rib/0.1/register_interest6");
	_router->remove_handler("rib/0.1/deregister_interest6");
