 ...
 *
 * $XORP: xorp/xrl/targets/ospf_base.hh,v 1.1.1.1 2002/12/11 23:56:19 hodson Exp $
 */
...
public:
    XrlOspfTargetBase(XrlCmdMap* r) : _router(r) { add_handlers(); }
...
private:
	...
	if (_router->add_handler("ospf/0.1/set_router_id", 
	...
	if (_router->add_handler("ospf/0.1/get_router_id", 
	...
	if (_router->add_handler("ospf/0.1/set_lsdb_limit", 
	...
	if (_router->add_handler("ospf/0.1/get_lsdb_limit", 
	...
	if (_router->add_handler("ospf/0.1/set_mospf", 
	...
	if (_router->add_handler("ospf/0.1/get_mospf", 
	...
	if (_router->add_handler("ospf/0.1/set_interarea_mc", 
	...
	if (_router->add_handler("ospf/0.1/get_interarea_mc", 
	...
	if (_router->add_handler("ospf/0.1/set_overflow_interval", 
	...
	if (_router->add_handler("ospf/0.1/get_overflow_interval", 
	...
	if (_router->add_handler("ospf/0.1/set_flood_rate", 
	...
	if (_router->add_handler("ospf/0.1/get_flood_rate", 
	...
	if (_router->add_handler("ospf/0.1/set_max_rxmt_window", 
	...
	if (_router->add_handler("ospf/0.1/get_max_rxmt_window", 
	...
	if (_router->add_handler("ospf/0.1/set_max_dds", 
	...
	if (_router->add_handler("ospf/0.1/get_max_dds", 
	...
	if (_router->add_handler("ospf/0.1/set_lsa_refresh_rate", 
	...
	if (_router->add_handler("ospf/0.1/get_lsa_refresh_rate", 
	...
	if (_router->add_handler("ospf/0.1/set_p2p_adj_limit", 
	...
	if (_router->add_handler("ospf/0.1/get_p2p_adj_limit", 
	...
	if (_router->add_handler("ospf/0.1/set_random_refresh", 
	...
	if (_router->add_handler("ospf/0.1/get_random_refresh", 
	...
	if (_router->add_handler("ospf/0.1/add_or_configure_area", 
	...
	if (_router->add_handler("ospf/0.1/delete_area", 
	...
	if (_router->add_handler("ospf/0.1/query_area", 
	...
	if (_router->add_handler("ospf/0.1/list_area_ids", 
	...
	if (_router->add_handler("ospf/0.1/add_or_configure_aggregate", 
	...
	if (_router->add_handler("ospf/0.1/delete_aggregate", 
	...
	if (_router->add_handler("ospf/0.1/query_aggregate", 
	...
	if (_router->add_handler("ospf/0.1/list_aggregates", 
	...
	if (_router->add_handler("ospf/0.1/add_or_configure_host", 
	...
	if (_router->add_handler("ospf/0.1/delete_host", 
	...
	if (_router->add_handler("ospf/0.1/query_host", 
	...
	if (_router->add_handler("ospf/0.1/list_hosts", 
	...
	if (_router->add_handler("ospf/0.1/add_vlink", 
	...
	if (_router->add_handler("ospf/0.1/delete_vlink", 
	...
	if (_router->add_handler("ospf/0.1/vlink_set_transmit_delay", 
	...
	if (_router->add_handler("ospf/0.1/vlink_get_transmit_delay", 
	...
	if (_router->add_handler("ospf/0.1/vlink_set_retransmit_interval", 
	...
	if (_router->add_handler("ospf/0.1/vlink_get_retransmit_interval", 
	...
	if (_router->add_handler("ospf/0.1/vlink_set_hello_interval", 
	...
	if (_router->add_handler("ospf/0.1/vlink_get_hello_interval", 
	...
	if (_router->add_handler("ospf/0.1/vlink_set_router_dead_interval", 
	...
	if (_router->add_handler("ospf/0.1/vlink_get_router_dead_interval", 
	...
	if (_router->add_handler("ospf/0.1/vlink_set_authentication", 
	...
	if (_router->add_handler("ospf/0.1/vlink_get_authentication", 
	...
	if (_router->add_handler("ospf/0.1/list_vlinks", 
	...
	if (_router->add_handler("ospf/0.1/add_or_configure_external_route", 
	...
	if (_router->add_handler("ospf/0.1/delete_external_route", 
	...
	if (_router->add_handler("ospf/0.1/query_external_route", 
	...
	if (_router->add_handler("ospf/0.1/list_external_routes", 
	...
	if (_router->add_handler("ospf/0.1/add_interface", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_if_index", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_if_index", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_area_id", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_area_id", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_cost", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_cost", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_mtu", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_mtu", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_type", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_type", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_dr_priority", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_dr_priority", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_transit_delay", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_transit_delay", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_retransmit_interval", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_retransmit_interval", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_router_dead_interval", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_router_dead_interval", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_poll_interval", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_poll_interval", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_authentication", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_authentication", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_multicast_forwarding", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_multicast_forwarding", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_on_demand", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_on_demand", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_passive", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_passive", 
	...
	if (_router->add_handler("ospf/0.1/interface_set_igmp", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_igmp", 
	...
	if (_router->add_handler("ospf/0.1/delete_interface", 
	...
	if (_router->add_handler("ospf/0.1/list_interfaces", 
	...
	if (_router->add_handler("ospf/0.1/interface_add_md5_key", 
	...
	if (_router->add_handler("ospf/0.1/interface_get_md5_key", 
	...
	if (_router->add_handler("ospf/0.1/interface_delete_md5_key", 
	...
	if (_router->add_handler("ospf/0.1/interface_list_md5_keys", 
	...
	if (_router->add_handler("ospf/0.1/add_neighbor", 
	...
	if (_router->add_handler("ospf/0.1/get_neighbor", 
	...
	if (_router->add_handler("ospf/0.1/delete_neighbor", 
	...
	if (_router->add_handler("ospf/0.1/list_neighbors", 
	...
	_router->remove_handler("ospf/0.1/set_router_id");
	_router->remove_handler("ospf/0.1/get_router_id");
	_router->remove_handler("ospf/0.1/set_lsdb_limit");
	_router->remove_handler("ospf/0.1/get_lsdb_limit");
	_router->remove_handler("ospf/0.1/set_mospf");
	_router->remove_handler("ospf/0.1/get_mospf");
	_router->remove_handler("ospf/0.1/set_interarea_mc");
	_router->remove_handler("ospf/0.1/get_interarea_mc");
	_router->remove_handler("ospf/0.1/set_overflow_interval");
	_router->remove_handler("ospf/0.1/get_overflow_interval");
	_router->remove_handler("ospf/0.1/set_flood_rate");
	_router->remove_handler("ospf/0.1/get_flood_rate");
	_router->remove_handler("ospf/0.1/set_max_rxmt_window");
	_router->remove_handler("ospf/0.1/get_max_rxmt_window");
	_router->remove_handler("ospf/0.1/set_max_dds");
	_router->remove_handler("ospf/0.1/get_max_dds");
	_router->remove_handler("ospf/0.1/set_lsa_refresh_rate");
	_router->remove_handler("ospf/0.1/get_lsa_refresh_rate");
	_router->remove_handler("ospf/0.1/set_p2p_adj_limit");
	_router->remove_handler("ospf/0.1/get_p2p_adj_limit");
	_router->remove_handler("ospf/0.1/set_random_refresh");
	_router->remove_handler("ospf/0.1/get_random_refresh");
	_router->remove_handler("ospf/0.1/add_or_configure_area");
	_router->remove_handler("ospf/0.1/delete_area");
	_router->remove_handler("ospf/0.1/query_area");
	_router->remove_handler("ospf/0.1/list_area_ids");
	_router->remove_handler("ospf/0.1/add_or_configure_aggregate");
	_router->remove_handler("ospf/0.1/delete_aggregate");
	_router->remove_handler("ospf/0.1/query_aggregate");
	_router->remove_handler("ospf/0.1/list_aggregates");
	_router->remove_handler("ospf/0.1/add_or_configure_host");
	_router->remove_handler("ospf/0.1/delete_host");
	_router->remove_handler("ospf/0.1/query_host");
	_router->remove_handler("ospf/0.1/list_hosts");
	_router->remove_handler("ospf/0.1/add_vlink");
	_router->remove_handler("ospf/0.1/delete_vlink");
	_router->remove_handler("ospf/0.1/vlink_set_transmit_delay");
	_router->remove_handler("ospf/0.1/vlink_get_transmit_delay");
	_router->remove_handler("ospf/0.1/vlink_set_retransmit_interval");
	_router->remove_handler("ospf/0.1/vlink_get_retransmit_interval");
	_router->remove_handler("ospf/0.1/vlink_set_hello_interval");
	_router->remove_handler("ospf/0.1/vlink_get_hello_interval");
	_router->remove_handler("ospf/0.1/vlink_set_router_dead_interval");
	_router->remove_handler("ospf/0.1/vlink_get_router_dead_interval");
	_router->remove_handler("ospf/0.1/vlink_set_authentication");
	_router->remove_handler("ospf/0.1/vlink_get_authentication");
	_router->remove_handler("ospf/0.1/list_vlinks");
	_router->remove_handler("ospf/0.1/add_or_configure_external_route");
	_router->remove_handler("ospf/0.1/delete_external_route");
	_router->remove_handler("ospf/0.1/query_external_route");
	_router->remove_handler("ospf/0.1/list_external_routes");
	_router->remove_handler("ospf/0.1/add_interface");
	_router->remove_handler("ospf/0.1/interface_set_if_index");
	_router->remove_handler("ospf/0.1/interface_get_if_index");
	_router->remove_handler("ospf/0.1/interface_set_area_id");
	_router->remove_handler("ospf/0.1/interface_get_area_id");
	_router->remove_handler("ospf/0.1/interface_set_cost");
	_router->remove_handler("ospf/0.1/interface_get_cost");
	_router->remove_handler("ospf/0.1/interface_set_mtu");
	_router->remove_handler("ospf/0.1/interface_get_mtu");
	_router->remove_handler("ospf/0.1/interface_set_type");
	_router->remove_handler("ospf/0.1/interface_get_type");
	_router->remove_handler("ospf/0.1/interface_set_dr_priority");
	_router->remove_handler("ospf/0.1/interface_get_dr_priority");
	_router->remove_handler("ospf/0.1/interface_set_transit_delay");
	_router->remove_handler("ospf/0.1/interface_get_transit_delay");
	_router->remove_handler("ospf/0.1/interface_set_retransmit_interval");
	_router->remove_handler("ospf/0.1/interface_get_retransmit_interval");
	_router->remove_handler("ospf/0.1/interface_set_router_dead_interval");
	_router->remove_handler("ospf/0.1/interface_get_router_dead_interval");
	_router->remove_handler("ospf/0.1/interface_set_poll_interval");
	_router->remove_handler("ospf/0.1/interface_get_poll_interval");
	_router->remove_handler("ospf/0.1/interface_set_authentication");
	_router->remove_handler("ospf/0.1/interface_get_authentication");
	_router->remove_handler("ospf/0.1/interface_set_multicast_forwarding");
	_router->remove_handler("ospf/0.1/interface_get_multicast_forwarding");
	_router->remove_handler("ospf/0.1/interface_set_on_demand");
	_router->remove_handler("ospf/0.1/interface_get_on_demand");
	_router->remove_handler("ospf/0.1/interface_set_passive");
	_router->remove_handler("ospf/0.1/interface_get_passive");
	_router->remove_handler("ospf/0.1/interface_set_igmp");
	_router->remove_handler("ospf/0.1/interface_get_igmp");
	_router->remove_handler("ospf/0.1/delete_interface");
	_router->remove_handler("ospf/0.1/list_interfaces");
	_router->remove_handler("ospf/0.1/interface_add_md5_key");
	_router->remove_handler("ospf/0.1/interface_get_md5_key");
	_router->remove_handler("ospf/0.1/interface_delete_md5_key");
	_router->remove_handler("ospf/0.1/interface_list_md5_keys");
	_router->remove_handler("ospf/0.1/add_neighbor");
	_router->remove_handler("ospf/0.1/get_neighbor");
	_router->remove_handler("ospf/0.1/delete_neighbor");
	_router->remove_handler("ospf/0.1/list_neighbors");
    }
};
