 ...
 *
 * $XORP: xorp/xrl/targets/ospf_base.hh,v 1.11 2003/06/19 00:44:47 hodson Exp $
 */
...
private:
	...
	if (_cmds->add_handler("common/0.1/get_status",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ospf/common/0.1/get_status");
	}
	if (_cmds->add_handler("common/0.1/shutdown",
	    callback(this, &XrlOspfTargetBase::handle_common_0_1_shutdown)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://ospf/common/0.1/shutdown");
	}
