 ...
 *
 * $XORP: xorp/xrl/targets/fea_base.hh,v 1.50 2004/11/29 01:59:46 bms Exp $
 */
...
protected:
     ...
     */
    virtual XrlCmdError fea_click_0_1_set_click_config_generator_file(
	// Input values,
	const string&	click_config_generator_file) = 0;
     ...
     */
    virtual XrlCmdError raw_packet4_0_1_send_raw(
	// Input values,
	const string&	vif_name,
     ...
     */
    virtual XrlCmdError raw_packet4_0_1_register_vif_receiver(
	// Input values,
     ...
     */
    virtual XrlCmdError raw_packet4_0_1_unregister_vif_receiver(
	// Input values,
	const string&	router_name,
	const string&	if_name,
	const string&	vif_name,
     ...
     */
    virtual XrlCmdError raw_packet6_0_1_send_raw(
	// Input values,
     ...
     */
    virtual XrlCmdError raw_packet6_0_1_register_vif_receiver(
	// Input values,
	const string&	router_name,
	const string&	if_name,
	const string&	vif_name,
     ...
     *  @param proto Protocol number that the receiver is interested in.
     */
    virtual XrlCmdError raw_packet6_0_1_unregister_vif_receiver(
	// Input values,
	const string&	router_name,
	const string&	if_name,
	const string&	vif_name,
...
private:
    ...
    const XrlCmdError handle_fea_click_0_1_set_click_config_generator_file(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_raw_packet4_0_1_send_raw(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_raw_packet4_0_1_register_vif_receiver(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_raw_packet4_0_1_unregister_vif_receiver(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_raw_packet6_0_1_send_raw(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_raw_packet6_0_1_register_vif_receiver(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_raw_packet6_0_1_unregister_vif_receiver(const XrlArgs& in, XrlArgs* out);
