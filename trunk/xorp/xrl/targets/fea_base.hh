 ...
 *
 * $XORP: xorp/xrl/targets/fea_base.hh,v 1.19 2003/06/01 22:34:01 hodson Exp $
 */
...
private:
    ...
    const XrlCmdError handle_ifmgr_0_1_get_all_vif_flags(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_vif_flags(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_vif_pif_index(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_vif_pif_index(const Xrl& x, XrlArgs* a);
    ...
    const XrlCmdError handle_ifmgr_0_1_get_all_address_flags4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_address_flags4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_address_flags6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_address_flags6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_interface_enabled(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_interface_enabled(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_mac(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_mac(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_mtu(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_mtu(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_vif_enabled(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_vif_enabled(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_prefix4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_prefix4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_broadcast4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_broadcast4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_endpoint4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_endpoint4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_prefix6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_prefix6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_all_endpoint6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_endpoint6(const Xrl& x, XrlArgs* a);
    ...
    const XrlCmdError handle_ifmgr_0_1_get_all_address_enabled4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_address_enabled4(const Xrl& x, XrlArgs* a);
    ...
    const XrlCmdError handle_ifmgr_0_1_get_all_address_enabled6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_configured_address_enabled6(const Xrl& x, XrlArgs* a);
    ...
    const XrlCmdError handle_ifmgr_0_1_register_all_interfaces_client(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_unregister_all_interfaces_client(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_start_transaction(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_commit_transaction(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_abort_transaction(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_add_entry4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_add_entry6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_delete_entry4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_delete_entry6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_delete_all_entries(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_delete_all_entries4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_delete_all_entries6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_lookup_route4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_lookup_route6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_lookup_entry4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_fti_0_2_lookup_entry6(const Xrl& x, XrlArgs* a);
