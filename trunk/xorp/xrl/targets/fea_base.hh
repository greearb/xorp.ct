 ...
 *
 * $XORP: xorp/xrl/targets/fea_base.hh,v 1.16 2003/05/23 23:26:35 pavlin Exp $
 */
...
protected:
     ...
     */
    virtual XrlCmdError fea_0_1_terminate() = 0;
...
private:
    ...
    const XrlCmdError handle_fea_0_1_terminate(const Xrl& x, XrlArgs* a);
	...
	if (_cmds->add_handler("fea/0.1/terminate", 
	    callback(this, &XrlFeaTargetBase::handle_fea_0_1_terminate)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://fea/fea/0.1/terminate");
	}
	...
	_cmds->remove_handler("fea/0.1/terminate");
