 ...
 *
 * $XORP: xorp/xrl/targets/fea_base.hh,v 1.10 2003/04/11 22:26:09 pavlin Exp $
 */
...
protected:
    ...
    virtual XrlCmdError ifmgr_0_1_get_address_flags4(
	// Input values, 
	const string&	ifname, 
	const string&	vif, 
	const IPv4&	address, 
    ...
    virtual XrlCmdError ifmgr_0_1_get_address_flags6(
	// Input values, 
	const string&	ifname, 
	const string&	vif, 
	const IPv6&	address, 
...
private:
    ...
    const XrlCmdError handle_ifmgr_0_1_get_address_flags4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_ifmgr_0_1_get_address_flags6(const Xrl& x, XrlArgs* a);
	...
	if (_cmds->add_handler("ifmgr/0.1/get_address_flags4", 
	    callback(this, &XrlFeaTargetBase::handle_ifmgr_0_1_get_address_flags4)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_address_flags4");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_address_flags6", 
	    callback(this, &XrlFeaTargetBase::handle_ifmgr_0_1_get_address_flags6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_address_flags6");
	}
	...
	_cmds->remove_handler("ifmgr/0.1/get_address_flags4");
	_cmds->remove_handler("ifmgr/0.1/get_address_flags6");
