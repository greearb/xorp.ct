 ...
 *
 * $XORP: xorp/xrl/targets/fea_base.hh,v 1.33 2004/04/06 07:10:28 pavlin Exp $
 */
...
private:
	...
	if (_cmds->add_handler("fea_fib/0.1/add_fib_client4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/fea_fib/0.1/add_fib_client4");
	}
	if (_cmds->add_handler("fea_fib/0.1/add_fib_client6",
	    callback(this, &XrlFeaTargetBase::handle_fea_fib_0_1_add_fib_client6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://fea/fea_fib/0.1/add_fib_client6");
	}
	if (_cmds->add_handler("fea_fib/0.1/delete_fib_client4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/fea_fib/0.1/delete_fib_client4");
	}
	if (_cmds->add_handler("fea_fib/0.1/delete_fib_client6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/fea_fib/0.1/delete_fib_client6");
	}
	...
	if (_cmds->add_handler("ifmgr/0.1/configure_interface_from_system",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/configure_interface_from_system");
	}
	...
	if (_cmds->add_handler("ifmgr/0.1/get_system_interface_names",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_interface_names");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_vif_names",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_vif_names");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_vif_flags",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_vif_flags");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_vif_pif_index",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_vif_pif_index");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_vif_addresses4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_vif_addresses4");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_address_flags4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_address_flags4");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_vif_addresses6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_vif_addresses6");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_address_flags6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_address_flags6");
	}
	...
	if (_cmds->add_handler("ifmgr/0.1/get_system_vif_enabled",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_vif_enabled");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_prefix4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_prefix4");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_broadcast4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_broadcast4");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_endpoint4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_endpoint4");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_prefix6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_prefix6");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_endpoint6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_endpoint6");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_address_enabled4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_address_enabled4");
	}
	if (_cmds->add_handler("ifmgr/0.1/get_system_address_enabled6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/get_system_address_enabled6");
	}
	if (_cmds->add_handler("ifmgr/0.1/register_system_interfaces_client",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/register_system_interfaces_client");
	}
	if (_cmds->add_handler("ifmgr/0.1/unregister_system_interfaces_client",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr/0.1/unregister_system_interfaces_client");
	}
	...
	if (_cmds->add_handler("redist_transaction4/0.1/start_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction4/0.1/start_transaction");
	}
	if (_cmds->add_handler("redist_transaction4/0.1/commit_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction4/0.1/commit_transaction");
	}
	if (_cmds->add_handler("redist_transaction4/0.1/abort_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction4/0.1/abort_transaction");
	}
	if (_cmds->add_handler("redist_transaction4/0.1/add_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction4/0.1/add_route");
	}
	if (_cmds->add_handler("redist_transaction4/0.1/delete_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction4/0.1/delete_route");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/start_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction6/0.1/start_transaction");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/commit_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction6/0.1/commit_transaction");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/abort_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction6/0.1/abort_transaction");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/add_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction6/0.1/add_route");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/delete_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/redist_transaction6/0.1/delete_route");
	}
	...
	if (_cmds->add_handler("socket4_locator/0.1/find_socket_server_for_addr",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/socket4_locator/0.1/find_socket_server_for_addr");
	}
	if (_cmds->add_handler("socket6_locator/0.1/find_socket_server_for_addr",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/socket6_locator/0.1/find_socket_server_for_addr");
	}
	_cmds->finalize();
    }
