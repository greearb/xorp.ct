 ...
 *
 * $XORP: xorp/xrl/targets/fea_base.hh,v 1.25 2003/09/12 23:43:40 pavlin Exp $
 */
...
private:
	...
	if (_cmds->add_handler("ifmgr_replicator/0.1/register_ifmgr_mirror", 
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr_replicator/0.1/register_ifmgr_mirror");
	}
	if (_cmds->add_handler("ifmgr_replicator/0.1/unregister_ifmgr_mirror", 
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/ifmgr_replicator/0.1/unregister_ifmgr_mirror");
	}
	...
	if (_cmds->add_handler("fti/0.2/have_ipv4", 
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/fti/0.2/have_ipv4");
	}
	if (_cmds->add_handler("fti/0.2/have_ipv6", 
	    callback(this, &XrlFeaTargetBase::handle_fti_0_2_have_ipv6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://fea/fti/0.2/have_ipv6");
	}
	if (_cmds->add_handler("fti/0.2/get_unicast_forwarding_enabled4", 
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/fti/0.2/get_unicast_forwarding_enabled4");
	}
	if (_cmds->add_handler("fti/0.2/get_unicast_forwarding_enabled6", 
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/fti/0.2/get_unicast_forwarding_enabled6");
	}
	if (_cmds->add_handler("fti/0.2/set_unicast_forwarding_enabled4", 
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/fti/0.2/set_unicast_forwarding_enabled4");
	}
	if (_cmds->add_handler("fti/0.2/set_unicast_forwarding_enabled6", 
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea/fti/0.2/set_unicast_forwarding_enabled6");
	}
