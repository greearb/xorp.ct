...
#ident "$XORP: xorp/xrl/targets/socket_server_base.cc,v 1.2 2004/02/19 04:33:15 hodson Exp $"
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling socket4/0.1/udp_join_group",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for socket4/0.1/udp_join_group failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling socket4/0.1/udp_leave_group",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for socket4/0.1/udp_leave_group failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != 5) handling socket4/0.1/send_from_multicast_if",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = socket4_0_1_send_from_multicast_if(
	    ...
	    xa_inputs.get_binary("data"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for socket4/0.1/send_from_multicast_if failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling socket6/0.1/udp_join_group",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for socket6/0.1/udp_join_group failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling socket6/0.1/udp_leave_group",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for socket6/0.1/udp_leave_group failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != 5) handling socket6/0.1/send_from_multicast_if",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = socket6_0_1_send_from_multicast_if(
	    ...
	    xa_inputs.get_binary("data"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for socket6/0.1/send_from_multicast_if failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
