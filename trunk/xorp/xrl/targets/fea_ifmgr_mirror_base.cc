...
#ident "$XORP: xorp/xrl/targets/fea_ifmgr_mirror_base.cc,v 1.26 2008/01/04 03:18:08 pavlin Exp $"
...
XrlFeaIfmgrMirrorTargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("fea_ifmgr_mirror/0.1/interface_set_baudrate",
	    callback(this, &XrlFeaIfmgrMirrorTargetBase::handle_fea_ifmgr_mirror_0_1_interface_set_baudrate)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea_ifmgr_mirror", "fea_ifmgr_mirror/0.1/interface_set_baudrate");
	}
...
XrlFeaIfmgrMirrorTargetBase::remove_handlers()
{
	...
	_cmds->remove_handler("fea_ifmgr_mirror/0.1/interface_set_baudrate");
