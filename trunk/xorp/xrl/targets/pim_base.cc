...
#ident "$XORP: xorp/xrl/targets/pim_base.cc,v 1.40 2004/12/14 21:55:10 pavlin Exp $"
...
XrlPimTargetBase::handle_mfea_client_0_1_set_vif_flags(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(7), XORP_UINT_CAST(xa_inputs.size()), "mfea_client/0.1/set_vif_flags");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_mfea_client_0_1_add_mrib4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(7), XORP_UINT_CAST(xa_inputs.size()), "mfea_client/0.1/add_mrib4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_mfea_client_0_1_add_mrib6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(7), XORP_UINT_CAST(xa_inputs.size()), "mfea_client/0.1/add_mrib6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_mfea_client_0_1_delete_mrib4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "mfea_client/0.1/delete_mrib4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_mfea_client_0_1_delete_mrib6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "mfea_client/0.1/delete_mrib6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_mfea_client_0_1_set_mrib_done(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "mfea_client/0.1/set_mrib_done");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_redist_transaction4_0_1_delete_route(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "redist_transaction4/0.1/delete_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_redist_transaction6_0_1_delete_route(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "redist_transaction6/0.1/delete_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_add_config_cand_bsr_by_vif_name4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/add_config_cand_bsr_by_vif_name4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_add_config_cand_bsr_by_vif_name6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/add_config_cand_bsr_by_vif_name6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_add_config_cand_bsr_by_addr4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/add_config_cand_bsr_by_addr4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_add_config_cand_bsr_by_addr6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/add_config_cand_bsr_by_addr6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_add_config_cand_rp_by_vif_name4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/add_config_cand_rp_by_vif_name4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_add_config_cand_rp_by_vif_name6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/add_config_cand_rp_by_vif_name6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_add_config_cand_rp_by_addr4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/add_config_cand_rp_by_addr4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_add_config_cand_rp_by_addr6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/add_config_cand_rp_by_addr6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_delete_config_cand_rp_by_vif_name4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/delete_config_cand_rp_by_vif_name4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_delete_config_cand_rp_by_vif_name6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/delete_config_cand_rp_by_vif_name6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_delete_config_cand_rp_by_addr4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/delete_config_cand_rp_by_addr4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_delete_config_cand_rp_by_addr6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/delete_config_cand_rp_by_addr6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_get_vif_lan_delay(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/get_vif_lan_delay");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_set_vif_lan_delay(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/set_vif_lan_delay");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_reset_vif_lan_delay(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/reset_vif_lan_delay");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_send_test_jp_entry4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/send_test_jp_entry4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlPimTargetBase::handle_pim_0_1_send_test_jp_entry6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/send_test_jp_entry6");
	return XrlCmdError::BAD_ARGS();
    }
