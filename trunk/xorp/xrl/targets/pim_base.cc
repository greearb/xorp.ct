...
#ident "$XORP: xorp/xrl/targets/pim_base.cc,v 1.33 2004/05/12 21:58:40 pavlin Exp $"
...
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling pim/0.1/enable_vif",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling pim/0.1/enable_all_vifs",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling pim/0.1/enable_pim",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling pim/0.1/enable_cli",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling pim/0.1/enable_bsr",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling pim/0.1/add_alternative_subnet4",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = pim_0_1_add_alternative_subnet4(
	    ...
	    xa_inputs.get_ipv4net("subnet"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for pim/0.1/add_alternative_subnet4 failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling pim/0.1/add_alternative_subnet6",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = pim_0_1_add_alternative_subnet6(
	    ...
	    xa_inputs.get_ipv6net("subnet"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for pim/0.1/add_alternative_subnet6 failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling pim/0.1/delete_alternative_subnet4",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = pim_0_1_delete_alternative_subnet4(
	    ...
	    xa_inputs.get_ipv4net("subnet"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for pim/0.1/delete_alternative_subnet4 failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling pim/0.1/delete_alternative_subnet6",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = pim_0_1_delete_alternative_subnet6(
	    ...
	    xa_inputs.get_ipv6net("subnet"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for pim/0.1/delete_alternative_subnet6 failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling pim/0.1/remove_all_alternative_subnets",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = pim_0_1_remove_all_alternative_subnets(
	    xa_inputs.get_string("vif_name"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for pim/0.1/remove_all_alternative_subnets failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling pim/0.1/log_trace_all",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = pim_0_1_log_trace_all(
	    xa_inputs.get_bool("enable"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for pim/0.1/log_trace_all failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
