...
#ident "$XORP: xorp/xrl/targets/pim_base.cc,v 1.50 2005/05/14 03:18:42 pavlin Exp $"
...
const XrlCmdError
XrlPimTargetBase::handle_pim_0_1_get_vif_ip_router_alert_option_check(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/get_vif_ip_router_alert_option_check");
	return XrlCmdError::BAD_ARGS();
    }
    ...
    bool enabled;
    try {
	XrlCmdError e = pim_0_1_get_vif_ip_router_alert_option_check(
	    xa_inputs.get_string("vif_name"),
	    enabled);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "pim/0.1/get_vif_ip_router_alert_option_check", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
const XrlCmdError
XrlPimTargetBase::handle_pim_0_1_set_vif_ip_router_alert_option_check(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/set_vif_ip_router_alert_option_check");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = pim_0_1_set_vif_ip_router_alert_option_check(
	    xa_inputs.get_string("vif_name"),
	    xa_inputs.get_bool("enable"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "pim/0.1/set_vif_ip_router_alert_option_check", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
const XrlCmdError
XrlPimTargetBase::handle_pim_0_1_reset_vif_ip_router_alert_option_check(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "pim/0.1/reset_vif_ip_router_alert_option_check");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = pim_0_1_reset_vif_ip_router_alert_option_check(
	    xa_inputs.get_string("vif_name"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "pim/0.1/reset_vif_ip_router_alert_option_check", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
XrlPimTargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("pim/0.1/get_vif_ip_router_alert_option_check",
	    callback(this, &XrlPimTargetBase::handle_pim_0_1_get_vif_ip_router_alert_option_check)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "pim", "pim/0.1/get_vif_ip_router_alert_option_check");
	}
	if (_cmds->add_handler("pim/0.1/set_vif_ip_router_alert_option_check",
	    callback(this, &XrlPimTargetBase::handle_pim_0_1_set_vif_ip_router_alert_option_check)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "pim", "pim/0.1/set_vif_ip_router_alert_option_check");
	}
	if (_cmds->add_handler("pim/0.1/reset_vif_ip_router_alert_option_check",
	    callback(this, &XrlPimTargetBase::handle_pim_0_1_reset_vif_ip_router_alert_option_check)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "pim", "pim/0.1/reset_vif_ip_router_alert_option_check");
	}
...
XrlPimTargetBase::remove_handlers()
{
	...
	_cmds->remove_handler("pim/0.1/get_vif_ip_router_alert_option_check");
	_cmds->remove_handler("pim/0.1/set_vif_ip_router_alert_option_check");
	_cmds->remove_handler("pim/0.1/reset_vif_ip_router_alert_option_check");
