...
#ident "$XORP: xorp/xrl/targets/fea_base.cc,v 1.48 2004/12/02 02:37:49 pavlin Exp $"
...
XrlFeaTargetBase::handle_fea_click_0_1_enable_click(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/enable_click");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_start_click(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/start_click");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_stop_click(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/stop_click");
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlFeaTargetBase::handle_fea_click_0_1_set_click_config_generator_file(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_click_config_generator_file");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = fea_click_0_1_set_click_config_generator_file(
	    xa_inputs.get_string("click_config_generator_file"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "fea_click/0.1/set_click_config_generator_file", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
XrlFeaTargetBase::handle_fea_click_0_1_enable_kernel_click(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/enable_kernel_click");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_enable_kernel_click_install_on_startup(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/enable_kernel_click_install_on_startup");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_set_kernel_click_modules(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_kernel_click_modules");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_set_kernel_click_mount_directory(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_kernel_click_mount_directory");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_enable_user_click(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/enable_user_click");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_set_user_click_command_file(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_user_click_command_file");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_set_user_click_command_extra_arguments(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_user_click_command_extra_arguments");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_set_user_click_command_execute_on_startup(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_user_click_command_execute_on_startup");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_set_user_click_control_address(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_user_click_control_address");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_set_user_click_control_socket_port(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_user_click_control_socket_port");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_click_0_1_set_user_click_startup_config_file(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_user_click_startup_config_file");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_fib_0_1_add_fib_client4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "fea_fib/0.1/add_fib_client4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_fib_0_1_add_fib_client6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "fea_fib/0.1/add_fib_client6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_fib_0_1_delete_fib_client4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_fib/0.1/delete_fib_client4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fea_fib_0_1_delete_fib_client6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fea_fib/0.1/delete_fib_client6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_interface_names(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_interface_names");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_vif_names(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_vif_names");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_vif_flags(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_vif_flags");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_vif_pif_index(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_vif_pif_index");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_vif_addresses4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_vif_addresses4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_vif_addresses6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_vif_addresses6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_address_flags4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_address_flags4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_address_flags6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_address_flags6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_interface_enabled(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_interface_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_interface_discard(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_interface_discard");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_mac(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_mac");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_mtu(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_mtu");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_vif_enabled(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_vif_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_prefix4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_prefix4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_broadcast4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_broadcast4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_endpoint4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_endpoint4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_prefix6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_prefix6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_endpoint6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_endpoint6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_start_transaction(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/start_transaction");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_commit_transaction(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/commit_transaction");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_abort_transaction(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/abort_transaction");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_create_interface(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/create_interface");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_delete_interface(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/delete_interface");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_configure_interface_from_system(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/configure_interface_from_system");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_interface_enabled(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_interface_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_interface_discard(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_interface_discard");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_mac(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_mac");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_mtu(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_mtu");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_create_vif(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/create_vif");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_delete_vif(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/delete_vif");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_vif_enabled(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_vif_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_create_address4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/create_address4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_delete_address4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/delete_address4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_address_enabled4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            5, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_address_enabled4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_address_enabled4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_address_enabled4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_prefix4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            5, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_prefix4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_broadcast4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            5, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_broadcast4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_endpoint4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            5, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_endpoint4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_create_address6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/create_address6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_delete_address6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/delete_address6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_address_enabled6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            5, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_address_enabled6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_configured_address_enabled6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_configured_address_enabled6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_prefix6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            5, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_prefix6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_endpoint6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            5, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/set_endpoint6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_register_client(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/register_client");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_unregister_client(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/unregister_client");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_interface_names(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_interface_names");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_names(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_names");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_flags(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_flags");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_pif_index(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_pif_index");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_addresses4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_addresses4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_address_flags4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_address_flags4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_addresses6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_addresses6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_address_flags6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_address_flags6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_interface_enabled(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_interface_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_interface_discard(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_interface_discard");
	return XrlCmdError::BAD_ARGS();
    }
    ...
    bool discard;
    try {
	XrlCmdError e = ifmgr_0_1_get_system_interface_discard(
	    xa_inputs.get_string("ifname"),
	    discard);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "ifmgr/0.1/get_system_interface_discard", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_mac(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_mac");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_mtu(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_mtu");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_enabled(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_prefix4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_prefix4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_broadcast4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_broadcast4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_endpoint4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_endpoint4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_prefix6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_prefix6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_endpoint6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_endpoint6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_address_enabled4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_address_enabled4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_address_enabled6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_address_enabled6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_register_system_interfaces_client(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/register_system_interfaces_client");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_unregister_system_interfaces_client(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/unregister_system_interfaces_client");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_replicator_0_1_register_ifmgr_mirror(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr_replicator/0.1/register_ifmgr_mirror");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_replicator_0_1_unregister_ifmgr_mirror(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ifmgr_replicator/0.1/unregister_ifmgr_mirror");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_lookup_route_by_dest4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/lookup_route_by_dest4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_lookup_route_by_dest6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/lookup_route_by_dest6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_lookup_route_by_network4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/lookup_route_by_network4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_lookup_route_by_network6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/lookup_route_by_network6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_have_ipv4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/have_ipv4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_have_ipv6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/have_ipv6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_get_unicast_forwarding_enabled4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/get_unicast_forwarding_enabled4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_get_unicast_forwarding_enabled6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/get_unicast_forwarding_enabled6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_set_unicast_forwarding_enabled4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/set_unicast_forwarding_enabled4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_fti_0_2_set_unicast_forwarding_enabled6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "fti/0.2/set_unicast_forwarding_enabled6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_raw_packet4_0_1_send(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 8) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            8, XORP_UINT_CAST(xa_inputs.size()), "raw_packet4/0.1/send");
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlFeaTargetBase::handle_raw_packet4_0_1_send_raw(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "raw_packet4/0.1/send_raw");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = raw_packet4_0_1_send_raw(
	    xa_inputs.get_string("vif_name"),
	    xa_inputs.get_binary("packet"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "raw_packet4/0.1/send_raw", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
const XrlCmdError
XrlFeaTargetBase::handle_raw_packet4_0_1_register_vif_receiver(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "raw_packet4/0.1/register_vif_receiver");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = raw_packet4_0_1_register_vif_receiver(
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "raw_packet4/0.1/register_vif_receiver", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
const XrlCmdError
XrlFeaTargetBase::handle_raw_packet4_0_1_unregister_vif_receiver(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "raw_packet4/0.1/unregister_vif_receiver");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = raw_packet4_0_1_unregister_vif_receiver(
	    xa_inputs.get_string("router_name"),
	    xa_inputs.get_string("if_name"),
	    xa_inputs.get_string("vif_name"),
	    xa_inputs.get_uint32("proto"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "raw_packet4/0.1/unregister_vif_receiver", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
const XrlCmdError
XrlFeaTargetBase::handle_raw_packet6_0_1_send_raw(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 8) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            8, XORP_UINT_CAST(xa_inputs.size()), "raw_packet6/0.1/send_raw");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = raw_packet6_0_1_send_raw(
	    xa_inputs.get_ipv6("src_address"),
	    xa_inputs.get_ipv6("dst_address"),
	    xa_inputs.get_string("vif_name"),
	    xa_inputs.get_uint32("proto"),
	    xa_inputs.get_uint32("tclass"),
	    xa_inputs.get_uint32("hoplimit"),
	    xa_inputs.get_binary("hopopts"),
	    xa_inputs.get_binary("packet"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "raw_packet6/0.1/send_raw", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
const XrlCmdError
XrlFeaTargetBase::handle_raw_packet6_0_1_register_vif_receiver(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "raw_packet6/0.1/register_vif_receiver");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = raw_packet6_0_1_register_vif_receiver(
	    xa_inputs.get_string("router_name"),
	    xa_inputs.get_string("if_name"),
	    xa_inputs.get_string("vif_name"),
	    xa_inputs.get_uint32("proto"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "raw_packet6/0.1/register_vif_receiver", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
const XrlCmdError
XrlFeaTargetBase::handle_raw_packet6_0_1_unregister_vif_receiver(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "raw_packet6/0.1/unregister_vif_receiver");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = raw_packet6_0_1_unregister_vif_receiver(
	    xa_inputs.get_string("router_name"),
	    xa_inputs.get_string("if_name"),
	    xa_inputs.get_string("vif_name"),
	    xa_inputs.get_uint32("proto"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "raw_packet6/0.1/unregister_vif_receiver", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
XrlFeaTargetBase::handle_socket4_locator_0_1_find_socket_server_for_addr(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "socket4_locator/0.1/find_socket_server_for_addr");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_socket6_locator_0_1_find_socket_server_for_addr(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "socket6_locator/0.1/find_socket_server_for_addr");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_profile_0_1_enable(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "profile/0.1/enable");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_profile_0_1_disable(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "profile/0.1/disable");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_profile_0_1_get_entries(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "profile/0.1/get_entries");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_profile_0_1_clear(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "profile/0.1/clear");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_profile_0_1_list(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "profile/0.1/list");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("fea_click/0.1/set_click_config_generator_file",
	    callback(this, &XrlFeaTargetBase::handle_fea_click_0_1_set_click_config_generator_file)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "fea_click/0.1/set_click_config_generator_file");
	}
	...
	if (_cmds->add_handler("ifmgr/0.1/get_system_interface_discard",
	    callback(this, &XrlFeaTargetBase::handle_ifmgr_0_1_get_system_interface_discard)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "ifmgr/0.1/get_system_interface_discard");
	}
	...
	if (_cmds->add_handler("raw_packet4/0.1/send_raw",
	    callback(this, &XrlFeaTargetBase::handle_raw_packet4_0_1_send_raw)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "raw_packet4/0.1/send_raw");
	}
	if (_cmds->add_handler("raw_packet4/0.1/register_vif_receiver",
	    callback(this, &XrlFeaTargetBase::handle_raw_packet4_0_1_register_vif_receiver)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "raw_packet4/0.1/register_vif_receiver");
	}
	if (_cmds->add_handler("raw_packet4/0.1/unregister_vif_receiver",
	    callback(this, &XrlFeaTargetBase::handle_raw_packet4_0_1_unregister_vif_receiver)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "raw_packet4/0.1/unregister_vif_receiver");
	}
	if (_cmds->add_handler("raw_packet6/0.1/send_raw",
	    callback(this, &XrlFeaTargetBase::handle_raw_packet6_0_1_send_raw)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "raw_packet6/0.1/send_raw");
	}
	if (_cmds->add_handler("raw_packet6/0.1/register_vif_receiver",
	    callback(this, &XrlFeaTargetBase::handle_raw_packet6_0_1_register_vif_receiver)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "raw_packet6/0.1/register_vif_receiver");
	}
	if (_cmds->add_handler("raw_packet6/0.1/unregister_vif_receiver",
	    callback(this, &XrlFeaTargetBase::handle_raw_packet6_0_1_unregister_vif_receiver)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "raw_packet6/0.1/unregister_vif_receiver");
	}
...
XrlFeaTargetBase::remove_handlers()
{
	...
	_cmds->remove_handler("fea_click/0.1/set_click_config_generator_file");
	...
	_cmds->remove_handler("ifmgr/0.1/get_system_interface_discard");
	...
	_cmds->remove_handler("raw_packet4/0.1/send_raw");
	_cmds->remove_handler("raw_packet4/0.1/register_vif_receiver");
	_cmds->remove_handler("raw_packet4/0.1/unregister_vif_receiver");
	_cmds->remove_handler("raw_packet6/0.1/send_raw");
	_cmds->remove_handler("raw_packet6/0.1/register_vif_receiver");
	_cmds->remove_handler("raw_packet6/0.1/unregister_vif_receiver");
