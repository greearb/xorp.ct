...
#ident "$XORP: xorp/xrl/targets/fea_base.cc,v 1.57 2005/10/16 07:10:39 pavlin Exp $"
...
const XrlCmdError
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_no_carrier(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_no_carrier");
	return XrlCmdError::BAD_ARGS();
    }
    ...
    bool no_carrier;
    try {
	XrlCmdError e = ifmgr_0_1_get_system_no_carrier(
	    xa_inputs.get_string("ifname"),
	    no_carrier);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "ifmgr/0.1/get_system_no_carrier", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
XrlFeaTargetBase::handle_raw_packet4_0_1_send(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 9) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(9), XORP_UINT_CAST(xa_inputs.size()), "raw_packet4/0.1/send");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_raw_packet6_0_1_send(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 9) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(9), XORP_UINT_CAST(xa_inputs.size()), "raw_packet6/0.1/send");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("ifmgr/0.1/get_system_no_carrier",
	    callback(this, &XrlFeaTargetBase::handle_ifmgr_0_1_get_system_no_carrier)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "ifmgr/0.1/get_system_no_carrier");
	}
...
XrlFeaTargetBase::remove_handlers()
{
	...
	_cmds->remove_handler("ifmgr/0.1/get_system_no_carrier");
