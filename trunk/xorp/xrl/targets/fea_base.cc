...
#ident "$XORP: xorp/xrl/targets/fea_base.cc,v 1.71 2007/07/12 21:46:11 pavlin Exp $"
...
XrlFeaTargetBase::handle_ifmgr_0_1_configure_all_interfaces_from_system(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/configure_all_interfaces_from_system");
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlFeaTargetBase::handle_socket4_0_1_send_with_flags(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
...
const XrlCmdError
XrlFeaTargetBase::handle_socket4_0_1_send_to_with_flags(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
...
const XrlCmdError
XrlFeaTargetBase::handle_socket6_0_1_send_with_flags(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
...
const XrlCmdError
XrlFeaTargetBase::handle_socket6_0_1_send_to_with_flags(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
...
XrlFeaTargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("socket4/0.1/send_with_flags",
	    callback(this, &XrlFeaTargetBase::handle_socket4_0_1_send_with_flags)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "socket4/0.1/send_with_flags");
	}
	...
	if (_cmds->add_handler("socket4/0.1/send_to_with_flags",
	    callback(this, &XrlFeaTargetBase::handle_socket4_0_1_send_to_with_flags)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "socket4/0.1/send_to_with_flags");
	}
	...
	if (_cmds->add_handler("socket6/0.1/send_with_flags",
	    callback(this, &XrlFeaTargetBase::handle_socket6_0_1_send_with_flags)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "socket6/0.1/send_with_flags");
	}
	...
	if (_cmds->add_handler("socket6/0.1/send_to_with_flags",
	    callback(this, &XrlFeaTargetBase::handle_socket6_0_1_send_to_with_flags)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "socket6/0.1/send_to_with_flags");
	}
