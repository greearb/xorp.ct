...
#ident "$XORP: xorp/xrl/targets/fea_base.cc,v 1.1.1.1 2002/12/11 23:56:18 hodson Exp $"
...
XrlFeaTargetBase::handle_ifmgr_0_1_set_address_enabled4(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 5) handling ifmgr/0.1/set_address_enabled4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling ifmgr/0.1/get_address_enabled4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 5) { 
	XLOG_ERROR("Wrong number of arguments (%d != 5) handling ifmgr/0.1/set_address_enabled6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling ifmgr/0.1/get_address_enabled6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
