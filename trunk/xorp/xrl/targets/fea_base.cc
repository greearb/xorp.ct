...
#ident "$XORP: xorp/xrl/targets/fea_base.cc,v 1.49 2004/12/14 18:37:11 atanu Exp $"
...
XrlFeaTargetBase::handle_fea_click_0_1_set_click_config_generator_file(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "fea_click/0.1/set_click_config_generator_file");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_register_client(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/register_client");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_unregister_client(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/unregister_client");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_interface_names(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(0), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_interface_names");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_names(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_names");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_flags(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_flags");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_pif_index(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_pif_index");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_addresses4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_addresses4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_address_flags4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_address_flags4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_addresses6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_addresses6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_address_flags6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_address_flags6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_interface_enabled(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_interface_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_interface_discard(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_interface_discard");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_mac(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_mac");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_mtu(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_mtu");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_vif_enabled(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_vif_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_prefix4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_prefix4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_broadcast4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_broadcast4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_endpoint4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_endpoint4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_prefix6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_prefix6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_endpoint6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_endpoint6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_address_enabled4(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_address_enabled4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_get_system_address_enabled6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/get_system_address_enabled6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_register_system_interfaces_client(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/register_system_interfaces_client");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_ifmgr_0_1_unregister_system_interfaces_client(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ifmgr/0.1/unregister_system_interfaces_client");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_raw_packet4_0_1_send(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 8) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(8), XORP_UINT_CAST(xa_inputs.size()), "raw_packet4/0.1/send");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_raw_packet4_0_1_send_raw(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "raw_packet4/0.1/send_raw");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_raw_packet4_0_1_register_vif_receiver(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "raw_packet4/0.1/register_vif_receiver");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_raw_packet4_0_1_unregister_vif_receiver(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "raw_packet4/0.1/unregister_vif_receiver");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_raw_packet6_0_1_send_raw(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 8) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(8), XORP_UINT_CAST(xa_inputs.size()), "raw_packet6/0.1/send_raw");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_raw_packet6_0_1_register_vif_receiver(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "raw_packet6/0.1/register_vif_receiver");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlFeaTargetBase::handle_raw_packet6_0_1_unregister_vif_receiver(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "raw_packet6/0.1/unregister_vif_receiver");
	return XrlCmdError::BAD_ARGS();
    }
