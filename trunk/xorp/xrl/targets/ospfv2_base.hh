 ...
 *
 * $XORP: xorp/xrl/targets/ospfv2_base.hh,v 1.42 2009/01/05 18:31:15 jtc Exp $
 */
...
private:
    ...
    const XrlCmdError handle_ospfv2_0_1_set_rfc1583_compatibility(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_ospfv2_0_1_originate_default_route(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_ospfv2_0_1_stub_default_cost(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_ospfv2_0_1_summaries(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_ospfv2_0_1_clear_database(const XrlArgs& in, XrlArgs* out);
    ...
    struct handler_table {
        const char *name;
        const XrlCmdError (XrlOspfv2TargetBase::*method)(const XrlArgs&, XrlArgs*);
    };
