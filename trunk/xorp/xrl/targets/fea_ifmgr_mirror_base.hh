 ...
 *
 * $XORP: xorp/xrl/targets/fea_ifmgr_mirror_base.hh,v 1.31 2009/01/05 18:31:15 jtc Exp $
 */
...
private:
    ...
    const XrlCmdError handle_fea_ifmgr_mirror_0_1_interface_set_baudrate(const XrlArgs& in, XrlArgs* out);
    ...
    struct handler_table {
        const char *name;
        const XrlCmdError (XrlFeaIfmgrMirrorTargetBase::*method)(const XrlArgs&, XrlArgs*);
    };
