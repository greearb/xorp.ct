...
protected:
    ...
    virtual XrlCmdError fea_ifmgr_mirror_0_1_vif_set_vlan_tag(
	// Input values,
	const string&	ifname,
	const string&	vifname,
	const uint32_t&	vlan_tag) = 0;
...
private:
    ...
    const XrlCmdError handle_fea_ifmgr_mirror_0_1_vif_set_vlan_tag(const XrlArgs& in, XrlArgs* out);
