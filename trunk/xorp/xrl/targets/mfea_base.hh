 ...
 *
 * $XORP: xorp/xrl/targets/mfea_base.hh,v 1.14 2003/06/01 22:34:02 hodson Exp $
 */
...
private:
    ...
    const XrlCmdError handle_mfea_0_1_disable_vif(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_mfea_0_1_disable_all_vifs(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_mfea_0_1_disable_mfea(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_mfea_0_1_enable_cli(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_mfea_0_1_disable_cli(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_mfea_0_1_enable_log_trace(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_mfea_0_1_disable_log_trace(const XrlArgs& in, XrlArgs* out);
