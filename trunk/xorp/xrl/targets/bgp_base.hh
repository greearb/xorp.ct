 ...
 *
 * $XORP: xorp/xrl/targets/bgp_base.hh,v 1.2 2002/12/14 23:43:14 hodson Exp $
 */
...
protected:
     ...
     *  remaining.
     */
    virtual XrlCmdError bgp_0_2_get_peer_list(
	// Output values, 
	uint32_t&	token, 
	IPv4&	local_ip, 
	uint32_t&	local_port, 
	...
	uint32_t&	min_as_orginiation_interval) = 0;
...
private:
    ...
    const XrlCmdError handle_bgp_0_2_get_peer_list(const Xrl& x, XrlArgs* a);
	...
	if (_router->add_handler("bgp/0.2/get_peer_list", 
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_get_peer_list)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://bgp/bgp/0.2/get_peer_list");
	}
	...
	_router->remove_handler("bgp/0.2/get_peer_list");
