 ...
 *
 * $XORP: xorp/xrl/targets/bgp_base.hh,v 1.61 2007/05/23 12:12:53 pavlin Exp $
 */
...
protected:
     ...
     */
    virtual XrlCmdError bgp_0_2_set_confederation_identifier(
	// Input values,
	const uint32_t&	as,
     ...
     */
    virtual XrlCmdError bgp_0_2_set_cluster_id(
	// Input values,
     ...
     */
    virtual XrlCmdError bgp_0_2_set_damping(
	// Input values,
     ...
     */
    virtual XrlCmdError bgp_0_2_change_local_ip(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     */
    virtual XrlCmdError bgp_0_2_change_local_port(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     *  @param peer_port peer port.
     */
    virtual XrlCmdError bgp_0_2_change_peer_port(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     */
    virtual XrlCmdError bgp_0_2_set_peer_as(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
	const uint32_t&	peer_port,
	const uint32_t&	peer_as) = 0;
     ...
     *  peering is considered down.
     */
    virtual XrlCmdError bgp_0_2_set_holdtime(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     */
    virtual XrlCmdError bgp_0_2_set_delay_open_time(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     */
    virtual XrlCmdError bgp_0_2_set_route_reflector_client(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     */
    virtual XrlCmdError bgp_0_2_set_confederation_member(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     */
    virtual XrlCmdError bgp_0_2_set_prefix_limit(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     */
    virtual XrlCmdError bgp_0_2_set_nexthop4(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     */
    virtual XrlCmdError bgp_0_2_set_nexthop6(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     *  @param next_hop IPv6 nexthop
     */
    virtual XrlCmdError bgp_0_2_get_nexthop6(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
     ...
     */
    virtual XrlCmdError bgp_0_2_trace(
	// Input values,
	const string&	tvar,
	const bool&	enable) = 0;
...
private:
    ...
    const XrlCmdError handle_bgp_0_2_set_confederation_identifier(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_cluster_id(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_damping(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_bgp_0_2_change_local_ip(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_change_local_port(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_change_peer_port(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_peer_as(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_holdtime(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_delay_open_time(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_route_reflector_client(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_confederation_member(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_prefix_limit(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_nexthop4(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_set_nexthop6(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_2_get_nexthop6(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_bgp_0_2_trace(const XrlArgs& in, XrlArgs* out);
