...
public:
    XrlBgpTargetBase(XrlCmdMap* r) : _router(r) { add_handlers(); }
...
private:
	...
	if (_router->add_handler("bgp/0.2/get_bgp_version", 
	...
	if (_router->add_handler("bgp/0.2/local_config", 
	...
	if (_router->add_handler("bgp/0.2/set_local_as", 
	...
	if (_router->add_handler("bgp/0.2/get_local_as", 
	...
	if (_router->add_handler("bgp/0.2/set_bgpid", 
	...
	if (_router->add_handler("bgp/0.2/get_bgpid", 
	...
	if (_router->add_handler("bgp/0.2/enable_peer", 
	...
	if (_router->add_handler("bgp/0.2/disable_peer", 
	...
	if (_router->add_handler("bgp/0.2/next_hop_rewrite_filter", 
	...
	if (_router->add_handler("bgp/0.2/set_peer_state", 
	...
	if (_router->add_handler("bgp/0.2/get_peer_list_start", 
	...
	if (_router->add_handler("bgp/0.2/get_peer_list_next", 
	...
	if (_router->add_handler("bgp/0.2/get_peer_id", 
	...
	if (_router->add_handler("bgp/0.2/get_peer_status", 
	...
	if (_router->add_handler("bgp/0.2/get_peer_negotiated_version", 
	...
	if (_router->add_handler("bgp/0.2/get_peer_as", 
	...
	if (_router->add_handler("bgp/0.2/get_peer_msg_stats", 
	...
	if (_router->add_handler("bgp/0.2/get_peer_established_stats", 
	...
	if (_router->add_handler("bgp/0.2/get_peer_timer_config", 
	...
	if (_router->add_handler("bgp/0.2/register_rib", 
	...
	if (_router->add_handler("bgp/0.2/add_route", 
	...
	if (_router->add_handler("bgp/0.2/delete_route", 
	...
	if (_router->add_handler("bgp/0.2/get_v4_route_list_start", 
	...
	if (_router->add_handler("bgp/0.2/get_v6_route_list_start", 
	...
	if (_router->add_handler("bgp/0.2/get_v4_route_list_next", 
	...
	if (_router->add_handler("bgp/0.2/get_v6_route_list_next", 
	...
	if (_router->add_handler("bgp/0.2/terminate", 
	...
	if (_router->add_handler("bgp/0.2/set_parameter", 
	...
	if (_router->add_handler("rib_client/0.1/route_info_changed4", 
	...
	if (_router->add_handler("rib_client/0.1/route_info_changed6", 
	...
	if (_router->add_handler("rib_client/0.1/route_info_invalid4", 
	...
	if (_router->add_handler("rib_client/0.1/route_info_invalid6", 
	...
	_router->remove_handler("bgp/0.2/get_bgp_version");
	_router->remove_handler("bgp/0.2/local_config");
	_router->remove_handler("bgp/0.2/set_local_as");
	_router->remove_handler("bgp/0.2/get_local_as");
	_router->remove_handler("bgp/0.2/set_bgpid");
	_router->remove_handler("bgp/0.2/get_bgpid");
	_router->remove_handler("bgp/0.2/add_peer");
	_router->remove_handler("bgp/0.2/delete_peer");
	_router->remove_handler("bgp/0.2/enable_peer");
	_router->remove_handler("bgp/0.2/disable_peer");
	_router->remove_handler("bgp/0.2/next_hop_rewrite_filter");
	_router->remove_handler("bgp/0.2/set_peer_state");
	_router->remove_handler("bgp/0.2/get_peer_list_start");
	_router->remove_handler("bgp/0.2/get_peer_list_next");
	_router->remove_handler("bgp/0.2/get_peer_id");
	_router->remove_handler("bgp/0.2/get_peer_status");
	_router->remove_handler("bgp/0.2/get_peer_negotiated_version");
	_router->remove_handler("bgp/0.2/get_peer_as");
	_router->remove_handler("bgp/0.2/get_peer_msg_stats");
	_router->remove_handler("bgp/0.2/get_peer_established_stats");
	_router->remove_handler("bgp/0.2/get_peer_timer_config");
	_router->remove_handler("bgp/0.2/register_rib");
	_router->remove_handler("bgp/0.2/add_route");
	_router->remove_handler("bgp/0.2/delete_route");
	_router->remove_handler("bgp/0.2/get_v4_route_list_start");
	_router->remove_handler("bgp/0.2/get_v6_route_list_start");
	_router->remove_handler("bgp/0.2/get_v4_route_list_next");
	_router->remove_handler("bgp/0.2/get_v6_route_list_next");
	_router->remove_handler("bgp/0.2/terminate");
	_router->remove_handler("bgp/0.2/set_parameter");
	_router->remove_handler("rib_client/0.1/route_info_changed4");
	_router->remove_handler("rib_client/0.1/route_info_changed6");
	_router->remove_handler("rib_client/0.1/route_info_invalid4");
	_router->remove_handler("rib_client/0.1/route_info_invalid6");
    }
};
