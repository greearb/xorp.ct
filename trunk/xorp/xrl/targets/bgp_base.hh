 ...
 *
 * $XORP: xorp/xrl/targets/bgp_base.hh,v 1.69 2009/01/05 18:31:15 jtc Exp $
 */
...
private:
    ...
    const XrlCmdError handle_bgp_0_3_get_bgp_version(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_local_config(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_local_as(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_4byte_as_support(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_local_as(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_bgp_id(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_bgp_id(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_confederation_identifier(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_cluster_id(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_damping(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_add_peer(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_delete_peer(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_enable_peer(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_disable_peer(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_change_local_ip(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_change_local_port(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_change_peer_port(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_peer_as(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_holdtime(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_delay_open_time(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_route_reflector_client(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_confederation_member(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_prefix_limit(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_nexthop4(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_nexthop6(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_nexthop6(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_peer_state(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_peer_md5_password(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_activate(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_set_parameter(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_next_hop_rewrite_filter(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_originate_route4(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_originate_route6(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_withdraw_route4(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_withdraw_route6(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_trace(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_peer_list_start(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_peer_list_next(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_peer_id(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_peer_status(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_peer_negotiated_version(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_peer_as(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_peer_msg_stats(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_peer_established_stats(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_peer_timer_config(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_register_rib(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_v4_route_list_start(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_v6_route_list_start(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_v4_route_list_next(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_bgp_0_3_get_v6_route_list_next(const XrlArgs& in, XrlArgs* out);
    ...
    struct handler_table {
        const char *name;
        const XrlCmdError (XrlBgpTargetBase::*method)(const XrlArgs&, XrlArgs*);
    };
