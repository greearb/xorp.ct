 ...
 *
 * $XORP: xorp/xrl/targets/bgp_base.hh,v 1.47 2005/10/25 18:11:27 atanu Exp $
 */
...
protected:
     ...
     */
    virtual XrlCmdError bgp_0_2_change_peer_ip(
	// Input values,
	const string&	local_ip,
	const uint32_t&	local_port,
	const string&	peer_ip,
	const uint32_t&	peer_port,
	const string&	new_peer_ip) = 0;
...
private:
    ...
    const XrlCmdError handle_bgp_0_2_change_peer_ip(const XrlArgs& in, XrlArgs* out);
