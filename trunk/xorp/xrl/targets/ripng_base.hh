 ...
 *
 * $XORP: xorp/xrl/targets/ripng_base.hh,v 1.42 2009/01/05 18:31:15 jtc Exp $
 */
...
private:
    ...
    const XrlCmdError handle_ripng_0_1_trace(const XrlArgs& in, XrlArgs* out);
    ...
    struct handler_table {
        const char *name;
        const XrlCmdError (XrlRipngTargetBase::*method)(const XrlArgs&, XrlArgs*);
    };
