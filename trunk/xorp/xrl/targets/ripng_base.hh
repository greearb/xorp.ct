 ...
 *
 * $XORP: xorp/xrl/targets/ripng_base.hh,v 1.10 2004/05/03 23:17:27 hodson Exp $
 */
...
protected:
     ...
     */
    virtual XrlCmdError ripng_0_1_import_protocol_routes(
	// Input values,
     ...
     */
    virtual XrlCmdError ripng_0_1_no_import_protocol_routes(
	// Input values,
...
private:
    ...
    const XrlCmdError handle_ripng_0_1_import_protocol_routes(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_ripng_0_1_no_import_protocol_routes(const XrlArgs& in, XrlArgs* out);
	...
	if (_cmds->add_handler("redist6/0.1/add_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ripng/redist6/0.1/add_route");
	}
	if (_cmds->add_handler("redist6/0.1/delete_route",
	    callback(this, &XrlRipngTargetBase::handle_redist6_0_1_delete_route)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://ripng/redist6/0.1/delete_route");
	}
	...
	if (_cmds->add_handler("ripng/0.1/get_counters",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ripng/ripng/0.1/get_counters");
	}
	...
	if (_cmds->add_handler("ripng/0.1/get_peer_counters",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ripng/ripng/0.1/get_peer_counters");
	}
	if (_cmds->add_handler("ripng/0.1/import_protocol_routes",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ripng/ripng/0.1/import_protocol_routes");
	}
	if (_cmds->add_handler("ripng/0.1/no_import_protocol_routes",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ripng/ripng/0.1/no_import_protocol_routes");
	}
	if (_cmds->add_handler("socket6_user/0.1/recv_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ripng/socket6_user/0.1/recv_event");
	}
	if (_cmds->add_handler("socket6_user/0.1/connect_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ripng/socket6_user/0.1/connect_event");
	}
	if (_cmds->add_handler("socket6_user/0.1/error_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ripng/socket6_user/0.1/error_event");
	}
	if (_cmds->add_handler("socket6_user/0.1/close_event",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://ripng/socket6_user/0.1/close_event");
	}
	_cmds->finalize();
    }
