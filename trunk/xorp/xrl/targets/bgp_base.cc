...
#ident "$XORP: xorp/xrl/targets/bgp_base.cc,v 1.26 2004/05/11 00:44:37 atanu Exp $"
...
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling bgp/0.2/activate",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = bgp_0_2_activate(
	    ...
	    xa_inputs.get_uint32("peer_port"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for bgp/0.2/activate failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling bgp/0.2/originate_route4",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for bgp/0.2/originate_route4 failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling bgp/0.2/originate_route6",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = bgp_0_2_originate_route6(
	    ...
	    xa_inputs.get_bool("multicast"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for bgp/0.2/originate_route6 failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling bgp/0.2/withdraw_route4",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = bgp_0_2_withdraw_route4(
	    ...
	    xa_inputs.get_bool("multicast"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for bgp/0.2/withdraw_route4 failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling bgp/0.2/withdraw_route6",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = bgp_0_2_withdraw_route6(
	    ...
	    xa_inputs.get_bool("multicast"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for bgp/0.2/withdraw_route6 failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling bgp/0.2/get_v4_route_list_start",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling bgp/0.2/get_v6_route_list_start",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
