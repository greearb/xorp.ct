...
#ident "$XORP: xorp/xrl/targets/bgp_base.cc,v 1.1.1.1 2002/12/11 23:56:18 hodson Exp $"
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling bgp/0.2/get_bgp_version", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling bgp/0.2/get_local_as", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling bgp/0.2/get_bgpid", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_get_peer_list(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling bgp/0.2/get_peer_list", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
    ...
    bool more; 
    try {
	XrlCmdError e = bgp_0_2_get_peer_list(
	    token, 
	    local_ip, 
	    local_port, 
	    peer_ip, 
	    ...
	    more);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for bgp/0.2/get_peer_list failed: %s \"%s\"",
            		 e.str().c_str(), e.note().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling bgp/0.2/get_peer_list_next", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling bgp/0.2/get_peer_id", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling bgp/0.2/get_peer_status", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling bgp/0.2/get_peer_negotiated_version", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling bgp/0.2/get_peer_as", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling bgp/0.2/get_peer_msg_stats", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling bgp/0.2/get_peer_established_stats", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling bgp/0.2/get_peer_timer_config", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
