...
#ident "$XORP: xorp/xrl/targets/bgp_base.cc,v 1.3 2003/01/17 04:07:25 mjh Exp $"
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling bgp/0.2/get_peer_list_start", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
