...
#ident "$XORP: xorp/xrl/targets/bgp_base.cc,v 1.16 2003/06/01 22:34:00 hodson Exp $"
...
XrlBgpTargetBase::handle_bgp_0_2_set_bgpid(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XrlCmdError e = bgp_0_2_set_bgpid(
	    xrl.const_args().get_ipv4("id"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for bgp/0.2/set_bgpid failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
XrlBgpTargetBase::handle_bgp_0_2_get_bgpid(const Xrl& xrl, XrlArgs* args)
{
	...
	XrlCmdError e = bgp_0_2_get_bgpid(
	    id);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for bgp/0.2/get_bgpid failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
const XrlCmdError
XrlBgpTargetBase::handle_finder_event_observer_0_1_xrl_target_birth(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 2) {
...
const XrlCmdError
XrlBgpTargetBase::handle_finder_event_observer_0_1_xrl_target_death(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 2) {
