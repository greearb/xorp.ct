...
#ident "$XORP: xorp/xrl/targets/bgp_base.cc,v 1.53 2007/05/31 19:13:38 pavlin Exp $"
...
XrlBgpTargetBase::handle_bgp_0_2_get_bgp_version(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(0), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_bgp_version");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_local_config(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/local_config");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_set_local_as(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_local_as");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_local_as(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(0), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_local_as");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_set_bgp_id(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_bgp_id");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_bgp_id(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(0), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_bgp_id");
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_confederation_identifier(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_confederation_identifier");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_confederation_identifier(
	    xa_inputs.get_uint32("as"),
	    xa_inputs.get_bool("disable"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_confederation_identifier", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_cluster_id(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_cluster_id");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_cluster_id(
	    xa_inputs.get_ipv4("cluster_id"),
	    xa_inputs.get_bool("disable"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_cluster_id", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_damping(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_damping");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_damping(
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_damping", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
XrlBgpTargetBase::handle_bgp_0_2_add_peer(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(7), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/add_peer");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_delete_peer(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/delete_peer");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_enable_peer(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/enable_peer");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_disable_peer(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/disable_peer");
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_change_local_ip(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/change_local_ip");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_change_local_ip(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/change_local_ip", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_change_local_port(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/change_local_port");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_change_local_port(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/change_local_port", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_change_peer_port(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/change_peer_port");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_change_peer_port(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/change_peer_port", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_peer_as(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_peer_as");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_peer_as(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	    xa_inputs.get_uint32("peer_as"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_peer_as", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_holdtime(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_holdtime");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_holdtime(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_holdtime", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_delay_open_time(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_delay_open_time");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_delay_open_time(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_delay_open_time", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_route_reflector_client(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_route_reflector_client");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_route_reflector_client(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_route_reflector_client", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_confederation_member(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_confederation_member");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_confederation_member(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_confederation_member", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_prefix_limit(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 6) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(6), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_prefix_limit");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_prefix_limit(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_prefix_limit", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_nexthop4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_nexthop4");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_nexthop4(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_nexthop4", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_set_nexthop6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_nexthop6");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_set_nexthop6(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/set_nexthop6", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_get_nexthop6(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_nexthop6");
	return XrlCmdError::BAD_ARGS();
    }
    ...
    IPv6 next_hop;
    try {
	XrlCmdError e = bgp_0_2_get_nexthop6(
	    xa_inputs.get_string("local_ip"),
	    xa_inputs.get_uint32("local_port"),
	    xa_inputs.get_string("peer_ip"),
	    xa_inputs.get_uint32("peer_port"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/get_nexthop6", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
XrlBgpTargetBase::handle_bgp_0_2_set_peer_state(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_peer_state");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_set_peer_md5_password(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_peer_md5_password");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_activate(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/activate");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_set_parameter(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 6) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(6), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/set_parameter");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_next_hop_rewrite_filter(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/next_hop_rewrite_filter");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_originate_route4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/originate_route4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_originate_route6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/originate_route6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_withdraw_route4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/withdraw_route4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_withdraw_route6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/withdraw_route6");
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlBgpTargetBase::handle_bgp_0_2_trace(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(2), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/trace");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = bgp_0_2_trace(
	    xa_inputs.get_string("tvar"),
	    xa_inputs.get_bool("enable"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "bgp/0.2/trace", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::BadArgs& e) {
	XLOG_ERROR("Error decoding the arguments: %s", e.str().c_str());
...
XrlBgpTargetBase::handle_bgp_0_2_get_peer_list_start(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(0), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_peer_list_start");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_peer_list_next(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_peer_list_next");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_peer_id(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_peer_id");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_peer_status(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_peer_status");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_peer_negotiated_version(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_peer_negotiated_version");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_peer_as(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_peer_as");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_peer_msg_stats(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_peer_msg_stats");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_peer_established_stats(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_peer_established_stats");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_peer_timer_config(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_peer_timer_config");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_register_rib(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/register_rib");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_v4_route_list_start(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_v4_route_list_start");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_v6_route_list_start(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_v6_route_list_start");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_v4_route_list_next(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_v4_route_list_next");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::handle_bgp_0_2_get_v6_route_list_next(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "bgp/0.2/get_v6_route_list_next");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlBgpTargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("bgp/0.2/set_confederation_identifier",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_confederation_identifier)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_confederation_identifier");
	}
	if (_cmds->add_handler("bgp/0.2/set_cluster_id",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_cluster_id)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_cluster_id");
	}
	if (_cmds->add_handler("bgp/0.2/set_damping",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_damping)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_damping");
	}
	...
	if (_cmds->add_handler("bgp/0.2/change_local_ip",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_change_local_ip)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/change_local_ip");
	}
	if (_cmds->add_handler("bgp/0.2/change_local_port",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_change_local_port)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/change_local_port");
	}
	if (_cmds->add_handler("bgp/0.2/change_peer_port",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_change_peer_port)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/change_peer_port");
	}
	if (_cmds->add_handler("bgp/0.2/set_peer_as",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_peer_as)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_peer_as");
	}
	if (_cmds->add_handler("bgp/0.2/set_holdtime",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_holdtime)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_holdtime");
	}
	if (_cmds->add_handler("bgp/0.2/set_delay_open_time",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_delay_open_time)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_delay_open_time");
	}
	if (_cmds->add_handler("bgp/0.2/set_route_reflector_client",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_route_reflector_client)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_route_reflector_client");
	}
	if (_cmds->add_handler("bgp/0.2/set_confederation_member",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_confederation_member)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_confederation_member");
	}
	if (_cmds->add_handler("bgp/0.2/set_prefix_limit",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_prefix_limit)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_prefix_limit");
	}
	if (_cmds->add_handler("bgp/0.2/set_nexthop4",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_nexthop4)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_nexthop4");
	}
	if (_cmds->add_handler("bgp/0.2/set_nexthop6",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_set_nexthop6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/set_nexthop6");
	}
	if (_cmds->add_handler("bgp/0.2/get_nexthop6",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_get_nexthop6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/get_nexthop6");
	}
	...
	if (_cmds->add_handler("bgp/0.2/trace",
	    callback(this, &XrlBgpTargetBase::handle_bgp_0_2_trace)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "bgp", "bgp/0.2/trace");
	}
...
XrlBgpTargetBase::remove_handlers()
{
	...
	_cmds->remove_handler("bgp/0.2/set_confederation_identifier");
	_cmds->remove_handler("bgp/0.2/set_cluster_id");
	_cmds->remove_handler("bgp/0.2/set_damping");
	...
	_cmds->remove_handler("bgp/0.2/change_local_ip");
	_cmds->remove_handler("bgp/0.2/change_local_port");
	_cmds->remove_handler("bgp/0.2/change_peer_port");
	_cmds->remove_handler("bgp/0.2/set_peer_as");
	_cmds->remove_handler("bgp/0.2/set_holdtime");
	_cmds->remove_handler("bgp/0.2/set_delay_open_time");
	_cmds->remove_handler("bgp/0.2/set_route_reflector_client");
	_cmds->remove_handler("bgp/0.2/set_confederation_member");
	_cmds->remove_handler("bgp/0.2/set_prefix_limit");
	_cmds->remove_handler("bgp/0.2/set_nexthop4");
	_cmds->remove_handler("bgp/0.2/set_nexthop6");
	_cmds->remove_handler("bgp/0.2/get_nexthop6");
	...
	_cmds->remove_handler("bgp/0.2/trace");
