...
#ident "$XORP: xorp/xrl/targets/xorp_if_mib_base.cc,v 1.8 2004/06/10 22:42:18 hodson Exp $"
...
XrlXorpIfMibTargetBase::handle_xorp_if_mib_0_1_load_mib(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "xorp_if_mib/0.1/load_mib");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlXorpIfMibTargetBase::handle_xorp_if_mib_0_1_unload_mib(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "xorp_if_mib/0.1/unload_mib");
	return XrlCmdError::BAD_ARGS();
    }
