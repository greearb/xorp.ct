...
#ident "$XORP: xorp/xrl/targets/bgp4_mib_base.cc,v 1.24 2009/01/05 18:31:15 jtc Exp $"


#include "bgp4_mib_base.hh"


const struct XrlBgp4MibTargetBase::handler_table XrlBgp4MibTargetBase::handlers[] = {
    { "common/0.1/get_target_name",
      &XrlBgp4MibTargetBase::handle_common_0_1_get_target_name },
    { "common/0.1/get_version",
      &XrlBgp4MibTargetBase::handle_common_0_1_get_version },
    { "common/0.1/get_status",
      &XrlBgp4MibTargetBase::handle_common_0_1_get_status },
    { "common/0.1/shutdown",
      &XrlBgp4MibTargetBase::handle_common_0_1_shutdown },
    { "bgp_mib_traps/0.1/send_bgp_established_trap",
      &XrlBgp4MibTargetBase::handle_bgp_mib_traps_0_1_send_bgp_established_trap },
    { "bgp_mib_traps/0.1/send_bgp_backward_transition_trap",
      &XrlBgp4MibTargetBase::handle_bgp_mib_traps_0_1_send_bgp_backward_transition_trap },
};

const size_t XrlBgp4MibTargetBase::num_handlers = (sizeof(XrlBgp4MibTargetBase::handlers) / sizeof(XrlBgp4MibTargetBase::handlers[0]));
...
XrlBgp4MibTargetBase::handle_bgp_mib_traps_0_1_send_bgp_established_trap(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
	...
	XrlCmdError e = bgp_mib_traps_0_1_send_bgp_established_trap(
	    xa_inputs.get(0, "bgp_last_error").text(),
	    xa_inputs.get(1, "bgp_state").uint32());
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
...
XrlBgp4MibTargetBase::add_handlers()
{
    for (size_t i = 0; i < num_handlers; ++i) {
        if (!_cmds->add_handler(handlers[i].name,
            ...
            XLOG_ERROR("Failed to register xrl handler finder://%s/%s", "bgp4_mib", handlers[i].name);
        }
    }
    _cmds->finalize();
}
