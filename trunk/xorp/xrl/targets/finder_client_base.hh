 ...
 *
 * $XORP: xorp/xrl/targets/finder_client_base.hh,v 1.1.1.1 2002/12/11 23:56:19 hodson Exp $
 */
...
public:
    XrlFinderclientTargetBase(XrlCmdMap* r) : _router(r) { add_handlers(); }
...
private:
	...
	if (_router->add_handler("finder_client/0.1/hello", 
	...
	if (_router->add_handler("finder_client/0.1/remove_xrl_from_cache", 
	...
	if (_router->add_handler("finder_client/0.1/remove_xrls_for_target_from_cache", 
	...
	_router->remove_handler("finder_client/0.1/hello");
	_router->remove_handler("finder_client/0.1/remove_xrl_from_cache");
	_router->remove_handler("finder_client/0.1/remove_xrls_for_target_from_cache");
    }
};
