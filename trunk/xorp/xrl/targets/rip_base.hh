 ...
 *
 * $XORP: xorp/xrl/targets/rip_base.hh,v 1.21 2005/10/27 05:05:41 pavlin Exp $
 */
...
protected:
     ...
     */
    virtual XrlCmdError rip_0_1_set_md5_authentication(
	// Input values,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
     ...
     *  Pure-virtual function that needs to be implemented to:
     *
     *  Delete MD5 authentication scheme.
     *
     *  @param ifname the interface name.
     *
     *  @param vifname the vif name.
     ...
     *  @param key_id the key ID (must be an integer in the interval [0, 255]).
     */
    virtual XrlCmdError rip_0_1_delete_md5_authentication(
	// Input values,
	const string&	ifname,
	const string&	vifname,
	const IPv4&	addr,
     ...
     */
    virtual XrlCmdError rip_0_1_redist_protocol_routes(
	// Input values,
     ...
     *  from.
     */
    virtual XrlCmdError rip_0_1_no_redist_protocol_routes(
	// Input values,
...
private:
    ...
    const XrlCmdError handle_rip_0_1_set_md5_authentication(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_rip_0_1_delete_md5_authentication(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_rip_0_1_redist_protocol_routes(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_rip_0_1_no_redist_protocol_routes(const XrlArgs& in, XrlArgs* out);
