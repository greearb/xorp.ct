...
#ident "$XORP: xorp/xrl/targets/ospfv2_base.cc,v 1.20 2006/02/26 09:20:59 atanu Exp $"
...
const XrlCmdError
XrlOspfv2TargetBase::handle_ospfv2_0_1_set_rfc1583compatibility(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(1), XORP_UINT_CAST(xa_inputs.size()), "ospfv2/0.1/set_rfc1583compatibility");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = ospfv2_0_1_set_rfc1583compatibility(
	    xa_inputs.get_bool("compatibility"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "ospfv2/0.1/set_rfc1583compatibility", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
XrlOspfv2TargetBase::handle_ospfv2_0_1_set_md5_authentication_key(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(7), XORP_UINT_CAST(xa_inputs.size()), "ospfv2/0.1/set_md5_authentication_key");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlOspfv2TargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("ospfv2/0.1/set_rfc1583compatibility",
	    callback(this, &XrlOspfv2TargetBase::handle_ospfv2_0_1_set_rfc1583compatibility)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "ospfv2", "ospfv2/0.1/set_rfc1583compatibility");
	}
...
XrlOspfv2TargetBase::remove_handlers()
{
	...
	_cmds->remove_handler("ospfv2/0.1/set_rfc1583compatibility");
