 ...
 *
 * $XORP: xorp/xrl/targets/socket_server_base.hh,v 1.2 2004/02/19 04:33:15 hodson Exp $
 */
...
private:
	...
	if (_cmds->add_handler("common/0.1/get_target_name",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/common/0.1/get_target_name");
	}
	if (_cmds->add_handler("common/0.1/get_version",
	    callback(this, &XrlSocketServerTargetBase::handle_common_0_1_get_version)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/common/0.1/get_version");
	}
	if (_cmds->add_handler("common/0.1/get_status",
	    callback(this, &XrlSocketServerTargetBase::handle_common_0_1_get_status)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/common/0.1/get_status");
	}
	if (_cmds->add_handler("common/0.1/shutdown",
	    callback(this, &XrlSocketServerTargetBase::handle_common_0_1_shutdown)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/common/0.1/shutdown");
	}
	if (_cmds->add_handler("finder_event_observer/0.1/xrl_target_birth",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/finder_event_observer/0.1/xrl_target_birth");
	}
	if (_cmds->add_handler("finder_event_observer/0.1/xrl_target_death",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/finder_event_observer/0.1/xrl_target_death");
	}
	if (_cmds->add_handler("socket4/0.1/tcp_open_and_bind",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/tcp_open_and_bind");
	}
	if (_cmds->add_handler("socket4/0.1/udp_open_and_bind",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/udp_open_and_bind");
	}
	if (_cmds->add_handler("socket4/0.1/udp_open_bind_join",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/udp_open_bind_join");
	}
	if (_cmds->add_handler("socket4/0.1/tcp_open_bind_connect",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/tcp_open_bind_connect");
	}
	if (_cmds->add_handler("socket4/0.1/udp_open_bind_connect",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/udp_open_bind_connect");
	}
	if (_cmds->add_handler("socket4/0.1/udp_join_group",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/udp_join_group");
	}
	...
	if (_cmds->add_handler("socket4/0.1/send_with_flags",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/send_with_flags");
	}
	if (_cmds->add_handler("socket4/0.1/send_to",
	    callback(this, &XrlSocketServerTargetBase::handle_socket4_0_1_send_to)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/send_to");
	}
	if (_cmds->add_handler("socket4/0.1/send_to_with_flags",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/send_to_with_flags");
	}
	if (_cmds->add_handler("socket4/0.1/send_from_multicast_if",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/send_from_multicast_if");
	}
	if (_cmds->add_handler("socket4/0.1/set_socket_option",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/set_socket_option");
	}
	if (_cmds->add_handler("socket4/0.1/get_socket_option",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket4/0.1/get_socket_option");
	}
	if (_cmds->add_handler("socket6/0.1/tcp_open_and_bind",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/tcp_open_and_bind");
	}
	if (_cmds->add_handler("socket6/0.1/udp_open_and_bind",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/udp_open_and_bind");
	}
	if (_cmds->add_handler("socket6/0.1/udp_open_bind_join",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/udp_open_bind_join");
	}
	if (_cmds->add_handler("socket6/0.1/tcp_open_bind_connect",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/tcp_open_bind_connect");
	}
	if (_cmds->add_handler("socket6/0.1/udp_open_bind_connect",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/udp_open_bind_connect");
	}
	if (_cmds->add_handler("socket6/0.1/udp_join_group",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/udp_join_group");
	}
	...
	if (_cmds->add_handler("socket6/0.1/send_with_flags",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/send_with_flags");
	}
	if (_cmds->add_handler("socket6/0.1/send_to",
	    callback(this, &XrlSocketServerTargetBase::handle_socket6_0_1_send_to)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/send_to");
	}
	if (_cmds->add_handler("socket6/0.1/send_to_with_flags",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/send_to_with_flags");
	}
	if (_cmds->add_handler("socket6/0.1/send_from_multicast_if",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/send_from_multicast_if");
	}
	if (_cmds->add_handler("socket6/0.1/set_socket_option",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/set_socket_option");
	}
	if (_cmds->add_handler("socket6/0.1/get_socket_option",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://socket_server/socket6/0.1/get_socket_option");
	}
	_cmds->finalize();
    }
