...
#ident "$XORP: xorp/xrl/targets/cli_base.cc,v 1.1.1.1 2002/12/11 23:56:18 hodson Exp $"
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling cli_manager/0.1/enable_cli", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling cli_manager/0.1/disable_cli", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling cli_manager/0.1/start_cli", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling cli_manager/0.1/stop_cli", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlCliTargetBase::handle_cli_manager_0_1_add_enable_cli_access_from_subnet4(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling cli_manager/0.1/add_enable_cli_access_from_subnet4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling cli_manager/0.1/add_enable_cli_access_from_subnet6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling cli_manager/0.1/delete_enable_cli_access_from_subnet4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling cli_manager/0.1/delete_enable_cli_access_from_subnet6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling cli_manager/0.1/add_disable_cli_access_from_subnet4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling cli_manager/0.1/add_disable_cli_access_from_subnet6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling cli_manager/0.1/delete_disable_cli_access_from_subnet4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling cli_manager/0.1/delete_disable_cli_access_from_subnet6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
