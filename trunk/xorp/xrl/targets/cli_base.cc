...
#ident "$XORP: xorp/xrl/targets/cli_base.cc,v 1.12 2003/12/15 20:12:55 hodson Exp $"
...
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling cli_manager/0.1/enable_cli",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
