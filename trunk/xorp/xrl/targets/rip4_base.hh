 ...
 *
 * $XORP: xorp/xrl/targets/rip4_base.hh,v 1.4 2004/01/09 00:17:05 hodson Exp $
 */
...
protected:
     ...
     *  @ref network to.
     */
    virtual XrlCmdError rip4_0_1_add_static_route(
	// Input values,
     ...
     */
    virtual XrlCmdError rip4_0_1_delete_static_route(
	// Input values,
...
private:
    ...
    const XrlCmdError handle_rip4_0_1_delete_static_route(const XrlArgs& in, XrlArgs* out);
	...
	if (_cmds->add_handler("rip4/0.1/add_static_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://rip4/rip4/0.1/add_static_route");
	}
	if (_cmds->add_handler("rip4/0.1/delete_static_route",
	    callback(this, &XrlRip4TargetBase::handle_rip4_0_1_delete_static_route)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://rip4/rip4/0.1/delete_static_route");
	}
