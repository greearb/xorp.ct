 ...
 *
 * $XORP: xorp/xrl/targets/pim_base.hh,v 1.15 2003/03/25 06:55:12 pavlin Exp $
 */
...
private:
	...
	if (_cmds->add_handler("fti/0.1/start_transaction", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_start_transaction)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/start_transaction");
	}
	if (_cmds->add_handler("fti/0.1/commit_transaction", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_commit_transaction)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/commit_transaction");
	}
	if (_cmds->add_handler("fti/0.1/abort_transaction", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_abort_transaction)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/abort_transaction");
	}
	if (_cmds->add_handler("fti/0.1/add_entry4", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_add_entry4)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/add_entry4");
	}
	if (_cmds->add_handler("fti/0.1/add_entry6", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_add_entry6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/add_entry6");
	}
	if (_cmds->add_handler("fti/0.1/delete_entry4", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_delete_entry4)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/delete_entry4");
	}
	if (_cmds->add_handler("fti/0.1/delete_entry6", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_delete_entry6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/delete_entry6");
	}
	if (_cmds->add_handler("fti/0.1/delete_all_entries", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_delete_all_entries)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/delete_all_entries");
	}
	if (_cmds->add_handler("fti/0.1/delete_all_entries4", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_delete_all_entries4)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/delete_all_entries4");
	}
	if (_cmds->add_handler("fti/0.1/delete_all_entries6", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_delete_all_entries6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/delete_all_entries6");
	}
	if (_cmds->add_handler("fti/0.1/lookup_route4", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_lookup_route4)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/lookup_route4");
	}
	if (_cmds->add_handler("fti/0.1/lookup_route6", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_lookup_route6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/lookup_route6");
	}
	if (_cmds->add_handler("fti/0.1/lookup_entry4", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_lookup_entry4)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/lookup_entry4");
	}
	if (_cmds->add_handler("fti/0.1/lookup_entry6", 
	    callback(this, &XrlPimTargetBase::handle_fti_0_1_lookup_entry6)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://pim/fti/0.1/lookup_entry6");
	}
