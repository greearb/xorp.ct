 ...
 *
 * $XORP: xorp/xrl/targets/pim_base.hh,v 1.36 2004/03/02 00:29:47 pavlin Exp $
 */
...
private:
	...
	if (_cmds->add_handler("redist_transaction4/0.1/start_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction4/0.1/start_transaction");
	}
	if (_cmds->add_handler("redist_transaction4/0.1/commit_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction4/0.1/commit_transaction");
	}
	if (_cmds->add_handler("redist_transaction4/0.1/abort_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction4/0.1/abort_transaction");
	}
	if (_cmds->add_handler("redist_transaction4/0.1/add_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction4/0.1/add_route");
	}
	if (_cmds->add_handler("redist_transaction4/0.1/delete_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction4/0.1/delete_route");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/start_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction6/0.1/start_transaction");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/commit_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction6/0.1/commit_transaction");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/abort_transaction",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction6/0.1/abort_transaction");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/add_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction6/0.1/add_route");
	}
	if (_cmds->add_handler("redist_transaction6/0.1/delete_route",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/redist_transaction6/0.1/delete_route");
	}
