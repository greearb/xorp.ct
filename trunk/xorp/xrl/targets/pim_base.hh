 ...
 *
 * $XORP: xorp/xrl/targets/pim_base.hh,v 1.19 2003/05/13 00:23:57 hodson Exp $
 */
...
protected:
    ...
    virtual XrlCmdError pim_0_1_config_rp_done() = 0;
...
private:
	...
	if (_cmds->add_handler("pim/0.1/add_config_rp4", 
	...
	if (_cmds->add_handler("pim/0.1/add_config_rp6", 
	...
	if (_cmds->add_handler("pim/0.1/delete_config_rp4", 
	...
	if (_cmds->add_handler("pim/0.1/delete_config_rp6", 
	...
	if (_cmds->add_handler("pim/0.1/config_rp_done", 
	...
	_cmds->remove_handler("pim/0.1/add_config_rp4");
	_cmds->remove_handler("pim/0.1/add_config_rp6");
	_cmds->remove_handler("pim/0.1/delete_config_rp4");
	_cmds->remove_handler("pim/0.1/delete_config_rp6");
	_cmds->remove_handler("pim/0.1/config_rp_done");
