 ...
 *
 * $XORP: xorp/xrl/targets/pim_base.hh,v 1.65 2007/06/07 17:23:49 pavlin Exp $
 */
...
protected:
     ...
     */
    virtual XrlCmdError pim_0_1_get_vif_ip_router_alert_option_check(
	// Input values,
	const string&	vif_name,
	// Output values,
	bool&	enabled) = 0;
     ...
     */
    virtual XrlCmdError pim_0_1_set_vif_ip_router_alert_option_check(
	// Input values,
	const string&	vif_name,
	const bool&	enable) = 0;
     ...
     *  @param vif_name the name of the vif to apply to.
     */
    virtual XrlCmdError pim_0_1_reset_vif_ip_router_alert_option_check(
	// Input values,
	const string&	vif_name) = 0;
...
private:
    ...
    const XrlCmdError handle_pim_0_1_add_config_cand_bsr4(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_pim_0_1_add_config_cand_bsr6(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_pim_0_1_add_config_cand_rp4(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_pim_0_1_add_config_cand_rp6(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_pim_0_1_delete_config_cand_rp4(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_pim_0_1_delete_config_cand_rp6(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_pim_0_1_delete_config_all_static_group_prefixes_rp4(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_pim_0_1_delete_config_all_static_group_prefixes_rp6(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_pim_0_1_get_vif_ip_router_alert_option_check(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_pim_0_1_set_vif_ip_router_alert_option_check(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_pim_0_1_reset_vif_ip_router_alert_option_check(const XrlArgs& in, XrlArgs* out);
    ...
    const XrlCmdError handle_pim_0_1_get_vif_propagation_delay(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_pim_0_1_set_vif_propagation_delay(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_pim_0_1_reset_vif_propagation_delay(const XrlArgs& in, XrlArgs* out);
