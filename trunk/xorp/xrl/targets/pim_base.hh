 ...
 *
 * $XORP: xorp/xrl/targets/pim_base.hh,v 1.35 2004/01/05 20:40:49 pavlin Exp $
 */
...
private:
	...
	if (_cmds->add_handler("pim/0.1/add_alternative_subnet4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/pim/0.1/add_alternative_subnet4");
	}
	if (_cmds->add_handler("pim/0.1/add_alternative_subnet6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/pim/0.1/add_alternative_subnet6");
	}
	if (_cmds->add_handler("pim/0.1/delete_alternative_subnet4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/pim/0.1/delete_alternative_subnet4");
	}
	if (_cmds->add_handler("pim/0.1/delete_alternative_subnet6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/pim/0.1/delete_alternative_subnet6");
	}
	if (_cmds->add_handler("pim/0.1/remove_all_alternative_subnets",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://pim/pim/0.1/remove_all_alternative_subnets");
	}
