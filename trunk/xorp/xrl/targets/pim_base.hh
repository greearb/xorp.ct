 ...
 *
 * $XORP: xorp/xrl/targets/pim_base.hh,v 1.21 2003/05/31 06:42:31 pavlin Exp $
 */
...
private:
    ...
    const XrlCmdError handle_pim_0_1_add_config_scope_zone_by_vif_name4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_add_config_scope_zone_by_vif_name6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_add_config_scope_zone_by_vif_addr4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_add_config_scope_zone_by_vif_addr6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_delete_config_scope_zone_by_vif_name4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_delete_config_scope_zone_by_vif_name6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_delete_config_scope_zone_by_vif_addr4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_delete_config_scope_zone_by_vif_addr6(const Xrl& x, XrlArgs* a);
    ...
    const XrlCmdError handle_pim_0_1_add_config_static_rp4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_add_config_static_rp6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_delete_config_static_rp4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_delete_config_static_rp6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_config_static_rp_done(const Xrl& x, XrlArgs* a);
    ...
    const XrlCmdError handle_pim_0_1_get_switch_to_spt_threshold(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_set_switch_to_spt_threshold(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_reset_switch_to_spt_threshold(const Xrl& x, XrlArgs* a);
    ...
    const XrlCmdError handle_pim_0_1_add_test_bsr_zone4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_add_test_bsr_zone6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_add_test_bsr_group_prefix4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_add_test_bsr_group_prefix6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_add_test_bsr_rp4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_add_test_bsr_rp6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_send_test_bootstrap(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_send_test_bootstrap_by_dest4(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_send_test_bootstrap_by_dest6(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_pim_0_1_send_test_cand_rp_adv(const Xrl& x, XrlArgs* a);
