 ...
 *
 * $XORP: xorp/xrl/targets/finder_base.hh,v 1.3 2003/01/28 00:37:56 hodson Exp $
 */
...
protected:
    ...
    virtual XrlCmdError finder_0_1_unregister_finder_client() = 0;
...
private:
	...
	if (_cmds->add_handler("finder/0.1/get_all_xrls", 
	...
	_cmds->remove_handler("finder/0.1/get_all_xrls");
    }
};
