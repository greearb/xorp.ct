 ...
 *
 * $XORP: xorp/xrl/targets/finder_base.hh,v 1.10 2003/03/10 23:01:33 hodson Exp $
 */
...
protected:
     ...
     *  queries about the client. Fails if target_name is already registered.
     *  The target_name must support the finder_client interface in order to be
     ...
     */
    virtual XrlCmdError finder_0_1_set_finder_client_enabled(
	// Input values, 
	const string&	target_name, 
     ...
     */
    virtual XrlCmdError finder_0_1_finder_client_enabled(
	// Input values, 
	const string&	target_name, 
	// Output values, 
	bool&	enabled) = 0;
     ...
     */
    virtual XrlCmdError finder_0_1_get_ipv4_permitted_hosts(
	// Output values, 
	XrlAtomList&	ipv4s) = 0;
     ...
     */
    virtual XrlCmdError finder_0_1_get_ipv4_permitted_nets(
	// Output values, 
     ...
     */
    virtual XrlCmdError finder_0_1_get_ipv6_permitted_hosts(
	// Output values, 
	XrlAtomList&	ipv6s) = 0;
     ...
     */
    virtual XrlCmdError finder_0_1_get_ipv6_permitted_nets(
	// Output values, 
...
private:
    ...
    const XrlCmdError handle_finder_0_1_set_finder_client_enabled(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_finder_0_1_finder_client_enabled(const Xrl& x, XrlArgs* a);
    ...
    const XrlCmdError handle_finder_0_1_get_ipv4_permitted_hosts(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_finder_0_1_get_ipv4_permitted_nets(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_finder_0_1_get_ipv6_permitted_hosts(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_finder_0_1_get_ipv6_permitted_nets(const Xrl& x, XrlArgs* a);
	...
	if (_cmds->add_handler("finder/0.1/set_finder_client_enabled", 
	    callback(this, &XrlFinderTargetBase::handle_finder_0_1_set_finder_client_enabled)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://finder/finder/0.1/set_finder_client_enabled");
	}
	if (_cmds->add_handler("finder/0.1/finder_client_enabled", 
	    callback(this, &XrlFinderTargetBase::handle_finder_0_1_finder_client_enabled)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://finder/finder/0.1/finder_client_enabled");
	}
	...
	if (_cmds->add_handler("finder/0.1/get_ipv4_permitted_hosts", 
	    callback(this, &XrlFinderTargetBase::handle_finder_0_1_get_ipv4_permitted_hosts)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://finder/finder/0.1/get_ipv4_permitted_hosts");
	}
	if (_cmds->add_handler("finder/0.1/get_ipv4_permitted_nets", 
	    callback(this, &XrlFinderTargetBase::handle_finder_0_1_get_ipv4_permitted_nets)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://finder/finder/0.1/get_ipv4_permitted_nets");
	}
	if (_cmds->add_handler("finder/0.1/get_ipv6_permitted_hosts", 
	    callback(this, &XrlFinderTargetBase::handle_finder_0_1_get_ipv6_permitted_hosts)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://finder/finder/0.1/get_ipv6_permitted_hosts");
	}
	if (_cmds->add_handler("finder/0.1/get_ipv6_permitted_nets", 
	    callback(this, &XrlFinderTargetBase::handle_finder_0_1_get_ipv6_permitted_nets)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://finder/finder/0.1/get_ipv6_permitted_nets");
	}
	_cmds->finalize();
    }
	...
	_cmds->remove_handler("finder/0.1/set_finder_client_enabled");
	_cmds->remove_handler("finder/0.1/finder_client_enabled");
	...
	_cmds->remove_handler("finder/0.1/get_ipv4_permitted_hosts");
	_cmds->remove_handler("finder/0.1/get_ipv4_permitted_nets");
	_cmds->remove_handler("finder/0.1/get_ipv6_permitted_hosts");
	_cmds->remove_handler("finder/0.1/get_ipv6_permitted_nets");
    }
};
