...
#ident "$XORP: xorp/xrl/targets/ripng_base.cc,v 1.18 2004/09/17 14:05:13 abittau Exp $"
...
XrlRipngTargetBase::handle_finder_event_observer_0_1_xrl_target_birth(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "finder_event_observer/0.1/xrl_target_birth");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_finder_event_observer_0_1_xrl_target_death(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "finder_event_observer/0.1/xrl_target_death");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_policy_backend_0_1_configure(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "policy_backend/0.1/configure");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_policy_backend_0_1_reset(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "policy_backend/0.1/reset");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_policy_backend_0_1_push_routes(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "policy_backend/0.1/push_routes");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_policy_redist6_0_1_add_route6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 6) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            6, XORP_UINT_CAST(xa_inputs.size()), "policy_redist6/0.1/add_route6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_policy_redist6_0_1_delete_route6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "policy_redist6/0.1/delete_route6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_redist6_0_1_add_route(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            7, XORP_UINT_CAST(xa_inputs.size()), "redist6/0.1/add_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_redist6_0_1_delete_route(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, XORP_UINT_CAST(xa_inputs.size()), "redist6/0.1/delete_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_redist6_0_1_starting_route_dump(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "redist6/0.1/starting_route_dump");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_redist6_0_1_finishing_route_dump(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "redist6/0.1/finishing_route_dump");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_add_rip_address(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/add_rip_address");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_remove_rip_address(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/remove_rip_address");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_rip_address_enabled(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_rip_address_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_rip_address_enabled(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/rip_address_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_cost(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_cost");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_cost(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/cost");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_horizon(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_horizon");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_horizon(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/horizon");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_passive(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_passive");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_passive(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/passive");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_accept_non_rip_requests(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_accept_non_rip_requests");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_accept_non_rip_requests(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/accept_non_rip_requests");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_accept_default_route(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_accept_default_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_accept_default_route(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/accept_default_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_advertise_default_route(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_advertise_default_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_advertise_default_route(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/advertise_default_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_route_expiry_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_route_expiry_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_route_expiry_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/route_expiry_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_route_deletion_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_route_deletion_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_route_deletion_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/route_deletion_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_table_request_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_table_request_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_table_request_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/table_request_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_unsolicited_response_min_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_unsolicited_response_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_unsolicited_response_min_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/unsolicited_response_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_unsolicited_response_max_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_unsolicited_response_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_unsolicited_response_max_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/unsolicited_response_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_triggered_update_min_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_triggered_update_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_triggered_update_min_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/triggered_update_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_triggered_update_max_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_triggered_update_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_triggered_update_max_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/triggered_update_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_set_interpacket_delay_milliseconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/set_interpacket_delay_milliseconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_interpacket_delay_milliseconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/interpacket_delay_milliseconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_rip_address_status(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/rip_address_status");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_get_all_addresses(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/get_all_addresses");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_get_counters(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/get_counters");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_get_peers(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/get_peers");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_get_all_peers(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/get_all_peers");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_get_peer_counters(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/get_peer_counters");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_redist_protocol_routes(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/redist_protocol_routes");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipngTargetBase::handle_ripng_0_1_no_redist_protocol_routes(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, XORP_UINT_CAST(xa_inputs.size()), "ripng/0.1/no_redist_protocol_routes");
	return XrlCmdError::BAD_ARGS();
    }
