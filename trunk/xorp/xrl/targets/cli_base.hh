 ...
 *
 * $XORP: xorp/xrl/targets/cli_base.hh,v 1.2 2002/12/14 23:43:14 hodson Exp $
 */
...
private:
	...
	if (_router->add_handler("cli_manager/0.1/enable_cli", 
	...
	if (_router->add_handler("cli_manager/0.1/disable_cli", 
	...
	if (_router->add_handler("cli_manager/0.1/start_cli", 
	...
	if (_router->add_handler("cli_manager/0.1/stop_cli", 
	...
	if (_router->add_handler("cli_manager/0.1/add_enable_cli_access_from_subnet4", 
	...
	if (_router->add_handler("cli_manager/0.1/add_enable_cli_access_from_subnet6", 
	...
	if (_router->add_handler("cli_manager/0.1/delete_enable_cli_access_from_subnet4", 
	...
	if (_router->add_handler("cli_manager/0.1/delete_enable_cli_access_from_subnet6", 
	...
	if (_router->add_handler("cli_manager/0.1/add_disable_cli_access_from_subnet4", 
	...
	if (_router->add_handler("cli_manager/0.1/add_disable_cli_access_from_subnet6", 
	...
	if (_router->add_handler("cli_manager/0.1/delete_disable_cli_access_from_subnet4", 
	...
	if (_router->add_handler("cli_manager/0.1/delete_disable_cli_access_from_subnet6", 
	...
	_router->remove_handler("cli_manager/0.1/enable_cli");
	_router->remove_handler("cli_manager/0.1/disable_cli");
	_router->remove_handler("cli_manager/0.1/start_cli");
	_router->remove_handler("cli_manager/0.1/stop_cli");
	_router->remove_handler("cli_manager/0.1/add_enable_cli_access_from_subnet4");
	_router->remove_handler("cli_manager/0.1/add_enable_cli_access_from_subnet6");
	_router->remove_handler("cli_manager/0.1/delete_enable_cli_access_from_subnet4");
	_router->remove_handler("cli_manager/0.1/delete_enable_cli_access_from_subnet6");
	_router->remove_handler("cli_manager/0.1/add_disable_cli_access_from_subnet4");
	_router->remove_handler("cli_manager/0.1/add_disable_cli_access_from_subnet6");
	_router->remove_handler("cli_manager/0.1/delete_disable_cli_access_from_subnet4");
	_router->remove_handler("cli_manager/0.1/delete_disable_cli_access_from_subnet6");
