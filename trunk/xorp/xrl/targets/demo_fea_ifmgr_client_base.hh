 ...
 *
 * $XORP: xorp/xrl/targets/demo_fea_ifmgr_client_base.hh,v 1.4 2003/01/28 18:19:22 hodson Exp $
 */
...
public:
    XrlDemoFeaIfmgrClientTargetBase(XrlCmdMap* cmds) : _cmds(cmds) { add_handlers(); }
