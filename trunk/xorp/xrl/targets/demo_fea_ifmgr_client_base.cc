...
#ident "$XORP: xorp/xrl/targets/demo_fea_ifmgr_client_base.cc,v 1.4 2003/05/13 00:23:54 hodson Exp $"
...
const XrlCmdError
XrlDemoFeaIfmgrClientTargetBase::handle_common_0_1_get_status(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 0) { 
...
const XrlCmdError
XrlDemoFeaIfmgrClientTargetBase::handle_common_0_1_shutdown(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 0) { 
