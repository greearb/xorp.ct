 ...
 *
 * $XORP: xorp/xrl/targets/fib2mrib_base.hh,v 1.1 2004/02/18 00:14:38 pavlin Exp $
 */
...
private:
	...
	if (_cmds->add_handler("fea_fib_client/0.1/add_route4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fib2mrib/fea_fib_client/0.1/add_route4");
	}
	if (_cmds->add_handler("fea_fib_client/0.1/add_route6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fib2mrib/fea_fib_client/0.1/add_route6");
	}
	if (_cmds->add_handler("fea_fib_client/0.1/replace_route4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fib2mrib/fea_fib_client/0.1/replace_route4");
	}
	if (_cmds->add_handler("fea_fib_client/0.1/replace_route6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fib2mrib/fea_fib_client/0.1/replace_route6");
	}
	if (_cmds->add_handler("fea_fib_client/0.1/delete_route4",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fib2mrib/fea_fib_client/0.1/delete_route4");
	}
	if (_cmds->add_handler("fea_fib_client/0.1/delete_route6",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fib2mrib/fea_fib_client/0.1/delete_route6");
	}
