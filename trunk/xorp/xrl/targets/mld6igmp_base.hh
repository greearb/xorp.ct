 ...
 *
 * $XORP: xorp/xrl/targets/mld6igmp_base.hh,v 1.14 2003/05/31 06:42:31 pavlin Exp $
 */
...
protected:
     ...
     */
    virtual XrlCmdError mld6igmp_0_1_enable_log_trace() = 0;

    virtual XrlCmdError mld6igmp_0_1_disable_log_trace() = 0;
...
private:
    ...
    const XrlCmdError handle_mld6igmp_0_1_get_vif_proto_version(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_mld6igmp_0_1_set_vif_proto_version(const Xrl& x, XrlArgs* a);

    const XrlCmdError handle_mld6igmp_0_1_reset_vif_proto_version(const Xrl& x, XrlArgs* a);
