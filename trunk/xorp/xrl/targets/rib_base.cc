...
#ident "$XORP: xorp/xrl/targets/rib_base.cc,v 1.14 2002/11/20 23:28:13 hodson Exp $"
...
XrlRibTargetBase::handle_rib_0_1_add_igp_table4(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/add_igp_table4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/add_igp_table6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/delete_igp_table4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/delete_igp_table6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/add_egp_table4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/add_egp_table6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/delete_egp_table4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/delete_egp_table6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRibTargetBase::handle_rib_0_1_add_route4(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 6) handling rib/0.1/add_route4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 6) { 
	XLOG_ERROR("Wrong number of arguments (%d != 6) handling rib/0.1/add_route6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 6) { 
	XLOG_ERROR("Wrong number of arguments (%d != 6) handling rib/0.1/replace_route4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 6) { 
	XLOG_ERROR("Wrong number of arguments (%d != 6) handling rib/0.1/replace_route6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRibTargetBase::handle_rib_0_1_delete_route4(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling rib/0.1/delete_route4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling rib/0.1/delete_route6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/lookup_route4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/lookup_route6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRibTargetBase::handle_rib_0_1_new_vif(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling rib/0.1/new_vif", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/add_vif_addr4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/add_vif_addr6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling rib/0.1/redist_enable4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling rib/0.1/redist_enable6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling rib/0.1/redist_disable4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling rib/0.1/redist_disable6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRibTargetBase::handle_rib_0_1_register_interest4(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 2) handling rib/0.1/register_interest4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/deregister_interest4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 2) { 
	XLOG_ERROR("Wrong number of arguments (%d != 2) handling rib/0.1/register_interest6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling rib/0.1/deregister_interest6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 2) { 
	XLOG_ERROR("Wrong number of arguments (%d != 2) handling fea_ifmgr_client/0.1/interface_update", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling fea_ifmgr_client/0.1/vif_update", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling fea_ifmgr_client/0.1/vifaddr4_update", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling fea_ifmgr_client/0.1/vifaddr6_update", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
