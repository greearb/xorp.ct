...
#ident "$XORP: xorp/xrl/targets/rib_base.cc,v 1.34 2005/03/25 02:55:07 pavlin Exp $"
...
XrlRibTargetBase::handle_rib_0_1_redist_enable4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "rib/0.1/redist_enable4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRibTargetBase::handle_rib_0_1_redist_enable6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "rib/0.1/redist_enable6");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRibTargetBase::handle_rib_0_1_redist_transaction_enable4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "rib/0.1/redist_transaction_enable4");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRibTargetBase::handle_rib_0_1_redist_transaction_enable6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "rib/0.1/redist_transaction_enable6");
	return XrlCmdError::BAD_ARGS();
    }
