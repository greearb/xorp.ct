...
#ident "$XORP: xorp/xrl/targets/rib_base.cc,v 1.4 2003/03/10 23:01:35 hodson Exp $"
...
const XrlCmdError
XrlRibTargetBase::handle_rib_0_1_add_rib_client(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling rib/0.1/add_rib_client", (uint32_t)xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
    ...
    string reason; 
    try {
	XrlCmdError e = rib_0_1_add_rib_client(
	    xrl.const_args().get_string("target_name"), 
	    xrl.const_args().get_uint32("family"), 
	    xrl.const_args().get_bool("is_unicast"), 
	    xrl.const_args().get_bool("is_multicast"), 
	    fail, 
	    reason);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rib/0.1/add_rib_client failed: %s \"%s\"",
            		 e.str().c_str(), e.note().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
const XrlCmdError
XrlRibTargetBase::handle_rib_0_1_delete_rib_client(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling rib/0.1/delete_rib_client", (uint32_t)xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
    ...
    string reason; 
    try {
	XrlCmdError e = rib_0_1_delete_rib_client(
	    xrl.const_args().get_string("target_name"), 
	    xrl.const_args().get_uint32("family"), 
	    xrl.const_args().get_bool("is_unicast"), 
	    xrl.const_args().get_bool("is_multicast"), 
	    ...
	    reason);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rib/0.1/delete_rib_client failed: %s \"%s\"",
            		 e.str().c_str(), e.note().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
const XrlCmdError
XrlRibTargetBase::handle_rib_0_1_enable_rib_client(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling rib/0.1/enable_rib_client", (uint32_t)xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
    ...
    string reason; 
    try {
	XrlCmdError e = rib_0_1_enable_rib_client(
	    xrl.const_args().get_string("target_name"), 
	    xrl.const_args().get_uint32("family"), 
	    xrl.const_args().get_bool("is_unicast"), 
	    xrl.const_args().get_bool("is_multicast"), 
	    ...
	    reason);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rib/0.1/enable_rib_client failed: %s \"%s\"",
            		 e.str().c_str(), e.note().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
const XrlCmdError
XrlRibTargetBase::handle_rib_0_1_disable_rib_client(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling rib/0.1/disable_rib_client", (uint32_t)xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
    ...
    string reason; 
    try {
	XrlCmdError e = rib_0_1_disable_rib_client(
	    xrl.const_args().get_string("target_name"), 
	    xrl.const_args().get_uint32("family"), 
	    xrl.const_args().get_bool("is_unicast"), 
	    xrl.const_args().get_bool("is_multicast"), 
	    ...
	    reason);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rib/0.1/disable_rib_client failed: %s \"%s\"",
            		 e.str().c_str(), e.note().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
