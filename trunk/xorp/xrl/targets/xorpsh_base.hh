 ...
 *
 * $XORP: xorp/xrl/targets/xorpsh_base.hh,v 1.1.1.1 2002/12/11 23:56:19 hodson Exp $
 */
...
public:
    XrlXorpshTargetBase(XrlCmdMap* r) : _router(r) { add_handlers(); }
...
private:
	...
	if (_router->add_handler("rtrmgr_client/0.1/new_config_user", 
	...
	if (_router->add_handler("rtrmgr_client/0.1/config_change_done", 
	...
	if (_router->add_handler("rtrmgr_client/0.1/config_changed", 
	...
	_router->remove_handler("rtrmgr_client/0.1/new_config_user");
	_router->remove_handler("rtrmgr_client/0.1/config_change_done");
	_router->remove_handler("rtrmgr_client/0.1/config_changed");
    }
};
