...
#ident "$XORP: xorp/xrl/targets/rip_base.cc,v 1.8 2004/05/03 23:17:27 hodson Exp $"
...
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != 7) handling redist4/0.1/add_route",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for redist4/0.1/add_route failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != 2) handling redist4/0.1/delete_route",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = redist4_0_1_delete_route(
	    ...
	    xa_inputs.get_string("cookie"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for redist4/0.1/delete_route failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling rip/0.1/set_accept_non_rip_requests",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/set_accept_non_rip_requests failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling rip/0.1/accept_non_rip_requests",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = rip_0_1_accept_non_rip_requests(
	    ...
	    accept);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/accept_non_rip_requests failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling rip/0.1/set_accept_default_route",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = rip_0_1_set_accept_default_route(
	    ...
	    xa_inputs.get_bool("accept"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/set_accept_default_route failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling rip/0.1/accept_default_route",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = rip_0_1_accept_default_route(
	    ...
	    accept);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/accept_default_route failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling rip/0.1/set_advertise_default_route",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/set_advertise_default_route failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling rip/0.1/advertise_default_route",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = rip_0_1_advertise_default_route(
	    ...
	    advertise);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/advertise_default_route failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling rip/0.1/get_counters",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = rip_0_1_get_counters(
	    ...
	    counter_values);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/get_counters failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling rip/0.1/get_peers",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = rip_0_1_get_peers(
	    ...
	    peers);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/get_peers failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != 0) handling rip/0.1/get_all_peers",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = rip_0_1_get_all_peers(
	    ...
	    addrs);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/get_all_peers failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != 4) handling rip/0.1/get_peer_counters",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = rip_0_1_get_peer_counters(
	    ...
	    peer_last_active);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/get_peer_counters failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != 3) handling rip/0.1/import_protocol_routes",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/import_protocol_routes failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != 1) handling rip/0.1/no_import_protocol_routes",
            (uint32_t)xa_inputs.size());
	return XrlCmdError::BAD_ARGS();
    }
	...
	XrlCmdError e = rip_0_1_no_import_protocol_routes(
	    xa_inputs.get_string("protocol_name"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for rip/0.1/no_import_protocol_routes failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
