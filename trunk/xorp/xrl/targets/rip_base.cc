...
#ident "$XORP: xorp/xrl/targets/rip_base.cc,v 1.20 2005/10/27 05:05:41 pavlin Exp $"
...
XrlRipTargetBase::handle_rip_0_1_set_route_expiry_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_route_expiry_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_route_expiry_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/route_expiry_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_route_deletion_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_route_deletion_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_route_deletion_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/route_deletion_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_table_request_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_table_request_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_table_request_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/table_request_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_unsolicited_response_min_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_unsolicited_response_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_unsolicited_response_min_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/unsolicited_response_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_unsolicited_response_max_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_unsolicited_response_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_unsolicited_response_max_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/unsolicited_response_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_triggered_update_min_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_triggered_update_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_triggered_update_min_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/triggered_update_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_triggered_update_max_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_triggered_update_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_triggered_update_max_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/triggered_update_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_interpacket_delay_milliseconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_interpacket_delay_milliseconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_interpacket_delay_milliseconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/interpacket_delay_milliseconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_authentication(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(5), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_authentication");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_authentication(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(3), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/authentication");
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlRipTargetBase::handle_rip_0_1_set_md5_authentication(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 7) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(7), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/set_md5_authentication");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = rip_0_1_set_md5_authentication(
	    xa_inputs.get_string("ifname"),
	    xa_inputs.get_string("vifname"),
	    xa_inputs.get_ipv4("addr"),
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "rip/0.1/set_md5_authentication", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
const XrlCmdError
XrlRipTargetBase::handle_rip_0_1_delete_md5_authentication(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            XORP_UINT_CAST(4), XORP_UINT_CAST(xa_inputs.size()), "rip/0.1/delete_md5_authentication");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = rip_0_1_delete_md5_authentication(
	    xa_inputs.get_string("ifname"),
	    xa_inputs.get_string("vifname"),
	    xa_inputs.get_ipv4("addr"),
	    xa_inputs.get_uint32("key_id"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "rip/0.1/delete_md5_authentication", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
XrlRipTargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("rip/0.1/set_md5_authentication",
	    callback(this, &XrlRipTargetBase::handle_rip_0_1_set_md5_authentication)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "rip", "rip/0.1/set_md5_authentication");
	}
	if (_cmds->add_handler("rip/0.1/delete_md5_authentication",
	    callback(this, &XrlRipTargetBase::handle_rip_0_1_delete_md5_authentication)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "rip", "rip/0.1/delete_md5_authentication");
	}
...
XrlRipTargetBase::remove_handlers()
{
	...
	_cmds->remove_handler("rip/0.1/set_md5_authentication");
	_cmds->remove_handler("rip/0.1/delete_md5_authentication");
