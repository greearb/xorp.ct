...
#ident "$XORP: xorp/xrl/targets/rip_base.cc,v 1.10 2004/05/24 17:35:44 hodson Exp $"
...
XrlRipTargetBase::handle_rip_0_1_add_rip_address(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/add_rip_address");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_remove_rip_address(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/remove_rip_address");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_rip_address_enabled(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_rip_address_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_rip_address_enabled(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/rip_address_enabled");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_cost(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_cost");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_cost(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/cost");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_horizon(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_horizon");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_horizon(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/horizon");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_passive(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_passive");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_passive(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/passive");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_accept_non_rip_requests(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_accept_non_rip_requests");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_accept_non_rip_requests(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/accept_non_rip_requests");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_accept_default_route(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_accept_default_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_accept_default_route(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/accept_default_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_advertise_default_route(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_advertise_default_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_advertise_default_route(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/advertise_default_route");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_route_expiry_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_route_expiry_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_route_expiry_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/route_expiry_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_route_deletion_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_route_deletion_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_route_deletion_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/route_deletion_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_table_request_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_table_request_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_table_request_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/table_request_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_unsolicited_response_min_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_unsolicited_response_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_unsolicited_response_min_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/unsolicited_response_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_unsolicited_response_max_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_unsolicited_response_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_unsolicited_response_max_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/unsolicited_response_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_triggered_update_min_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_triggered_update_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_triggered_update_min_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/triggered_update_min_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_triggered_update_max_seconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_triggered_update_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_triggered_update_max_seconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/triggered_update_max_seconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_interpacket_delay_milliseconds(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/set_interpacket_delay_milliseconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_interpacket_delay_milliseconds(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/interpacket_delay_milliseconds");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_set_authentication(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 5) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            5, (uint32_t)xa_inputs.size(), "rip/0.1/set_authentication");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_authentication(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/authentication");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_rip_address_status(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/rip_address_status");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_get_all_addresses(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, (uint32_t)xa_inputs.size(), "rip/0.1/get_all_addresses");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_get_counters(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/get_counters");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_get_peers(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/get_peers");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_get_all_peers(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 0) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            0, (uint32_t)xa_inputs.size(), "rip/0.1/get_all_peers");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_get_peer_counters(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "rip/0.1/get_peer_counters");
	return XrlCmdError::BAD_ARGS();
    }
...
const XrlCmdError
XrlRipTargetBase::handle_rip_0_1_import_protocol_routes(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/import_protocol_routes");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = rip_0_1_import_protocol_routes(
	    xa_inputs.get_string("protocol_name"),
	    xa_inputs.get_uint32("cost"),
	    xa_inputs.get_uint32("tag"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "rip/0.1/import_protocol_routes", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
const XrlCmdError
XrlRipTargetBase::handle_rip_0_1_no_import_protocol_routes(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, (uint32_t)xa_inputs.size(), "rip/0.1/no_import_protocol_routes");
	return XrlCmdError::BAD_ARGS();
    }

    /* Return value declarations */
    try {
	XrlCmdError e = rip_0_1_no_import_protocol_routes(
	    xa_inputs.get_string("protocol_name"));
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
            		 "rip/0.1/no_import_protocol_routes", e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
	XLOG_ERROR("Argument not found");
...
XrlRipTargetBase::handle_socket4_user_0_1_recv_event(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "socket4_user/0.1/recv_event");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_socket4_user_0_1_connect_event(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
    if (xa_inputs.size() != 4) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            4, (uint32_t)xa_inputs.size(), "socket4_user/0.1/connect_event");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_socket4_user_0_1_error_event(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "socket4_user/0.1/error_event");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_socket4_user_0_1_close_event(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 2) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            2, (uint32_t)xa_inputs.size(), "socket4_user/0.1/close_event");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("rip/0.1/import_protocol_routes",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "rip", "rip/0.1/import_protocol_routes");
	}
	if (_cmds->add_handler("rip/0.1/no_import_protocol_routes",
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "rip", "rip/0.1/no_import_protocol_routes");
	}
