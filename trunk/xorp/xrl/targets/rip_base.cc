...
#ident "$XORP: xorp/xrl/targets/rip_base.cc,v 1.14 2004/06/21 18:06:07 hodson Exp $"
...
XrlRipTargetBase::handle_rip_0_1_redist_protocol_routes(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 3) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            3, (uint32_t)xa_inputs.size(), "rip/0.1/redist_protocol_routes");
	return XrlCmdError::BAD_ARGS();
    }
...
XrlRipTargetBase::handle_rip_0_1_no_redist_protocol_routes(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
    if (xa_inputs.size() != 1) {
	XLOG_ERROR("Wrong number of arguments (%u != %u) handling %s",
            1, (uint32_t)xa_inputs.size(), "rip/0.1/no_redist_protocol_routes");
	return XrlCmdError::BAD_ARGS();
    }
