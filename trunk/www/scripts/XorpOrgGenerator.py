...
# --
    ...
    ("CLI Manual", "http://www.xorp.org/releases/current/docs/rtrmgr/xorpsh_userguide.pdf"),
    ("Frequently Asked Questions", "faq.html"),
    ("Design docs", "design_docs.html"),
    ("Papers", "papers.html"),
    ("API Docs", "http://www.xorp.org/releases/current/docs/kdoc/html/index.html"),
