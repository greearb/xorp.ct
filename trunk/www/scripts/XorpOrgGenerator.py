...
#    print "<hr noshade>"
#    open_div("feedback")
#    print "<p><em>Document id $XORP: www/scripts/XorpOrgGenerator.py,v 1.20 2008/10/23 21:19:59 rchua Exp $."
...
def write_header(filename, headextras = []):
    print """<!-- $XORP: www/scripts/XorpOrgGenerator.py,v 1.20 2008/10/23 21:19:59 rchua Exp $ -->
