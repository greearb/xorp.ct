...
#    print "<hr noshade>"
#    open_div("feedback")
#    print "<p><em>Document id $XORP: www/scripts/XorpOrgGenerator.py,v 1.22 2008/10/28 15:50:59 rchua Exp $."
...
def write_header(filename, headextras = []):
    print """<!-- $XORP: www/scripts/XorpOrgGenerator.py,v 1.22 2008/10/28 15:50:59 rchua Exp $ -->
