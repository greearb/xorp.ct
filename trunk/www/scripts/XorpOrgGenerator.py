...
# --
    ...
    ("CLI Manual", "releases/current/docs/rtrmgr/xorpsh_userguide.pdf"),
...
# --
    ...
    ("Bug Reporting", "bugzilla/index.cgi")
    ]
...
def write_main_end():
    print "<hr noshade>"
    open_div("feedback")
    print "<p><em>Document id $XORP: www/scripts/XorpOrgGenerator.py,v 1.2 2004/07/02 19:27:30 hodson Exp $."
...
def write_header(headextras = []):
    print """<!-- $XORP: www/scripts/XorpOrgGenerator.py,v 1.2 2004/07/02 19:27:30 hodson Exp $ -->
