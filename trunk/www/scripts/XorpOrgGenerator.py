...
def write_main_end():
    print "<hr noshade>"
    open_div("feedback")
    print "<p><em>Document id $XORP: www/scripts/XorpOrgGenerator.py,v 1.1 2004/07/02 18:54:14 hodson Exp $."
...
def write_header(headextras = []):
    print """<!-- $XORP: www/scripts/XorpOrgGenerator.py,v 1.1 2004/07/02 18:54:14 hodson Exp $ -->
