...
def write_main_end():
    print "<hr noshade>"
    open_div("feedback")
    print "<p><em>Document id $XORP: www/scripts/XorpOrgGenerator.py,v 1.12 2005/04/14 10:43:17 mjh Exp $."
...
def write_header(headextras = []):
    print """<!-- $XORP: www/scripts/XorpOrgGenerator.py,v 1.12 2005/04/14 10:43:17 mjh Exp $ -->
