...
def write_main_end():
    print "<hr noshade>"
    open_div("feedback")
    print "<p><em>Document id $XORP: www/scripts/XorpOrgGenerator.py,v 1.8 2004/07/14 22:21:06 pavlin Exp $."
...
def write_header(headextras = []):
    print """<!-- $XORP: www/scripts/XorpOrgGenerator.py,v 1.8 2004/07/14 22:21:06 pavlin Exp $ -->
