...
#    print "<hr noshade>"
#    open_div("feedback")
#    print "<p><em>Document id $XORP: www/scripts/XorpOrgGenerator.py,v 1.21 2008/10/25 23:29:59 rchua Exp $."
...
def write_header(filename, headextras = []):
    print """<!-- $XORP: www/scripts/XorpOrgGenerator.py,v 1.21 2008/10/25 23:29:59 rchua Exp $ -->
