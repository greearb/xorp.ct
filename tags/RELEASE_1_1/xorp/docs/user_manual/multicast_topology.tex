%
% $XORP: xorp/docs/user_manual/multicast_topology.tex,v 1.3 2005/04/07 03:09:12 pavlin Exp $
%
...
\begin{alltt}
\begin{tabbing}
xxxx\=xxxxxxxxxxxxxxxxxxx\=xxxxxxxxxxxxxxxxxxxxxxxx\=xxxxxxxxxxxxxxxxxxxx\=\kill
Xorp> \textbf{show route table ipv4 multicast fib2mrib}\\
Network 10.2.0.0/24\\
    \>Nexthop := 0.0.0.0\\
    \>Metric := 65535    \>Protocol := fib2mrib    \>Interface := dc2    \>Vif := dc2\\
Network 10.3.0.0/24\\
    \>Nexthop := 0.0.0.0\\
    \>Metric := 65535    \>Protocol := fib2mrib    \>Interface := dc1    \>Vif := dc1\\
Network 10.4.0.0/24\\
    \>Nexthop := 10.3.0.2\\
    \>Metric := 65535    \>Protocol := fib2mrib    \>Interface := dc1    \>Vif := dc1\\
Network 10.5.0.0/24\\
...
\begin{alltt}
\begin{tabbing}
xxxx\=xxxxxxxxxxxxxx\=xxxxx\=xxxxxxxxxxxxxxxxxxxxxxxx\=xxxxxxxxxxxxxxxxxxxx\=\kill
Xorp> \textbf{show route table ipv4 multicast final}\\
Network 10.2.0.0/24\\
    \>Nexthop := 10.2.0.2\\
    \>Metric :=     \>0    \>Protocol := connected    \>Interface := dc2    \>Vif := dc2\\
Network 10.3.0.0/24\\
    \>Nexthop := 10.3.0.1\\
    \>Metric :=     \>0    \>Protocol := connected    \>Interface := dc1    \>Vif := dc1\\
Network 10.4.0.0/24\\
    \>Nexthop := 10.3.0.2\\
    \>Metric := 65535    \>\>Protocol := fib2mrib    \>Interface := dc1    \>Vif := dc1\\
Network 10.5.0.0/24\\
