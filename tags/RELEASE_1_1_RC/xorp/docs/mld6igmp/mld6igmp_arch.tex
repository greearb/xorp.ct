%
% $XORP: xorp/docs/mld6igmp/mld6igmp_arch.tex,v 1.9 2004/06/23 01:46:44 pavlin Exp $
%
...
Currently (July 2004), the MLD and IGMP implementation is based
...
(July 2004) there are few occasions when XrlMld6igmpNode uses
...
configuration~\footnote{Currently (July 2004), Mld6igmpConfig is not
