...
#ident "$XORP: xorp/xrl/interfaces/bgp_xif.cc,v 1.42 2005/12/06 07:30:59 atanu Exp $"
...
{
    Xrl x(the_tgt, "bgp/0.2/set_confederation_identifier");
    x.args().add("as", as);
...
{
    Xrl x(the_tgt, "bgp/0.2/set_cluster_id");
...
{
    Xrl x(the_tgt, "bgp/0.2/set_damping");
...
{
    Xrl x(the_tgt, "bgp/0.2/change_local_ip");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/change_local_port");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/change_peer_port");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/set_peer_as");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/set_holdtime");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/set_delay_open_time");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/set_route_reflector_client");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/set_confederation_member");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/set_nexthop4");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/set_nexthop6");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
...
{
    Xrl x(the_tgt, "bgp/0.2/get_nexthop6");
    x.args().add("local_ip", local_ip);
    x.args().add("local_port", local_port);
    x.args().add("peer_ip", peer_ip);
    x.args().add("peer_port", peer_port);
