...
#ident "$XORP: xorp/xrl/targets/fea_base.cc,v 1.88 2008/06/14 02:59:25 pavlin Exp $"
...
XrlFeaTargetBase::handle_fea_firewall_0_1_add_entry4(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
	...
	XrlCmdError e = fea_firewall_0_1_add_entry4(
	    xa_inputs.get_uint32("tid"),
	    xa_inputs.get_uint32("rule_number"),
	    xa_inputs.get_string("ifname"),
	    xa_inputs.get_string("vifname"),
	    xa_inputs.get_ipv4net("src_network"),
	    xa_inputs.get_ipv4net("dst_network"),
	    xa_inputs.get_uint32("ip_protocol"),
	    xa_inputs.get_uint32("src_port_begin"),
	    xa_inputs.get_uint32("src_port_end"),
	    xa_inputs.get_uint32("dst_port_begin"),
	    xa_inputs.get_uint32("dst_port_end"),
...
XrlFeaTargetBase::handle_fea_firewall_0_1_add_entry6(const XrlArgs& xa_inputs, XrlArgs* /* pxa_outputs */)
{
	...
	XrlCmdError e = fea_firewall_0_1_add_entry6(
	    ...
	    xa_inputs.get_string("ifname"),
	    xa_inputs.get_string("vifname"),
	    xa_inputs.get_ipv6net("src_network"),
	    xa_inputs.get_ipv6net("dst_network"),
	    xa_inputs.get_uint32("ip_protocol"),
	    xa_inputs.get_uint32("src_port_begin"),
	    xa_inputs.get_uint32("src_port_end"),
	    xa_inputs.get_uint32("dst_port_begin"),
...
XrlFeaTargetBase::handle_socket4_0_1_udp_open_bind_broadcast(const XrlArgs& xa_inputs, XrlArgs* pxa_outputs)
{
	...
	XrlCmdError e = socket4_0_1_udp_open_bind_broadcast(
	    ...
	    xa_inputs.get_uint32("remote_port"),
	    xa_inputs.get_bool("reuse"),
	    xa_inputs.get_bool("limited"),
	    xa_inputs.get_bool("connected"),
	    sockid);
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for %s failed: %s",
