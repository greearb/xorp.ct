...
#ident "$XORP: xorp/xrl/interfaces/finder_xif.cc,v 1.23 2007/07/12 21:46:08 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/register_finder_client");
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/unregister_finder_client");
    x.args().add("instance_name", instance_name);
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/set_finder_client_enabled");
    x.args().add("instance_name", instance_name);
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/finder_client_enabled");
    x.args().add("instance_name", instance_name);
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/add_xrl");
    x.args().add("xrl", xrl);
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/remove_xrl");
    x.args().add("xrl", xrl);
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/resolve_xrl");
    x.args().add("xrl", xrl);
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/get_xrl_targets");
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/get_xrls_registered_by");
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/get_ipv4_permitted_hosts");
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/get_ipv4_permitted_nets");
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/get_ipv6_permitted_hosts");
...
{
    Xrl x(dst_xrl_target_name, "finder/0.2/get_ipv6_permitted_nets");
