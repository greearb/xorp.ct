...
#ident "$XORP: xorp/xrl/interfaces/fea_fib_client_xif.cc,v 1.12 2007/07/16 22:29:26 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "fea_fib_client/0.1/add_route4");
...
{
    Xrl x(dst_xrl_target_name, "fea_fib_client/0.1/add_route6");
    x.args().add("network", network);
    x.args().add("nexthop", nexthop);
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "fea_fib_client/0.1/replace_route4");
    x.args().add("network", network);
    x.args().add("nexthop", nexthop);
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "fea_fib_client/0.1/replace_route6");
    x.args().add("network", network);
    x.args().add("nexthop", nexthop);
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "fea_fib_client/0.1/delete_route4");
    x.args().add("network", network);
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "fea_fib_client/0.1/delete_route6");
    x.args().add("network", network);
    x.args().add("ifname", ifname);
    x.args().add("vifname", vifname);
...
{
    Xrl x(dst_xrl_target_name, "fea_fib_client/0.1/resolve_route4");
    x.args().add("network", network);
...
{
    Xrl x(dst_xrl_target_name, "fea_fib_client/0.1/resolve_route6");
    x.args().add("network", network);
