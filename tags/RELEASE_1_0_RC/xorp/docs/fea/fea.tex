%
% $XORP: xorp/docs/fea/fea.tex,v 1.8 2003/11/06 18:31:00 pavlin Exp $
%
...
interfaces that require special programming.  Currently (November 2003),
...
via XRL on the basis on filter conditions.  Currently (November 2003),
...
Currently (November 2003), two versions of the FEA are supported: {\tt
...
In other words, currently (November 2003) the {\tt fea} supports FreeBSD,
