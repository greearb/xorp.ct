%
% $XORP: xorp/docs/mld6igmp/mld6igmp_arch.tex,v 1.7 2003/08/28 00:13:21 pavlin Exp $
%
...
Currently (November 2003), the MLD and IGMP implementation is based
...
(November 2003) there are few occasions when XrlMld6igmpNode uses
...
configuration~\footnote{Currently (November 2003), Mld6igmpConfig is not
