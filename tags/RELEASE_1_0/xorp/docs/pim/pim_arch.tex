%
% $XORP: xorp/docs/pim/pim_arch.tex,v 1.10 2004/06/23 02:48:52 pavlin Exp $
%
...
would be through PimNode~\footnote{For simplicity, currently (July 2004)
...
(July 2004) the PimScopeZoneTable is used only for PIM
...
For simplicity of implementation, currently (July 2004) PimMrt
...
the multicast forwarding engine. Currently (July 2004), those
...
module~\footnote{Note that before July 2004 the information was
...
(July 2004), PimConfig is not implemented; rather, all state is
