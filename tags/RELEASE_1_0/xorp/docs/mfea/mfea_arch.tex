%
% $XORP: xorp/docs/mfea/mfea_arch.tex,v 1.12 2004/06/23 01:43:34 pavlin Exp $
%
...
Currently (July 2004), the MFEA supports abstraction for
...
path~\footnote{Currently (July 2004) Click does
...
\begin{itemize}
  ...
  multicast-related modules. Note that as of July 2004 this interface is
...
packets~\footnote{In the future (after July 2004), the PIM
...
(July 2004) there are few occasions when XrlMfeaNode uses direct access to
MfeaVif.}.
...
(July 2004), MfeaConfig is not implemented; rather, all state is
...
{\bf Note: As of July 2004 obtaning the MRIB information via the MFEA
