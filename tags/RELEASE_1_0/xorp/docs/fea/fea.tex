%
% $XORP: xorp/docs/fea/fea.tex,v 1.10 2004/06/24 04:34:07 pavlin Exp $
%
...
interfaces that require special programming.  Currently (July 2004),
...
via XRL on the basis on filter conditions.  Currently (July 2004),
...
In other words, currently (July 2004) the {\tt fea} supports FreeBSD,
