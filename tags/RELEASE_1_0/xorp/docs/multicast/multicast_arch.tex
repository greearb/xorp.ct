%
% $XORP: xorp/docs/multicast/multicast_arch.tex,v 1.9 2004/06/23 02:40:26 pavlin Exp $
%
...
\begin{itemize}
  ...
  \item Note that as of (July 2004), the MRIB information is
...
Register encapsulation. Currently (July 2004), only few systems (\eg
...
information should be sent to the PIM module. Currently (July 2004),
...
As of July 2004 the MRIB is received from the RIB instead.
