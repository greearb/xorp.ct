...
#ident "$XORP: xorp/xrl/interfaces/pim_xif.cc,v 1.24 2004/05/24 17:35:37 hodson Exp $"
...
)
{
	...
	XLOG_ERROR("Wrong number of arguments (%u != %u)", (uint32_t)a->size(), 8);
...
)
{
	...
	XLOG_ERROR("Wrong number of arguments (%u != %u)", (uint32_t)a->size(), 5);
