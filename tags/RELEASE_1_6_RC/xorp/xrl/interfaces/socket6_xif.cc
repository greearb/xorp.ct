...
#ident "$XORP: xorp/xrl/interfaces/socket6_xif.cc,v 1.25 2008/09/23 08:13:20 abittau Exp $"
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/tcp_open");
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/udp_open");
        x->args().add(XrlAtom(creator));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/tcp_open_and_bind");
        x->args().add(XrlAtom(creator));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/udp_open_and_bind");
        x->args().add(XrlAtom(creator));
        x->args().add(XrlAtom(local_addr));
        x->args().add(XrlAtom(local_port));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/udp_open_bind_join");
        x->args().add(XrlAtom(creator));
        x->args().add(XrlAtom(local_addr));
        x->args().add(XrlAtom(local_port));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/tcp_open_bind_connect");
        x->args().add(XrlAtom(creator));
        x->args().add(XrlAtom(local_addr));
        x->args().add(XrlAtom(local_port));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/udp_open_bind_connect");
        x->args().add(XrlAtom(creator));
        x->args().add(XrlAtom(local_addr));
        x->args().add(XrlAtom(local_port));
        x->args().add(XrlAtom(remote_addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/bind");
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/udp_join_group");
        x->args().add(XrlAtom(sockid));
        x->args().add(XrlAtom(mcast_addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/udp_leave_group");
        x->args().add(XrlAtom(sockid));
        x->args().add(XrlAtom(mcast_addr));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/close");
        x->args().add(XrlAtom(sockid));
    }
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/tcp_listen");
        x->args().add(XrlAtom(sockid));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/send");
        x->args().add(XrlAtom(sockid));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/send_to");
        x->args().add(XrlAtom(sockid));
        x->args().add(XrlAtom(remote_addr));
        x->args().add(XrlAtom(remote_port));
        x->args().add(XrlAtom(data));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/send_from_multicast_if");
        x->args().add(XrlAtom(sockid));
...
)
{
    ...
    if (!x) {
        x = new Xrl(dst_xrl_target_name, "socket6/0.1/set_socket_option");
        x->args().add(XrlAtom(sockid));
