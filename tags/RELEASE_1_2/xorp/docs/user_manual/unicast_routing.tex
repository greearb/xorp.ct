%
% $XORP: xorp/docs/user_manual/unicast_routing.tex,v 1.9 2006/03/08 06:55:23 atanu Exp $
%
...
\end{itemize}
Currently (March 2006), XORP supports RIP, OSPF and BGP.
...
Currently (March 2006), there is no way to modify these default
