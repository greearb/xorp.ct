%
% $XORP: xorp/docs/design_arch/design_arch.tex,v 1.7 2003/06/09 20:02:19 pavlin Exp $
%
...
most of the code is written to support both, as of Release 0.4
(August 2003) only IPv4 has been tested in details.
...
As of August 2003, the RIP implementation is work in progress.
