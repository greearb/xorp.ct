%
% $XORP: xorp/docs/pim/pim_arch.tex,v 1.6 2003/06/09 20:02:21 pavlin Exp $
%
...
Currently (August 2003), the PIM-SM implementation is based
...
would be through PimNode~\footnote{For simplicity, currently (August 2003)
...
(August 2003) the PimScopeZoneTable is used only for PIM
...
For simplicity of implementation, currently (August 2003) PimMrt
...
the multicast forwarding engine. Currently (August 2003), those
...
possible to create such table manually. However, currently (August
2003) there are 52 input events and 77 output operations,
...
as of August 2003), we save the appropriate state to continue the
...
module~\footnote{Currently (August 2003), the information is
...
Note that as we mentioned earlier, currently (August 2003), the MRIB
...
(August 2003), PimConfig is not implemented; rather, all state is
