 ...
 *
 * $XORP: xorp/xrl/targets/rtrmgr_base.hh,v 1.10 2003/06/01 22:34:03 hodson Exp $
 */
...
private:
	...
	if (_cmds->add_handler("common/0.1/get_status", 
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://rtrmgr/common/0.1/get_status");
	}
	if (_cmds->add_handler("common/0.1/shutdown", 
	    callback(this, &XrlRtrmgrTargetBase::handle_common_0_1_shutdown)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://rtrmgr/common/0.1/shutdown");
	}
