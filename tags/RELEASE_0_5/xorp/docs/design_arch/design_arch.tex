%
% $XORP: xorp/docs/design_arch/design_arch.tex,v 1.8 2003/08/28 13:25:50 pavlin Exp $
%
...
most of the code is written to support both, as of Release 0.5
(November 2003) only IPv4 has been tested in details.
...
As of November 2003, the RIP implementation is work in progress.
