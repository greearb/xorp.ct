 ...
 *
 * $XORP: xorp/xrl/targets/mld6igmp_base.hh,v 1.16 2003/06/01 22:34:02 hodson Exp $
 */
...
private:
    ...
    const XrlCmdError handle_mld6igmp_0_1_enable_log_trace(const XrlArgs& in, XrlArgs* out);

    const XrlCmdError handle_mld6igmp_0_1_disable_log_trace(const XrlArgs& in, XrlArgs* out);
