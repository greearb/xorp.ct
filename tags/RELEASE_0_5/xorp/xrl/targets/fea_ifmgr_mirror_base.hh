 ...
 *
 * $XORP: xorp/xrl/targets/fea_ifmgr_mirror_base.hh,v 1.4 2003/09/30 03:08:04 pavlin Exp $
 */
...
private:
	...
	if (_cmds->add_handler("fea_ifmgr_mirror/0.1/interface_set_pif_index", 
	    ...
	    XLOG_ERROR("Failed to xrl handler finder://fea_ifmgr_mirror/fea_ifmgr_mirror/0.1/interface_set_pif_index");
	}
