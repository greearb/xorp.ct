...
#ident "$XORP: xorp/xrl/targets/fea_base.cc,v 1.94 2008/10/09 17:47:03 abittau Exp $"
...
XrlFeaTargetBase::add_handlers()
{
	...
	if (_cmds->add_handler("ifmgr/0.1/create_mac",
	    callback(this, &XrlFeaTargetBase::handle_ifmgr_0_1_create_mac)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "ifmgr/0.1/create_mac");
	}
	if (_cmds->add_handler("ifmgr/0.1/delete_mac",
	    callback(this, &XrlFeaTargetBase::handle_ifmgr_0_1_delete_mac)) == false) {
	    XLOG_ERROR("Failed to xrl handler finder://%s/%s", "fea", "ifmgr/0.1/delete_mac");
	}
...
XrlFeaTargetBase::remove_handlers()
{
	...
	_cmds->remove_handler("ifmgr/0.1/create_mac");
	_cmds->remove_handler("ifmgr/0.1/delete_mac");
