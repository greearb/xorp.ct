...
#    print "<hr noshade>"
#    open_div("feedback")
#    print "<p><em>Document id $XORP: www/scripts/XorpOrgGenerator.py,v 1.17 2008/01/30 05:35:54 atanu Exp $."
...
def write_header(filename, headextras = []):
    print """<!-- $XORP: www/scripts/XorpOrgGenerator.py,v 1.17 2008/01/30 05:35:54 atanu Exp $ -->
