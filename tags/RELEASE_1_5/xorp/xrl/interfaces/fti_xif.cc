...
#ident "$XORP: xorp/xrl/interfaces/fti_xif.cc,v 1.21 2008/01/04 03:17:56 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "fti/0.2/set_unicast_forwarding_table_id4");
...
{
    Xrl x(dst_xrl_target_name, "fti/0.2/set_unicast_forwarding_table_id6");
    x.args().add("is_configured", is_configured);
    x.args().add("table_id", table_id);
