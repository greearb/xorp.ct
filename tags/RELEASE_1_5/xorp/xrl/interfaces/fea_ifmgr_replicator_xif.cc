...
#ident "$XORP: xorp/xrl/interfaces/fea_ifmgr_replicator_xif.cc,v 1.12 2008/01/04 03:17:53 pavlin Exp $"
...
{
    Xrl x(dst_xrl_target_name, "ifmgr_replicator/0.1/register_ifmgr_mirror");
...
{
    Xrl x(dst_xrl_target_name, "ifmgr_replicator/0.1/unregister_ifmgr_mirror");
    x.args().add("clientname", clientname);
