...
#ident "$XORP: xorp/xrl/interfaces/mfea_xif.cc,v 1.5 2003/02/08 09:18:27 pavlin Exp $"
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall0, cb));
}
...
)
{
    ...
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall1, cb));
}
...
)
{
    ...
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall2, cb));
}
...
)
{
    ...
    x.args().add("protocol_name", protocol_name);
    x.args().add("protocol_id", protocol_id);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall3, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall4, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    x.args().add("vif_index", vif_index);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall5, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    x.args().add("vif_index", vif_index);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall6, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    x.args().add("vif_index", vif_index);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall7, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall8, cb));
}
...
)
{
    ...
    x.args().add("protocol_id", protocol_id);
    x.args().add("is_allow", is_allow);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall9, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall10, cb));
}
...
)
{
    ...
    x.args().add("vif_index", vif_index);
    x.args().add("group_address", group_address);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall11, cb));
}
...
)
{
    ...
    x.args().add("vif_index", vif_index);
    x.args().add("group_address", group_address);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall12, cb));
}
...
)
{
    ...
    x.args().add("vif_index", vif_index);
    x.args().add("group_address", group_address);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall13, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall14, cb));
}
...
)
{
    ...
    x.args().add("max_vifs_oiflist", max_vifs_oiflist);
    x.args().add("rp_address", rp_address);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall15, cb));
}
...
)
{
    ...
    x.args().add("source_address", source_address);
    x.args().add("group_address", group_address);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall16, cb));
}
...
)
{
    ...
    x.args().add("source_address", source_address);
    x.args().add("group_address", group_address);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall17, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall18, cb));
}
...
)
{
    ...
    x.args().add("is_router_alert", is_router_alert);
    x.args().add("protocol_message", protocol_message);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall19, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall20, cb));
}
...
)
{
    ...
    x.args().add("is_geq_upcall", is_geq_upcall);
    x.args().add("is_leq_upcall", is_leq_upcall);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall21, cb));
}
...
)
{
    ...
    x.args().add("is_geq_upcall", is_geq_upcall);
    x.args().add("is_leq_upcall", is_leq_upcall);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall22, cb));
}
...
)
{
    ...
    x.args().add("is_geq_upcall", is_geq_upcall);
    x.args().add("is_leq_upcall", is_leq_upcall);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall23, cb));
}
...
)
{
    ...
    x.args().add("source_address", source_address);
    x.args().add("group_address", group_address);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall24, cb));
}
...
)
{
    ...
    x.args().add("source_address", source_address);
    x.args().add("group_address", group_address);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall25, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall26, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall27, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall28, cb));
}
...
)
{
    ...
    x.args().add("vif_name", vif_name);
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall29, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall30, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall31, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall32, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall33, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall34, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall35, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall36, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall37, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall38, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall39, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall40, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall41, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall42, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall43, cb));
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall44, cb));
}


/* Unmarshall get_mrib_table_default_metric_preference */
void
XrlMfeaV0p1Client::unmarshall44(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB44		cb
)
{
    ...
    cb->dispatch(e, &metric_preference, &fail, &reason);
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall45, cb));
}


/* Unmarshall set_mrib_table_default_metric_preference */
void
XrlMfeaV0p1Client::unmarshall45(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB45		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall46, cb));
}


/* Unmarshall reset_mrib_table_default_metric_preference */
void
XrlMfeaV0p1Client::unmarshall46(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB46		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall47, cb));
}


/* Unmarshall get_mrib_table_default_metric */
void
XrlMfeaV0p1Client::unmarshall47(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB47		cb
)
{
    ...
    cb->dispatch(e, &metric, &fail, &reason);
}
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall48, cb));
}


/* Unmarshall set_mrib_table_default_metric */
void
XrlMfeaV0p1Client::unmarshall48(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB48		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlMfeaV0p1Client::unmarshall49, cb));
}


/* Unmarshall reset_mrib_table_default_metric */
void
XrlMfeaV0p1Client::unmarshall49(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB49		cb
)
