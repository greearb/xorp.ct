...
#ident "$XORP: xorp/xrl/targets/cli_base.cc,v 1.8 2003/05/29 21:17:18 mjh Exp $"
...
const XrlCmdError
XrlCliTargetBase::handle_common_0_1_get_status(const Xrl& xrl, XrlArgs* args)
{
    if (xrl.const_args().size() != 0) {
...
const XrlCmdError
XrlCliTargetBase::handle_common_0_1_shutdown(const Xrl& xrl, XrlArgs* /* args */)
{
    if (xrl.const_args().size() != 0) {
