...
#ident "$XORP: xorp/xrl/targets/mld6igmp_base.cc,v 1.11 2003/06/01 02:09:59 pavlin Exp $"
...
XrlMld6igmpTargetBase::handle_mld6igmp_0_1_enable_log_trace(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for mld6igmp/0.1/enable_log_trace failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
...
XrlMld6igmpTargetBase::handle_mld6igmp_0_1_disable_log_trace(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	if (e != XrlCmdError::OKAY()) {
	    XLOG_WARNING("Handling method for mld6igmp/0.1/disable_log_trace failed: %s",
            		 e.str().c_str());
	    return e;
        }
    } catch (const XrlArgs::XrlAtomNotFound& e) {
