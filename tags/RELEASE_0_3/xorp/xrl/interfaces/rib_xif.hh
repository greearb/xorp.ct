 ...
 *
 * $XORP: xorp/xrl/interfaces/rib_xif.hh,v 1.10 2003/05/13 00:23:51 hodson Exp $
 */
...
public:
    ...
    typedef XorpCallback7<void, const XrlError&, const bool*, const IPv4*, const uint32_t*, const uint32_t*, const IPv4*, const uint32_t*>::RefPtr CB37;
    /**
     *  Send Xrl intended to:
     *  
    ...
    typedef XorpCallback7<void, const XrlError&, const bool*, const IPv6*, const uint32_t*, const uint32_t*, const IPv6*, const uint32_t*>::RefPtr CB39;
    /**
     *  Send Xrl intended to:
     *  
     *  Register an interest in a route
