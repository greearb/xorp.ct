...
#ident "$XORP: xorp/xrl/interfaces/cli_processor_xif.cc,v 1.5 2003/03/10 23:01:26 hodson Exp $"
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlCliProcessorV0p1Client::unmarshall0, cb));
}
