...
#ident "$XORP: xorp/xrl/interfaces/rib_xif.cc,v 1.10 2003/05/13 00:23:51 hodson Exp $"
...
)
{
    ...
    x.args().add("unicast", unicast);
    x.args().add("multicast", multicast);
    return _sender->send(x, callback(this, &XrlRibV0p1Client::unmarshall36, cb));
}


/* Unmarshall redist_disable6 */
void
XrlRibV0p1Client::unmarshall36(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB36		cb
)
...
)
{
    ...
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRibV0p1Client::unmarshall37, cb));
}


/* Unmarshall register_interest4 */
void
XrlRibV0p1Client::unmarshall37(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB37		cb
)
...
)
{
    ...
    return _sender->send(x, callback(this, &XrlRibV0p1Client::unmarshall38, cb));
}


/* Unmarshall deregister_interest4 */
void
XrlRibV0p1Client::unmarshall38(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB38		cb
)
...
)
{
    ...
    x.args().add("target", target);
    x.args().add("addr", addr);
    return _sender->send(x, callback(this, &XrlRibV0p1Client::unmarshall39, cb));
}


/* Unmarshall register_interest6 */
void
XrlRibV0p1Client::unmarshall39(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB39		cb
)
...
)
{
    ...
    x.args().add("addr", addr);
    x.args().add("prefix", prefix);
    return _sender->send(x, callback(this, &XrlRibV0p1Client::unmarshall40, cb));
}


/* Unmarshall deregister_interest6 */
void
XrlRibV0p1Client::unmarshall40(
	const XrlError&	e, 
	XrlArgs*	a, 
	CB40		cb
)
