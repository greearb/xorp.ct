...
#ident "$XORP: xorp/xrl/targets/test_peer_base.cc,v 1.2 2002/06/20 22:29:47 atanu Exp $"
...
XrlTestPeerTargetBase::handle_test_peer_0_1_register(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling test_peer/0.1/register", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling test_peer/0.1/packetisation", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlTestPeerTargetBase::handle_test_peer_0_1_connect(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 2) handling test_peer/0.1/connect", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 2) { 
	XLOG_ERROR("Wrong number of arguments (%d != 2) handling test_peer/0.1/listen", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling test_peer/0.1/send", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling test_peer/0.1/disconnect", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling test_peer/0.1/reset", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling test_peer/0.1/terminate", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
