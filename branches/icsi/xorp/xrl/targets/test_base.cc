...
#ident "$XORP: xorp/xrl/targets/test_base.cc,v 1.6 2002/05/10 17:24:12 hodson Exp $"
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling test/1.0/print_hello_world", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlTestTargetBase::handle_test_1_0_print_hello_world_and_message(const Xrl& xrl, XrlArgs* /* args */)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling test/1.0/print_hello_world_and_message", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling test/1.0/get_greeting_count", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling test/1.0/get_greeting", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling test/1.0/shoot_foot", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
