...
#ident "$XORP: xorp/xrl/targets/mfea_base.cc,v 1.33 2002/12/08 11:02:39 pavlin Exp $"
...
XrlMfeaTargetBase::handle_mfea_0_1_add_protocol4(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling mfea/0.1/add_protocol4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling mfea/0.1/add_protocol6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling mfea/0.1/delete_protocol4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling mfea/0.1/delete_protocol6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 5) { 
	XLOG_ERROR("Wrong number of arguments (%d != 5) handling mfea/0.1/start_protocol_vif4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 5) { 
	XLOG_ERROR("Wrong number of arguments (%d != 5) handling mfea/0.1/start_protocol_vif6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 5) { 
	XLOG_ERROR("Wrong number of arguments (%d != 5) handling mfea/0.1/stop_protocol_vif4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 5) { 
	XLOG_ERROR("Wrong number of arguments (%d != 5) handling mfea/0.1/stop_protocol_vif6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_allow_signal_messages(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling mfea/0.1/allow_signal_messages", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 4) { 
	XLOG_ERROR("Wrong number of arguments (%d != 4) handling mfea/0.1/allow_mrib_messages", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_join_multicast_group4(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 6) handling mfea/0.1/join_multicast_group4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 6) { 
	XLOG_ERROR("Wrong number of arguments (%d != 6) handling mfea/0.1/join_multicast_group6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 6) { 
	XLOG_ERROR("Wrong number of arguments (%d != 6) handling mfea/0.1/leave_multicast_group4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 6) { 
	XLOG_ERROR("Wrong number of arguments (%d != 6) handling mfea/0.1/leave_multicast_group6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_add_mfc4(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 8) handling mfea/0.1/add_mfc4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 8) { 
	XLOG_ERROR("Wrong number of arguments (%d != 8) handling mfea/0.1/add_mfc6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling mfea/0.1/delete_mfc4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling mfea/0.1/delete_mfc6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_send_protocol_message4(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 11) handling mfea/0.1/send_protocol_message4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 11) { 
	XLOG_ERROR("Wrong number of arguments (%d != 11) handling mfea/0.1/send_protocol_message6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 11) { 
	XLOG_ERROR("Wrong number of arguments (%d != 11) handling mfea/0.1/add_dataflow_monitor4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 11) { 
	XLOG_ERROR("Wrong number of arguments (%d != 11) handling mfea/0.1/add_dataflow_monitor6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 11) { 
	XLOG_ERROR("Wrong number of arguments (%d != 11) handling mfea/0.1/delete_dataflow_monitor4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 11) { 
	XLOG_ERROR("Wrong number of arguments (%d != 11) handling mfea/0.1/delete_dataflow_monitor6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling mfea/0.1/delete_all_dataflow_monitor4", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 3) { 
	XLOG_ERROR("Wrong number of arguments (%d != 3) handling mfea/0.1/delete_all_dataflow_monitor6", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
XrlMfeaTargetBase::handle_mfea_0_1_enable_vif(const Xrl& xrl, XrlArgs* args)
{
	...
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling mfea/0.1/enable_vif", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling mfea/0.1/disable_vif", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling mfea/0.1/start_vif", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 1) { 
	XLOG_ERROR("Wrong number of arguments (%d != 1) handling mfea/0.1/stop_vif", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/enable_all_vifs", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/disable_all_vifs", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/start_all_vifs", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/stop_all_vifs", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/enable_mfea", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/disable_mfea", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/enable_cli", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/disable_cli", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/start_mfea", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/stop_mfea", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/start_cli", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/stop_cli", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/enable_log_trace", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
...
{
    if (xrl.const_args().size() != 0) { 
	XLOG_ERROR("Wrong number of arguments (%d != 0) handling mfea/0.1/disable_log_trace", xrl.const_args().size());
	return XrlCmdError::BAD_ARGS();
    }
